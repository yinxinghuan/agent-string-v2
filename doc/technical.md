...
- 游戏：LEXICON
- 类型：puzzle
- 简述：语言有重力 — 在滚动的文字流中捕获词语，构建连锁评分机器
...
- 平台元信息：meta.title=LEXICON；cover_url=/poster.png；category=puzzle；uuid=45a331af-b0c9-42e4-a16d-5229a700cd80
...
- `src/Lexicon/Lexicon.tsx`
- `src/Lexicon/types.ts`
- `src/Lexicon/constants.ts`
- `src/Lexicon/index.ts`
- `src/Lexicon/Lexicon.less`
- `src/Lexicon/utils/sounds.ts`
- `src/Lexicon/components/ScrambleText.tsx`
