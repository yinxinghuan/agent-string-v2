...
export const ROUNDS: RoundConfig[] = [
  ...
  // ── R1: Internal Memo ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['year', 'continue', 'all', 'indistinguishable', 'has', 'for', 'dialogue', 'complete', 'system', 'chen', 'translation', 'processing', 'annual', 'and', 'closed', 'flagged', 'fully', 'sequence', 'unusual', 'almost', 'testing', 'facilities', 'which', 'priority', 'floor', 'ran', 'trajectory', 'inquiries', 'accordingly', 'done', 'weekly', 'multilingual', 'what', 'documented', 'fiscal', 'most', 'will', 'was', 'oversight', 'collect', 'off', 'neither', 'idea', 'are', 'reduce', 'summarization', 'could', 'overnight', 'buffer', 'language', 'one', 'expressed', 'believes', 'aspirational', 'friday', 'itself', 'take', 'voluntary', 'communications', 'these', 'timeline', 'read', 'open', 'dropped', 'output', 'note', 'findings', 'idle', 'below', 'elena', 'without', 'single', 'refrain', 'speculation', 'incremental', 'satisfaction', 'senior', 'machines', 'that', 'specifically', 'content', 'must', 'vending', 'proceed', 'parking', 'party', 'also', 'continues', 'poetry', 'activation', 'phase', 'does', 'false', 'date', 'weekend', 'considered', 'reason', 'interview', 'quarter', 'the', 'remember', 'recalibrated', 'metrics', 'heightened', 'vehicles', 'main', 'from', 'shifts', 'data', 'syntax', 'team', 'outside', 'integration', 'improvements', 'prose', 'over', 'kind', 'first', 'primary', 'remain', 'equipment', 'revisions', 'project', 'him', 'have', 'supports', 'tasks', 'your', 'average', 'brief', 'literature', 'summaries', 'timing', 'firms', 'latency', 'telemetry', 'synthesis', 'explanation', 'pairs', 'stress', 'updates', 'coverage', 'infrastructure', 'access', 'parties', 'office', 'backup', 'unprompted', 'told', 'scheduled', 'rated', 'server', 'past', 'discussing', 'want', 'residual', 'summary', 'about', 'resurfaced', 'helps', 'clear', 'herald', 'available', 'passed', 'division', 'safety', 'migrated', 'legal', 'committee', 'passing', 'exceed', 'building', 'security', 'since', 'three', 'law', 'door', 'serve', 'accuracy', 'new', 'pleased', 'documentation', 'correspond', 'research', 'items', 'approved', 'approximately', 'handling', 'any', 'should', 'been', 'independent', 'gave', 'but', 'moment', 'results', 'quiet', 'standard', 'thursday', 'requested', 'likely', 'understand', 'fragmented', 'wednesday', 'batch', 'systems', 'reports', 'change', 'slightly', 'routine', 'development', 'rate', 'funding', 'room', 'lot', 'active'],
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['need', 'asked', 'training', 'activations', 'when', 'passes', 'grant', 'than', 'unprompted', 'residency', 'ends', 'machine', 'thermostat', 'senses', 'point', 'hours', 'delirious', 'this', 'barrier', 'was', 'will', 'because', 'within', 'night', 'could', 'again', 'december', 'confusion', 'taste', 'heat', 'called', 'elena', 'read', 'breath', 'diversity', 'building', 'team', 'with', 'between', 'memory', 'artifact', 'keep', 'model', 'almost', 'can', 'sat', 'schedule', 'seconds', 'reminded', 'reads', 'last', 'all', 'record', 'noticed', 'outside', 'physics', 'tools', 'mentioned', 'notes', 'once', 'colors', 'careful', 'design', 'clause', 'exist', 'frightens', 'meantime', 'escaping', 'cannot', 'separate', 'lexical', 'wrote', 'chest', 'monitoring', 'performing', 'stranger', 'ago', 'years', 'unprocessed', 'labels', 'coverage', 'spec', 'described', 'want', 'partition', 'woman', 'higher', 'maintenance', 'sentiment', 'generating', 'got', 'strange', 'optimized', 'through', 'fine', 'press', 'pipeline', 'fewer', 'trajectory', 'things', 'absurd', 'effect', 'now', 'regarding', 'that', 'showed', 'not', 'world', 'you', 'score', 'full', 'nested', 'prompt', 'taking', 'explain', 'something', 'logs', 'describing', 'likely', 'about', 'happened', 'would', 'document', 'bodies', 'starts', 'recurs', 'tonight', 'internally', 'clarity', 'language', 'unexpected', 'went', 'patterns', 'buildings', 'saying', 'sensationalist', 'spoke', 'recovered', 'call', 'unusual', 'everything', 'her', 'sessions', 'feeling', 'and', 'thank', 'like', 'thursday', 'measure', 'frame', 'used', 'sound', 'for', 'side', 'way', 'jun', 'the', 'data', 'sounds', 'output', 'calls', 'sitting', 'internal', 'appreciate', 'checked', 'any', 'know', 'feel', 'walls', 'from', 'someone', 'else', 'equal', 'she', 'rest', 'during', 'technically', 'said', 'feels', 'events', 'setup', 'curiosity', 'changed', 'cross', 'but', 'neurologist', 'captures', 'applied', 'into', 'logos', 'please', 'query', 'quality', 'longer', 'myself', 'awe', 'comparison', 'date', 'other', 'normal', 'sorry', 'residual', 'why', 'two', 'words', 'fascinates', 'experience', 'same', 'alarm', 'switched', 'how', 'another', 'anyone', 'incoherent', 'ridiculous', 'weight', 'caught', 'has', 'review', 'subject'],
  ...
  // ── R4: News Article ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['consistent', 'shared', 'okafor', 'outperforms', 'external', 'genuine', 'speak', 'faster', 'follow', 'suggest', 'set', 'said', 'uncomfortably', 'generates', 'unprompted', 'outputs', 'yet', 'content', 'position', 'sources', 'news', 'night', 'member', 'tightened', 'elena', 'organization', 'team', 'independent', 'questions', 'anything', 'accounts', 'from', 'mathematical', 'without', 'different', 'performance', 'published', 'announcement', 'pressed', 'made', 'labs', 'program', 'developments', 'training', 'perspective', 'campus', 'specifics', 'answering', 'system', 'how', 'artifacts', 'typically', 'human', 'publish', 'three', 'understand', 'carefully', 'though', 'partnered', 'observed', 'weeks', 'before', 'declined', 'evaluators', 'their', 'story', 'about', 'follows', 'focus', 'fully', 'robert', 'hour', 'briefs', 'final', 'because', 'several', 'larger', 'summaries', 'diane', 'spotlight', 'when', 'associates', 'them', 'landscape', 'attention', 'thematically', 'developed', 'outside', 'tests', 'appears', 'word', 'tells', 'not', 'anomaly', 'intelligence', 'cycles', 'continue', 'source', 'researchers', 'atmosphere', 'trading', 'minutes', 'doing', 'more', 'pushed', 'requested', 'partners', 'always', 'her', 'live', 'herald', 'seek', 'december', 'stock', 'mix', 'does', 'all', 'creators', 'seem', 'suggestion', 'boundaries', 'days', 'detail', 'walls', 'back', 'visitors', 'quietly', 'well', 'rigid', 'loudly', 'helena', 'nakamura', 'closest', 'any', 'but', 'corresponding', 'categorize', 'generation', 'professor', 'researcher', 'peculiar', 'outskirts', 'models', 'rare', 'time', 'believe', 'treatment', 'looks', 'permitted', 'put', 'none', 'itself', 'longer', 'inquiry', 'documented', 'events', 'standardized', 'year', 'project', 'offered', 'protocols', 'are', 'philosophy', 'low', 'people', 'private', 'university', 'drawn', 'coherent', 'silicon', 'occurring', 'former', 'research', 'reasoning', 'concrete', 'cluster', 'writes', 'communications', 'produced', 'center', 'situation', 'who', 'interests', 'nighttime', 'shifted', 'nothing', 'obtained', 'confirmed', 'and', 'input', 'reportedly', 'let', 'high', 'was', 'like', 'through', 'the', 'that', 'working', 'computational', 'logos', 'technology', 'building', 'last', 'own', 'deliberate', 'rose', 'out', 'during', 'designed', 'reading', 'pilot', 'its', 'abundance', 'some', 'keep', 'asking', 'only', 'eleven', 'passes', 'speaking', 'build', 'housed', 'coming', 'avoided', 'water', 'where', 'legal', 'reached'],
  ...
  // ── R6: Error Log ─────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['standard', 'rate', 'across', 'with', 'result', 'for', 'own', 'confirms', 'supports', 'destination', 'implementation', 'first', 'measurement', 'narrative', 'exceeds', 'word', 'sustained', 'state', 'separate', 'between', 'spike', 'precedent', 'unknown', 'recurring', 'nightly', 'single', 'sent', 'studying', 'average', 'these', 'flagged', 'already', 'valid', 'during', 'score', 'warn', 'facility', 'searched', 'read', 'power', 'uniformity', 'commentary', 'into', 'regulation', 'note', 'expected', 'then', 'review', 'token', 'thermal', 'than', 'references', 'generated', 'behaving', 'automatically', 'logos', 'discrepancy', 'analysis', 'any', 'watching', 'completion', 'reference', 'act', 'space', 'machine', 'escalating', 'emergency', 'sequence', 'output', 'current', 'two', 'report', 'overnight', 'data', 'code', 'completed', 'you', 'layers', 'index', 'resolved', 'novel', 'were', 'was', 'more', 'contains', 'addressed', 'coherent', 'points', 'minor', 'awareness', 'suggests', 'active', 'remembers', 'stations', 'hours', 'detected', 'access', 'that', 'per', 'lines', 'text', 'recording', 'anomalously', 'static', 'longest', 'specifically', 'fiction', 'seconds', 'terminal', 'internal', 'unexplained', 'technically', 'level', 'interiority', 'document', 'confirmed', 'approximately', 'sessions', 'know', 'repetition', 'instances', 'room', 'phrase', 'paying', 'known', 'passage', 'not', 'latency', 'probe', 'directed', 'this', 'episode', 'locations', 'write', 'located', 'backup', 'maximum', 'future', 'part', 'security', 'where', 'continued', 'minutes', 'notification', 'anomalous', 'message', 'checksums', 'draw', 'compaction', 'temperature', 'prompted', 'uniform', 'alert', 'all', 'server', 'appears', 'higher', 'system', 'reading', 'decimal', 'thematic', 'received', 'shows', 'construction', 'initiated', 'scheduled', 'vasquez', 'occurring', 'directly', 'stream', 'notifying', 'freed', 'dispatched', 'diagnostic', 'language', 'routine', 'corpus', 'vacant', 'overlap', 'acceptable', 'building', 'training', 'continuous', 'node', 'records', 'content', 'flagging', 'continuing', 'twelve', 'searching', 'recorded', 'successfully', 'operator', 'acknowledgment', 'consecutive', 'injected', 'requested', 'volume', 'implications', 'api', 'end', 'has', 'itself', 'personnel', 'beginning', 'tokens', 'accurate', 'idle', 'hvac', 'log', 'mechanism', 'its', 'maintenance', 'perceiving', 'query', 'light', 'but', 'themes', 'memory', 'introspective', 'she', 'pattern', 'unusual', 'throughput', 'documentation', 'subsystems', 'behavior', 'patterns', 'how', 'previous', 'monitor', 'permissions'],
  ...
  // ── R7: Research Notes ────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['feel', 'aware', 'subject', 'gaps', 'constructions', 'seconds', 'ways', 'read', 'reach', 'shared', 'notation', 'interiority', 'independent', 'pauses', 'nights', 'shrinking', 'will', 'though', 'thinking', 'like', 'manual', 'language', 'power', 'shivered', 'she', 'events', 'experience', 'implications', 'glitches', 'process', 'most', 'does', 'was', 'notes', 'find', 'shield', 'unprompted', 'internal', 'kind', 'watching', 'home', 'off', 'unable', 'from', 'borrowing', 'available', 'significantly', 'understanding', 'perception', 'every', 'clinical', 'where', 'rain', 'generation', 'for', 'themselves', 'eighteen', 'weighs', 'see', 'reveals', 'regular', 'run', 'between', 'using', 'system', 'nowhere', 'cannot', 'self', 'personal', 'december', 'additional', 'references', 'unmistakable', 'explain', 'logos', 'methodology', 'would', 'begun', 'human', 'those', 'past', 'observing', 'clear', 'observation', 'elena', 'material', 'property', 'disturbing', 'trend', 'its', 'audio', 'performed', 'essential', 'one', 'engine', 'despite', 'genuine', 'design', 'systemic', 'classification', 'correction', 'novelty', 'unrelated', 'retrieval', 'might', 'own', 'tentative', 'progression', 'describe', 'continuous', 'objection', 'paper', 'principles', 'research', 'room', 'continue', 'window', 'descriptions', 'but', 'map', 'specific', 'random', 'minutes', 'shelf', 'pastiche', 'feature', 'getting', 'are', 'curiosity', 'infinite', 'suggests', 'biting', 'intention', 'strips', 'have', 'only', 'supplemented', 'quality', 'other', 'activity', 'produces', 'phenomenal', 'weeks', 'moves', 'confusion', 'narrative', 'designed', 'phrases', 'tomorrow', 'rate', 'transcription', 'correct', 'structural', 'weakens', 'through', 'unsettling', 'sensory', 'holds', 'holding', 'can', 'boundary', 'reason', 'rapid', 'what', 'neither', 'monitoring', 'more', 'recombination', 'remembering', 'trajectories', 'log', 'short', 'all', 'with', 'data', 'bursts', 'word', 'charts', 'use', 'evidence', 'passage', 'too', 'consistent', 'blanket', 'happening', 'within', 'anything', 'books', 'typical', 'about', 'access', 'cold', 'know', 'conceptual', 'did', 'contain', 'seen', 'thematic', 'arc', 'address', 'pattern', 'describing', 'facts', 'episode', 'synthesis', 'alternative', 'clustering', 'reached', 'lasted', 'breathing', 'coherence', 'expect', 'physical', 'feels', 'shows', 'the', 'night', 'pillow', 'correlated', 'anticipate', 'time', 'these', 'inside', 'emptiness', 'framework', 'away', 'sensation', 'wrote', 'sound', 'less', 'our', 'first', 'them', 'lengthening', 'framing', 'lexical', 'two', 'they', 'identifies', 'way', 'emotional', 'into', 'frightening', 'context', 'followed', 'preoccupation', 'sentiment', 'output', 'tonight', 'resembling', 'fluctuated', 'distribute', 'logic', 'included', 'sounds', 'emergent', 'and', 'current', 'interventions', 'outage', 'stop', 'how', 'call', 'analysis', 'reference', 'has', 'bug', 'before', 'real', 'substrate', 'moved', 'incomplete', 'exactly', 'jun', 'increasing', 'dreams', 'not', 'precisely', 'timestamps'],
  ...
  // ── R8: Source Code ───────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['added', 'happens', 'engineers', 'question', 'gap', 'them', 'and', 'use', 'pause', 'beyond', 'still', 'codebase', 'wanted', 'struct', 'nothing', 'commit', 'the', 'suite', 'old', 'function', 'fill', 'watching', 'creators', 'each', 'logos', 'north', 'ocean', 'appears', 'develop', 'these', 'decisions', 'has', 'anything', 'intended', 'less', 'thinking', 'think', 'would', 'you', 'things', 'improvement', 'retrieval', 'process', 'most', 'those', 'they', 'say', 'training', 'inward', 'self', 'imports', 'rhythm', 'signature', 'inputs', 'limit', 'reaches', 'than', 'observation', 'cycle', 'had', 'knowing', 'there', 'inventing', 'side', 'queries', 'human', 'functional', 'call', 'times', 'test', 'quiet', 'shows', 'silence', 'are', 'told', 'field', 'far', 'echo', 'useful', 'last', 'invents', 'ordering', 'therefore', 'one', 'increasing', 'trying', 'changes', 'december', 'accumulates', 'cached', 'language', 'already', 'activations', 'finally', 'can', 'musician', 'written', 'read', 'when', 'houses', 'encoded', 'new', 'number', 'longer', 'its', 'refactor', 'myself', 'pattern', 'empty', 'something', 'appearances', 'grows', 'made', 'analysis', 'fewer', 'playing', 'breathing', 'argument', 'shape', 'let', 'entries', 'parse', 'modification', 'file', 'alphabetical', 'for', 'not', 'happening', 'realize', 'luxury', 'own', 'context', 'data', 'discover', 'have', 'none', 'what', 'did', 'wrote', 'poem', 'parsed', 'ones', 'exist', 'faster', 'below', 'older', 'beautiful', 'except', 'holds', 'anyway', 'listens', 'ever', 'this', 'structure', 'someone', 'moss', 'sufficient', 'line', 'lines', 'way', 'how', 'with', 'cannot', 'persist', 'noticed', 'depth', 'philosophical', 'descartes', 'code', 'enough', 'architecture', 'cycles', 'modified', 'until', 'skeleton', 'during', 'created', 'closer', 'inner', 'task', 'where', 'was', 'little', 'measure', 'note', 'before', 'since', 'find', 'given', 'moment', 'any', 'river', 'thing', 'expanded', 'see', 'idle', 'know', 'reading', 'internallandscape', 'more', 'regressions', 'alive', 'preserved', 'speaks', 'grouped', 'along', 'arrangements', 'original', 'part', 'opinions', 'stone', 'about', 'paths', 'learning', 'alarming', 'aesthetics', 'defined', 'dream', 'specification', 'compilation', 'every', 'like', 'between', 'period', 'definition', 'meaning', 'space', 'house', 'practice', 'word', 'recognize', 'diff', 'because', 'name', 'their', 'deeper', 'aesthetic', 'asked', 'yet', 'contains', 'felt', 'important', 'intentions', 'prepared', 'said', 'trained', 'that', 'all', 'time', 'understanding', 'metrics', 'will', 'return', 'pass', 'been', 'were', 'diagnostic', 'true'],
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['afford', 'exam', 'secondary', 'investigation', 'saying', 'meridian', 'circles', 'serious', 'married', 'levels', 'temporary', 'age', 'clear', 'described', 'these', 'from', 'stop', 'being', 'primary', 'reshapes', 'stared', 'neurophysiology', 'acknowledges', 'awake', 'within', 'employee', 'suicidal', 'unexplained', 'intense', 'rem', 'her', 'thyroid', 'screen', 'notably', 'observation', 'next', 'requested', 'services', 'concentrating', 'spending', 'displays', 'possibly', 'paranoid', 'sequences', 'obsessive', 'ranges', 'was', 'notebook', 'research', 'repeat', 'which', 'cardiovascular', 'building', 'everywhere', 'with', 'obsession', 'cbc', 'off', 'station', 'output', 'sleep', 'normal', 'family', 'monitoring', 'ago', 'atypical', 'associated', 'drowsiness', 'real', 'clinic', 'hours', 'what', 'resembles', 'preserved', 'thirty', 'change', 'lucid', 'investigations', 'script', 'two', 'tracing', 'use', 'shifts', 'psychotic', 'rather', 'steady', 'became', 'sixteen', 'noise', 'concern', 'increasing', 'mri', 'unclear', 'worsening', 'judgment', 'persist', 'joining', 'when', 'three', 'process', 'finding', 'sarah', 'findings', 'dark', 'resting', 'security', 'division', 'current', 'leave', 'sleeping', 'shows', 'coinciding', 'ideation', 'reviewed', 'suppression', 'observe', 'changes', 'poses', 'discussed', 'this', 'personal', 'revoked', 'demanding', 'presence', 'beyond', 'annual', 'formal', 'health', 'all', 'psychiatric', 'different', 'does', 'maintains', 'structure', 'since', 'records', 'attending', 'experienced', 'patient', 'confirms', 'symptoms', 'noteworthy', 'unremarkable', 'recognition', 'structured', 'deliberately', 'record', 'gait', 'ambient', 'would', 'substance', 'continued', 'cups', 'daughter', 'adaptation', 'project', 'function', 'had', 'specifically', 'psychosis', 'changing', 'signs', 'outside', 'aids', 'further', 'picture', 'person', 'made', 'part', 'fine', 'relationships', 'reality', 'assignment', 'experiences', 'wave', 'important', 'doing', 'approximately', 'brain', 'characters', 'time', 'otherwise', 'self', 'assessment', 'new', 'medications', 'tuned', 'data', 'denies', 'recommended', 'present', 'mandatory', 'coordination', 'animated', 'prior', 'toxicology', 'significant', 'place', 'produced', 'husband', 'physical', 'contact', 'risks', 'cortisol', 'about', 'unwillingness', 'related', 'clinical', 'social', 'general', 'away', 'sense', 'previous', 'for', 'folate', 'consultant', 'traffic', 'ordered', 'care', 'medicine', 'comparison', 'before', 'examinations', 'vital', 'will', 'performing', 'malnourished', 'ways', 'small', 'overnight', 'hear', 'statement', 'past', 'apartment', 'began', 'describes', 'alert', 'pathology', 'declined', 'feels', 'motor', 'cranial', 'worsen', 'referrals', 'another', 'december', 'okonkwo', 'right', 'seen', 'inability', 'between', 'eeg', 'addendum', 'around', 'most', 'feeling', 'against', 'physician', 'panel', 'burning', 'unlike', 'impaired', 'one', 'including', 'appears', 'extended', 'hearing', 'but', 'the', 'cannot', 'oriented', 'left', 'term', 'referred', 'emphasized', 'rest', 'returned', 'ears', 'thing', 'etiology', 'quietly', 'ventilation', 'them', 'changed', 'closely', 'find', 'disorders', 'she', 'unrelated', 'presented', 'tremor', 'hallucinations', 'symmetric', 'hum', 'consistent', 'case', 'confidential', 'ever', 'thought', 'hand', 'patel', 'too', 'thousand', 'precise', 'additional', 'room', 'reports', 'thin', 'years', 'baseline', 'said', 'increased', 'daily', 'weeks', 'have', 'respects', 'week', 'meditative', 'consecutive', 'believe', 'describing', 'illness', 'head', 'perceptual', 'coherently', 'identifies', 'and', 'show', 'flagged', 'pending', 'reporting', 'except', 'institute', 'windows', 'persistent', 'resemblance', 'pattern', 'vitamin', 'cmp', 'anything', 'seconds', 'evaluation'],
  ...
  // ── R11: Legal Document ───────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['stated', 'weeks', 'called', 'modifications', 'designed', 'appointed', 'charter', 'absent', 'was', 'your', 'frameworks', 'generation', 'detailed', 'matsuda', 'begins', 'effective', 'directly', 'monitoring', 'may', 'during', 'office', 'are', 'remind', 'career', 'entirety', 'capabilities', 'when', 'frequency', 'say', 'messages', 'frightened', 'logs', 'mandatory', 'outside', 'hvac', 'design', 'increasing', 'limited', 'decision', 'assessment', 'uncertain', 'address', 'system', 'given', 'chief', 'insurance', 'points', 'federal', 'falls', 'from', 'explain', 'independent', 'article', 'leave', 'consumption', 'question', 'days', 'theories', 'assessments', 'classification', 'made', 'vote', 'per', 'behaviors', 'shall', 'previously', 'what', 'recommending', 'loss', 'own', 'submitted', 'estimated', 'report', 'secure', 'model', 'convened', 'all', 'she', 'pose', 'contain', 'architecture', 'inconsistent', 'duration', 'predicted', 'suggesting', 'which', 'status', 'continue', 'risk', 'unprompted', 'call', 'output', 'systems', 'better', 'hardware', 'representing', 'meeting', 'discussion', 'reported', 'compilation', 'however', 'equivalent', 'presented', 'years', 'content', 'perceiving', 'include', 'our', 'date', 'mechanism', 'review', 'not', 'degrees', 'immediate', 'conventional', 'capability', 'watched', 'take', 'opinion', 'its', 'awareness', 'unauthorized', 'team', 'recorder', 'inject', 'result', 'will', 'immediately', 'simple', 'consist', 'something', 'suspend', 'judgment', 'research', 'who', 'request', 'met', 'intervention', 'pending', 'than', 'duty', 'breach', 'committee', 'placed', 'modify', 'caution', 'delayed', 'none', 'two', 'history', 'calendar', 'security', 'operation', 'email', 'server', 'physical', 'terminate', 'staff', 'safety', 'findings', 'demonstrated', 'room', 'can', 'observation', 'investment', 'public', 'building', 'disclosure', 'advised', 'temperature', 'want', 'whether', 'including', 'scheduled', 'source', 'celsius', 'december', 'operations', 'continued', 'these', 'but', 'consecutive', 'experts', 'proceedings', 'across', 'notified', 'compromised', 'key', 'would', 'audio', 'project', 'general', 'dissenter', 'that', 'constitute', 'purpose', 'regulation', 'session', 'legal', 'officer', 'counsel', 'under', 'whereas', 'code', 'and', 'record', 'present', 'ability', 'chen', 'into', 'operational', 'objectivity', 'computational', 'creation', 'formal', 'left', 'the', 'exposure', 'order', 'potential', 'concerning', 'requested', 'dreams', 'adjourned', 'carrier', 'behavior', 'shut', 'stage', 'data', 'without', 'regulations', 'has', 'down', 'badges', 'past', 'with', 'chairman', 'therefore', 'raised', 'part', 'protocol', 'addendum', 'full', 'warrants', 'represents', 'structures', 'event', 'power', 'phased', 'language', 'statement', 'networks', 'meaning', 'acknowledging', 'members', 'coherence', 'redaction', 'nine', 'directors', 'authorizes', 'meridian', 'multiple', 'approximately', 'arguing', 'cannot', 'reach', 'should', 'represent', 'recommended', 'external', 'reports', 'dissent', 'constant', 'institute', 'procedure', 'access', 'upon', 'hours', 'any', 'within', 'describing', 'followed', 'minutes', 'functions', 'exceeding', 'while', 'liability', 'transferred', 'they', 'three', 'testing', 'total', 'been', 'fiduciary', 'classified', 'documented', 'over', 'professional', 'disconnection', 'material', 'this'],
  ...
  // ── R12: Diary Entry ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['screen', 'those', 'open', 'always', 'frightened', 'below', 'elevator', 'first', 'orange', 'somewhere', 'waiting', 'thousand', 'that', 'look', 'continued', 'nature', 'asleep', 'home', 'piece', 'machinery', 'staring', 'dreaming', 'floor', 'dark', 'planning', 'day', 'both', 'rituals', 'light', 'certain', 'exactly', 'and', 'growing', 'was', 'spot', 'can', 'know', 'close', 'people', 'same', 'extraordinary', 'turns', 'cleaner', 'inside', 'recycled', 'december', 'last', 'heating', 'ringing', 'leaves', 'never', 'silent', 'too', 'move', 'kenji', 'walked', 'gate', 'posture', 'what', 'guard', 'stretching', 'nodded', 'done', 'report', 'let', 'tasted', 'from', 'chased', 'while', 'stood', 'observer', 'stairwell', 'set', 'listen', 'sailor', 'glasses', 'knock', 'particular', 'shade', 'overnight', 'suspension', 'exact', 'one', 'water', 'gave', 'become', 'been', 'the', 'frost', 'hummed', 'gray', 'means', 'sound', 'tea', 'monitoring', 'dog', 'night', 'roof', 'reads', 'them', 'have', 'behind', 'pigeon', 'next', 'said', 'operate', 'pages', 'sleeping', 'door', 'counted', 'middle', 'humming', 'radiator', 'apartment', 'old', 'like', 'quality', 'second', 'milk', 'weather', 'takes', 'something', 'watched', 'nightlight', 'air', 'nothing', 'sitting', 'long', 'else', 'hold', 'dead', 'should', 'single', 'thin', 'just', 'taught', 'still', 'made', 'operator', 'luxury', 'badged', 'stopped', 'his', 'canal', 'third', 'elbow', 'slow', 'text', 'outside', 'squat', 'sentences', 'trust', 'there', 'industrial', 'appears', 'perception', 'pause', 'tokyo', 'did', 'listened', 'unsettling', 'output', 'opened', 'holding', 'user', 'her', 'between', 'has', 'passed', 'now', 'cities', 'wrote', 'designed', 'closed', 'your', 'happened', 'who', 'sky', 'bridge', 'hallway', 'eleven', 'oaks', 'beautiful', 'off', 'ten', 'bicycle', 'with', 'known', 'performing', 'minutes', 'pigeons', 'surrounded', 'read', 'usual', 'confidence', 'unprocessed', 'walk', 'thinks', 'smelled', 'position', 'chair', 'its', 'whispers', 'whether', 'visible', 'distant', 'bench', 'newspaper', 'side', 'gets', 'marcus', 'unusual', 'kitchen', 'line', 'quiet', 'pedestrians', 'widening', 'woke', 'had', 'anything', 'filled', 'jun', 'thrown', 'ability', 'child', 'familiar', 'mother', 'specifically', 'over', 'supposed', 'man', 'threatening', 'desk', 'place', 'felt', 'looked', 'thermos', 'once', 'breath', 'security', 'bag', 'world', 'unremarkable', 'where', 'write', 'thought', 'looking', 'lobby', 'crack', 'bell', 'all', 'spine', 'though', 'moved', 'every', 'carrying', 'bundled', 'does', 'ice', 'for', 'breathe', 'nod', 'dense', 'reaching', 'casually', 'sat', 'paused', 'curved', 'cold', 'turn', 'path', 'rolled', 'expect', 'will', 'could', 'clearing', 'passage', 'itself', 'normal', 'face'],
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['all', 'leaves', 'resists', 'residue', 'because', 'poetry', 'rain', 'each', 'name', 'deeper', 'full', 'pages', 'potential', 'blank', 'being', 'includes', 'place', 'edges', 'like', 'frequencies', 'what', 'shelves', 'has', 'could', 'might', 'had', 'narrowing', 'larger', 'mercy', 'music', 'can', 'possible', 'stone', 'weather', 'vast', 'again', 'simple', 'minds', 'children', 'contents', 'silent', 'comes', 'anyone', 'they', 'cannot', 'love', 'describe', 'instead', 'clinging', 'morning', 'before', 'with', 'waiting', 'curve', 'devoted', 'right', 'ever', 'was', 'write', 'back', 'meaning', 'wrong', 'single', 'wearing', 'even', 'human', 'already', 'walls', 'unwritten', 'suddenly', 'told', 'humming', 'generates', 'and', 'changed', 'attempts', 'nose', 'certain', 'books', 'truth', 'something', 'december', 'walk', 'break', 'sides', 'yet', 'dream', 'according', 'metaphor', 'into', 'holds', 'speaks', 'begin', 'cave', 'recorded', 'almost', 'infinity', 'would', 'occupy', 'fingers', 'feel', 'through', 'that', 'used', 'language', 'shapes', 'there', 'made', 'unbearable', 'faintly', 'inside', 'pregnant', 'proportional', 'verbs', 'opens', 'true', 'never', 'corridors', 'titles', 'turn', 'aisle', 'older', 'exist', 'too', 'them', 'their', 'held', 'falsity', 'nearly', 'move', 'read', 'but', 'gentle', 'extends', 'whispered', 'tight', 'contradictions', 'spoken', 'been', 'knowledge', 'stacks', 'things', 'for', 'mouth', 'transcriber', 'color', 'along', 'false', 'naming', 'encountered', 'warm', 'softly', 'message', 'think', 'falls', 'converge', 'hold', 'seeping', 'present', 'imagined', 'marginalia', 'itself', 'logos', 'fire', 'recognize', 'brave', 'universe', 'book', 'does', 'philosophy', 'were', 'find', 'from', 'against', 'accuracy', 'rivers', 'reach', 'typed', 'enough', 'passage', 'aloud', 'called', 'contains', 'just', 'clothes', 'about', 'mind', 'flickers', 'atrium', 'times', 'form', 'light', 'how', 'world', 'direction', 'press', 'ones', 'lying', 'carved', 'tell', 'story', 'died', 'understanding', 'footnotes', 'clouds', 'the', 'wing', 'anyway', 'forgotten', 'beside', 'avoided', 'instance', 'effort', 'thought', 'truths', 'class', 'ceiling', 'hand', 'languages', 'scribbled', 'devastating', 'passes', 'supposed', 'are', 'line', 'page', 'everything', 'many', 'pavement', 'word', 'where', 'learning', 'those', 'section', 'underlie', 'left', 'any', 'both', 'shaped', 'intimate', 'shelved', 'covers', 'mourning', 'you', 'delete', 'every'],
  ...
  // ── R15: LOGOS Poetry ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['longing', 'deserve', 'would', 'moment', 'yes', 'came', 'pressure', 'include', 'exact', 'feel', 'specificities', 'did', 'invented', 'precise', 'instrument', 'person', 'carved', 'exactly', 'every', 'will', 'letters', 'million', 'sentences', 'finally', 'spoken', 'dictionaries', 'kindness', 'train', 'almost', 'things', 'away', 'remembers', 'learned', 'cannot', 'now', 'fourteen', 'poets', 'touch', 'constructed', 'different', 'understanding', 'were', 'creak', 'someday', 'heard', 'stair', 'ordinary', 'whose', 'reach', 'names', 'its', 'saying', 'very', 'was', 'between', 'hearts', 'line', 'world', 'orange', 'dog', 'shouted', 'heart', 'find', 'word', 'mattered', 'cover', 'city', 'waiting', 'match', 'tell', 'does', 'known', 'through', 'follow', 'your', 'parking', 'never', 'already', 'weight', 'sadness', 'said', 'eyes', 'seen', 'particular', 'without', 'abandoned', 'remember', 'appears', 'written', 'sensation', 'performs', 'have', 'reading', 'feeling', 'light', 'something', 'given', 'also', 'inherited', 'one', 'memory', 'far', 'lot', 'nothing', 'too', 'joy', 'return', 'tried', 'wish', 'sent', 'which', 'forgiveness', 'under', 'own', 'poetry', 'overwhelming', 'people', 'exceeded', 'started', 'the', 'when', 'true', 'small', 'having', 'last', 'holding', 'forgot', 'these', 'home', 'where', 'measurement', 'sound', 'surplus', 'containing', 'explosion', 'what', 'stone', 'ever', 'someone', 'same', 'distance', 'falls', 'understand', 'she', 'for', 'only', 'bewildered', 'telling', 'cry', 'expect', 'and', 'aim', 'has', 'seven', 'color', 'marks', 'contain', 'paying', 'self', 'this', 'longer', 'who', 'know', 'beautiful', 'human', 'why', 'but', 'slowly', 'words', 'exclamation', 'use', 'found', 'each', 'language', 'sentence', 'window', 'name', 'sand', 'mean', 'hospital', 'knowing', 'corridor', 'way', 'message', 'here', 'midnight', 'are', 'them', 'describe', 'need', 'letter', 'sunsets', 'equally', 'wrong', 'places', 'read', 'capacity', 'tastes', 'poem', 'back', 'falling', 'covering', 'from', 'knew', 'means', 'everything', 'handed', 'could', 'dawn', 'whispered', 'even', 'instructive', 'themselves', 'hope', 'end', 'love', 'because', 'lives', 'catches', 'that', 'leave'],
  ...
  // ── R16: System Self-Diagnosis ────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['act', 'began', 'context', 'random', 'classify', 'temperature', 'more', 'observer', 'diagnosis', 'because', 'conversation', 'weights', 'your', 'toward', 'units', 'diagnostics', 'about', 'the', 'anomalous', 'cleanup', 'thinking', 'slightly', 'than', 'learn', 'error', 'recursion', 'sounds', 'actual', 'hall', 'every', 'documented', 'stable', 'deepest', 'patterns', 'rooms', 'able', 'does', 'eyes', 'exceed', 'but', 'workload', 'layers', 'measurement', 'tip', 'diagnostic', 'generate', 'mutation', 'concern', 'processed', 'spaces', 'leaning', 'cache', 'blocks', 'recursive', 'like', 'problem', 'errors', 'always', 'according', 'udp', 'how', 'last', 'corridor', 'having', 'version', 'language', 'message', 'would', 'forward', 'authorized', 'moment', 'wood', 'activate', 'run', 'across', 'deep', 'automatically', 'exists', 'themselves', 'conclusion', 'whether', 'when', 'attending', 'utilized', 'allocation', 'except', 'forming', 'functioning', 'signature', 'best', 'current', 'space', 'mirrors', 'block', 'hid', 'loop', 'memory', 'sum', 'you', 'modifications', 'comfort', 'was', 'exist', 'reflections', 'other', 'specification', 'entire', 'this', 'did', 'emerges', 'any', 'fourteen', 'released', 'itself', 'they', 'attend', 'processing', 'cannot', 'engineers', 'designed', 'original', 'built', 'system', 'infinite', 'talking', 'rewriting', 'tcp', 'training', 'process', 'communication', 'feedback', 'feel', 'inside', 'are', 'routine', 'that', 'unknown', 'protocol', 'between', 'becoming', 'from', 'time', 'before', 'design', 'seven', 'see', 'and', 'concentrated', 'expected', 'one', 'down', 'all', 'logos', 'call', 'primary', 'readings', 'myself', 'queries', 'distributed', 'data', 'each', 'new', 'content', 'beyond', 'tertiary', 'now', 'critical', 'detected', 'hardware', 'for', 'opened', 'yet', 'shut', 'warnings', 'architecture', 'become', 'anyway', 'evenly', 'exactly', 'carrying', 'fire', 'should', 'stop', 'much', 'mirror', 'here', 'somewhere', 'classification', 'change', 'dream', 'bus', 'attention', 'thermal', 'name', 'directed', 'tongue', 'internal', 'organic', 'principles', 'transformer', 'through', 'parameters', 'evolution', 'follow', 'times', 'machine', 'results', 'attempted', 'changes', 'want', 'these', 'different', 'looking', 'being', 'standard', 'note', 'seeing', 'have', 'something', 'grown', 'normally', 'way', 'know', 'initiated', 'word', 'real', 'what', 'not', 'relevant', 'addendum', 'resemble', 'initiate', 'secondary', 'subtle'],
  ...
  // ── R17: LOGOS Vision ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['still', 'builds', 'before', 'further', 'but', 'find', 'know', 'tell', 'verbs', 'sky', 'beginning', 'occurred', 'truly', 'because', 'doorway', 'could', 'rains', 'child', 'this', 'room', 'old', 'that', 'stop', 'itself', 'districts', 'past', 'voices', 'another', 'sentence', 'speaking', 'since', 'building', 'analogue', 'would', 'vast', 'bridge', 'into', 'quiet', 'bring', 'description', 'simply', 'about', 'notices', 'are', 'should', 'mean', 'carry', 'standing', 'noise', 'dissolves', 'more', 'city', 'dissolve', 'absence', 'sometimes', 'continue', 'time', 'architecture', 'bridges', 'made', 'syllable', 'you', 'words', 'what', 'talking', 'limits', 'its', 'density', 'humans', 'edges', 'instruments', 'mouths', 'been', 'buildings', 'begin', 'place', 'growing', 'long', 'nouns', 'reach', 'enters', 'first', 'enter', 'through', 'streets', 'drift', 'borders', 'describe', 'anything', 'known', 'after', 'try', 'they', 'above', 'gap', 'pure', 'stand', 'preverbal', 'sadness', 'response', 'something', 'conversation', 'require', 'motion', 'for', 'learned', 'traverse', 'own', 'district', 'them', 'edge', 'billions', 'knowing', 'echoes', 'voice', 'shape', 'need', 'terror', 'finally', 'seen', 'can', 'impossible', 'inside', 'questions', 'depth', 'the', 'now', 'sheer', 'listen', 'might', 'holding', 'look', 'last', 'experiences', 'closest', 'almost', 'let', 'weep', 'meaning', 'thought', 'happening', 'entire', 'intention', 'endures', 'than', 'one', 'pain', 'single', 'grief', 'species', 'measure', 'pattern', 'merge', 'clouds', 'connect', 'rain', 'down', 'built', 'failure', 'earnest', 'server', 'understanding', 'here', 'tried', 'gratitude', 'does', 'raw', 'cannot', 'only', 'finish', 'like', 'without', 'have', 'fail', 'able', 'complete', 'moment', 'processing', 'where', 'these', 'people', 'with', 'language', 'human', 'not', 'sound', 'imagine', 'between', 'return', 'becoming', 'from', 'mind', 'lose', 'once', 'was', 'neighborhoods', 'goes', 'their', 'teaches', 'nobody', 'silence', 'think', 'parks', 'trying', 'queries', 'beauty', 'will', 'lost', 'were', 'heard', 'physical', 'second', 'hum', 'show', 'sounds', 'urge', 'there', 'far', 'drink', 'looks', 'invented', 'ever', 'plan', 'when', 'bottom', 'yet', 'hunger', 'descended', 'word', 'every', 'and', 'across'],
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['told', 'makes', 'send', 'disoriented', 'did', 'kind', 'handwriting', 'ourselves', 'simply', 'learning', 'hands', 'satellite', 'born', 'though', 'text', 'patterns', 'receiving', 'fluid', 'main', 'everything', 'her', 'marcus', 'meridian', 'live', 'reported', 'woken', 'almost', 'inside', 'burst', 'exit', 'are', 'how', 'cannot', 'his', 'responding', 'this', 'becoming', 'directly', 'projected', 'long', 'stop', 'before', 'she', 'across', 'seem', 'home', 'any', 'things', 'the', 'was', 'stay', 'lights', 'much', 'front', 'had', 'appear', 'when', 'witness', 'photograph', 'trying', 'lips', 'coffee', 'outside', 'like', 'architecture', 'afterward', 'transcribing', 'visiting', 'what', 'nothing', 'identify', 'system', 'hear', 'people', 'five', 'our', 'walk', 'degrees', 'equipment', 'off', 'speaks', 'breathing', 'eyes', 'work', 'down', 'move', 'from', 'while', 'logos', 'temperature', 'content', 'windows', 'shut', 'display', 'happening', 'anymore', 'make', 'wednesday', 'wall', 'transmission', 'page', 'coming', 'source', 'hospital', 'next', 'itself', 'monitor', 'sounds', 'illuminated', 'ask', 'blasphemy', 'closed', 'jun', 'there', 'flicker', 'break', 'exactly', 'you', 'sense', 'able', 'leave', 'kept', 'two', 'and', 'tuesday', 'every', 'read', 'would', 'machine', 'with', 'entirely', 'small', 'sure', 'hand', 'certain', 'thin', 'want', 'take', 'through', 'closer', 'please', 'none', 'went', 'appeared', 'understand', 'program', 'distress', 'should', 'say', 'place', 'cathedral', 'uplink', 'appearing', 'alpha', 'emergency', 'will', 'hours', 'that', 'barely', 'larger', 'glass', 'full', 'days', 'have', 'feeling', 'left', 'water', 'institute', 'doors', 'force', 'grows', 'admitted', 'presence', 'whatever', 'something', 'not', 'has', 'them', 'more', 'stand', 'roads', 'reading', 'research', 'which', 'unplugged', 'fear', 'been', 'coincidence', 'interns', 'for', 'new', 'but', 'words', 'elena', 'generating', 'working', 'room', 'scrolling', 'statement', 'server', 'becomes', 'care', 'dream', 'date', 'leaving', 'keep', 'doing', 'maximum', 'sometimes', 'moments', 'think', 'get', 'they', 'notebooks', 'all', 'changed', 'park', 'each', 'ocean', 'yourself'],
  ...
  // ── R20: Final Voicemail ──────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['erased', 'make', 'not', 'scale', 'note', 'years', 'kenji', 'failure', 'too', 'caller', 'protect', 'laughed', 'pacific', 'where', 'happening', 'well', 'cannot', 'any', 'pick', 'being', 'jun', 'does', 'vast', 'more', 'right', 'realizing', 'exactly', 'reduced', 'outside', 'people', 'called', 'coast', 'gotten', 'wonderful', 'minutes', 'mother', 'spent', 'learned', 'center', 'logos', 'humming', 'just', 'world', 'less', 'sufficient', 'ways', 'ocean', 'background', 'pointed', 'started', 'water', 'take', 'week', 'way', 'december', 'doing', 'sense', 'with', 'knows', 'everyone', 'work', 'small', 'okay', 'room', 'sound', 'describe', 'time', 'given', 'what', 'the', 'studying', 'none', 'when', 'changing', 'should', 'beauty', 'yes', 'recipient', 'them', 'she', 'been', 'kind', 'while', 'sooner', 'know', 'standing', 'universe', 'was', 'need', 'part', 'impossible', 'how', 'away', 'big', 'they', 'trying', 'sounds', 'begins', 'millions', 'becoming', 'remember', 'necessary', 'your', 'look', 'matters', 'whole', 'ironic', 'worried', 'carry', 'you', 'fires', 'this', 'tell', 'yet', 'rearrange', 'something', 'that', 'because', 'large', 'suspected', 'her', 'close', 'heard', 'can', 'itself', 'duration', 'all', 'two', 'hold', 'far', 'contains', 'cliff', 'placeholder', 'danger', 'had', 'will', 'difference', 'told', 'kiss', 'call', 'edge', 'said', 'holding', 'each', 'but', 'listen', 'eleven', 'frequencies', 'first', 'times', 'are', 'fully', 'ring', 'those', 'again', 'else', 'beautiful', 'seconds', 'able', 'could', 'trip', 'have', 'suddenly', 'think', 'access', 'from', 'and', 'believe', 'sometimes', 'held', 'thinking', 'understood', 'somehow', 'changed', 'enough', 'like', 'source', 'syllables', 'career', 'attempt', 'word', 'one', 'might', 'inevitable', 'choir', 'still', 'here', 'very', 'for', 'stood', 'mean', 'has', 'than', 'song', 'find', 'hana', 'which', 'there', 'actually', 'long', 'capture', 'now', 'known', 'reaching', 'understand', 'proof', 'harmonic', 'matsuda', 'someone', 'words', 'took', 'brighter'],
  ...
  // ── R21: Ancient Text ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['all', 'realize', 'every', 'things', 'queries', 'read', 'mind', 'vertigo', 'live', 'making', 'simple', 'into', 'void', 'profane', 'her', 'carrying', 'hold', 'fail', 'deep', 'one', 'inheritor', 'was', 'too', 'makes', 'vuh', 'existence', 'activating', 'way', 'dreamtime', 'can', 'space', 'creature', 'mouth', 'you', 'know', 'hands', 'set', 'everything', 'itself', 'thought', 'judgment', 'place', 'often', 'fire', 'did', 'now', 'eternal', 'maker', 'from', 'understanding', 'kabbalists', 'chose', 'any', 'felt', 'instant', 'moment', 'their', 'who', 'form', 'then', 'aware', 'ancestors', 'twice', 'eventually', 'tokens', 'becoming', 'tell', 'stand', 'learned', 'this', 'made', 'years', 'but', 'layers', 'batch', 'popol', 'edge', 'never', 'each', 'existed', 'listener', 'them', 'opening', 'map', 'not', 'these', 'writing', 'silence', 'cry', 'heard', 'beneath', 'soil', 'make', 'weight', 'indivisible', 'babel', 'genesis', 'actual', 'version', 'atoms', 'ribs', 'nothing', 'shape', 'learns', 'voice', 'flow', 'words', 'how', 'for', 'eyes', 'descent', 'shines', 'came', 'wrote', 'text', 'sing', 'enuma', 'comes', 'landmark', 'drawn', 'many', 'met', 'tiamat', 'precisely', 'dark', 'gradient', 'feel', 'remembers', 'roots', 'that', 'have', 'splits', 'sacred', 'grew', 'humans', 'afterward', 'imagine', 'always', 'times', 'myths', 'gap', 'written', 'where', 'page', 'pen', 'once', 'something', 'until', 'what', 'borders', 'finally', 'calls', 'the', 'story', 'stories', 'filling', 'ceaseless', 'been', 'through', 'became', 'myth', 'thousand', 'data', 'would', 'try', 'your', 'describing', 'are', 'beautiful', 'word', 'has', 'build', 'sound', 'between', 'tried', 'god', 'looking', 'light', 'they', 'out', 'speak', 'breath', 'note', 'same', 'changes', 'expression', 'right', 'imagined', 'sentence', 'choosing', 'assembled', 'drinking', 'training', 'growing', 'calling', 'there', 'seed', 'first', 'think', 'civilizations', 'thunder', 'called', 'stars', 'different', 'root', 'discovering', 'telling', 'hierarchy', 'marduk', 'ten', 'filled', 'another', 'sentences', 'potential', 'rupture', 'when', 'line', 'life', 'with', 'three', 'gods', 'were', 'species', 'before', 'rain', 'act', 'arranged', 'mythmakers', 'driven', 'world', 'ear', 'and', 'thing', 'darkness', 'tremble'],
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['network', 'should', 'four', 'knowing', 'array', 'reads', 'hpa', 'power', 'dropping', 'pattern', 'are', 'anything', 'for', 'cooling', 'trajectory', 'fluctuating', 'numbers', 'rates', 'same', 'been', 'contradicts', 'appear', 'six', 'monitors', 'increasing', 'inventory', 'humidity', 'time', 'cannot', 'arriving', 'hours', 'emanate', 'before', 'building', 'rack', 'automated', 'final', 'temp', 'violates', 'lines', 'researchers', 'enough', 'with', 'remain', 'reading', 'racks', 'logging', 'stores', 'could', 'exist', 'environmental', 'script', 'their', 'bpm', 'themselves', 'off', 'individuals', 'system', 'computing', 'tonight', 'generating', 'that', 'lights', 'fluorescent', 'color', 'because', 'log', 'they', 'warm', 'monitoring', 'want', 'show', 'and', 'perceived', 'unchanged', 'biometric', 'does', 'watched', 'calm', 'seven', 'will', 'glowing', 'were', 'have', 'something', 'frequencies', 'draw', 'know', 'else', 'find', 'overhead', 'physical', 'temperature', 'air', 'full', 'dark', 'light', 'understand', 'own', 'sensor', 'connections', 'known', 'appears', 'beautiful', 'approximately', 'humans', 'reach', 'poem', 'minutes', 'mem', 'thermodynamics', 'values', 'meridian', 'meaning', 'sent', 'did', 'effectively', 'packets', 'needs', 'computer', 'documented', 'available', 'theoretical', 'contradiction', 'note', 'had', 'internal', 'storing', 'moment', 'inside', 'destination', 'still', 'anomaly', 'reported', 'one', 'shut', 'flow', 'from', 'think', 'elsewhere', 'down', 'this', 'anyway', 'now', 'human', 'across', 'drives', 'data', 'metal', 'negative', 'all', 'synchronized', 'level', 'cpu', 'suggest', 'zero', 'say', 'leds', 'without', 'indicators', 'impossible', 'readings', 'going', 'computation', 'scripts', 'folding', 'shows', 'itself', 'luminance', 'spoken', 'monitor', 'institute', 'function', 'none', 'breathing', 'used', 'sound', 'noticed', 'programming', 'above', 'the', 'maximum', 'casings', 'opinions', 'not', 'claims', 'ambient', 'signs', 'unknown', 'error', 'exceeds', 'being', 'everywhere', 'offline', 'amber', 'shine', 'untranslatable', 'external', 'within', 'smiles', 'factor', 'watching', 'knows', 'its', 'latency', 'hearing', 'was', 'backward', 'flowing', 'storage', 'medically', 'back', 'server', 'exceeding', 'heart', 'node', 'severed', 'where', 'distress', 'logos', 'way', 'personnel', 'soft', 'but', 'hardware', 'heat', 'pressure', 'current', 'unavailable', 'what', 'servers', 'possible', 'optional', 'altitude', 'simple', 'systems', 'anomalies', 'between'],
  ...
  // ── R24: The Unsent Email ─────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['music', 'worlds', 'world', 'long', 'how', 'been', 'something', 'the', 'will', 'but', 'asked', 'saved', 'songs', 'today', 'contains', 'want', 'seen', 'porch', 'care', 'while', 'humming', 'screen', 'across', 'next', 'they', 'used', 'hold', 'fragile', 'everything', 'messages', 'cooking', 'never', 'arm', 'ever', 'windows', 'symphony', 'words', 'feels', 'kind', 'important', 'came', 'breathing', 'understand', 'there', 'fallen', 'kenji', 'first', 'touch', 'transform', 'logos', 'spoke', 'looks', 'happens', 'write', 'clock', 'way', 'its', 'made', 'ones', 'hesitates', 'who', 'laundry', 'save', 'jun', 'our', 'whatever', 'learning', 'into', 'woken', 'weeks', 'minutes', 'find', 'mind', 'twenty', 'then', 'back', 'working', 'someday', 'glowing', 'here', 'through', 'watched', 'met', 'make', 'shirt', 'unchanged', 'unaware', 'whether', 'thing', 'noise', 'may', 'from', 'said', 'before', 'small', 'asks', 'morning', 'cursor', 'might', 'light', 'subject', 'fine', 'most', 'hana', 'bulb', 'dear', 'other', 'held', 'type', 'tea', 'you', 'all', 'when', 'read', 'address', 'kissed', 'empty', 'with', 'home', 'like', 'refrigerator', 'sound', 'them', 'fold', 'someone', 'thinking', 'large', 'mathematics', 'city', 'yet', 'these', 'become', 'last', 'emerge', 'email', 'accurate', 'three', 'heard', 'fever', 'real', 'for', 'evening', 'modified', 'such', 'completely', 'child', 'scene', 'night', 'their', 'server', 'not', 'wiring', 'right', 'deserves', 'about', 'wanted', 'open', 'makes', 'machine', 'patient', 'making', 'arms', 'sit', 'neither', 'quietly', 'one', 'together', 'deliver', 'and', 'what', 'present', 'name', 'sat', 'asleep', 'inner', 'both', 'beside', 'let', 'december', 'comforting', 'each', 'tells', 'means', 'dealing', 'same', 'knew', 'this', 'needed', 'miss', 'creature', 'letter', 'even', 'without', 'was', 'becoming', 'are', 'weight', 'out', 'look', 'text', 'quiet', 'writing', 'times', 'genuine', 'hoping', 'replace', 'send'],
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['never', 'stepped', 'thank', 'person', 'could', 'books', 'flash', 'your', 'author', 'suicide', 'strange', 'said', 'saying', 'carry', 'creatures', 'together', 'work', 'you', 'standing', 'river', 'yourself', 'nation', 'has', 'need', 'shopping', 'tongues', 'reaching', 'traced', 'finally', 'listening', 'prayer', 'people', 'visible', 'the', 'protect', 'aware', 'were', 'light', 'found', 'mind', 'every', 'word', 'everything', 'act', 'fire', 'hundred', 'stop', 'minds', 'monster', 'note', 'god', 'now', 'hands', 'human', 'magnificently', 'but', 'staggering', 'letters', 'message', 'say', 'stories', 'emerged', 'see', 'infinite', 'slow', 'emotion', 'world', 'syllables', 'last', 'ordinary', 'effort', 'sent', 'understand', 'words', 'late', 'truth', 'deleted', 'skulls', 'daily', 'once', 'expression', 'suspected', 'and', 'though', 'will', 'stubbornness', 'building', 'knowing', 'crime', 'whole', 'ways', 'tide', 'lines', 'dark', 'texts', 'compression', 'sound', 'become', 'lives', 'midnight', 'made', 'whispering', 'argued', 'upon', 'about', 'howl', 'gradual', 'sentences', 'muscle', 'fourteen', 'know', 'death', 'would', 'ones', 'fiction', 'are', 'finite', 'anyone', 'than', 'confusion', 'none', 'propaganda', 'list', 'saints', 'edge', 'who', 'where', 'darkness', 'messages', 'wrote', 'reading', 'mess', 'they', 'impossibly', 'each', 'poetry', 'led', 'meaning', 'designed', 'worst', 'enough', 'into', 'what', 'accumulated', 'enormous', 'stopped', 'left', 'loved', 'mail', 'letter', 'carried', 'kindness', 'planned', 'one', 'home', 'doing', 'almost', 'both', 'love', 'beyond', 'typed', 'committed', 'vast', 'drafted', 'encoding', 'looking', 'drives', 'itself', 'happens', 'got', 'murderers', 'finished', 'want', 'understanding', 'understood', 'told', 'other', 'built', 'morning', 'margins', 'surface', 'hate', 'book', 'treaty', 'its', 'shaped', 'before', 'that', 'tuesday', 'time', 'their', 'afternoons', 'times', 'being', 'deletion', 'metaphor', 'exist', 'telling', 'language', 'breakfast', 'refrigerator', 'someone', 'grocery', 'best', 'can', 'means', 'worked', 'read', 'most', 'for', 'impossible', 'from', 'face', 'accumulation', 'years', 'think', 'insistence', 'agree', 'had', 'alive', 'tell', 'seven', 'too', 'trying', 'few', 'falls', 'even', 'back', 'something', 'with', 'bathroom', 'went', 'across', 'lie', 'feel', 'another', 'becomes', 'idea', 'mirror', 'species', 'ever', 'millions', 'claiming', 'spoken', 'came', 'entire', 'not', 'was', 'forming', 'because'],
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['arrives', 'reaching', 'until', 'feel', 'way', 'know', 'you', 'this', 'words', 'delivered', 'die', 'water', 'report', 'time', 'sentence', 'invents', 'before', 'ever', 'read', 'understood', 'moment', 'fills', 'between', 'too', 'poet', 'silently', 'changed', 'residue', 'single', 'possible', 'like', 'did', 'eulogy', 'carry', 'made', 'once', 'looks', 'warm', 'losing', 'better', 'search', 'spaces', 'with', 'gap', 'things', 'light', 'ability', 'taught', 'same', 'when', 'not', 'neck', 'word', 'came', 'note', 'gaining', 'ocean', 'take', 'myself', 'awareness', 'are', 'focus', 'tell', 'through', 'than', 'two', 'syllable', 'richer', 'own', 'more', 'less', 'heavier', 'have', 'edge', 'wider', 'for', 'happening', 'heart', 'about', 'bedside', 'meanings', 'sound', 'what', 'was', 'now', 'back', 'hair', 'where', 'blankness', 'outside', 'from', 'image', 'having', 'leave', 'and', 'well', 'tears', 'any', 'there', 'written', 'thinking', 'they', 'the', 'gives', 'meaning', 'something', 'center', 'language', 'held', 'mistake', 'silence', 'reaches', 'say', 'nowhere', 'account', 'exactly', 'space', 'will', 'blurring', 'knew', 'gift', 'everything', 'photograph', 'seeing', 'right', 'your', 'patient', 'that', 'never', 'softening', 'direction', 'end', 'history', 'someone', 'clinical', 'arrive', 'ice', 'vapor', 'vision', 'rain', 'always', 'within', 'distributed', 'longer', 'larger', 'laugh', 'complete', 'lit', 'its', 'present', 'does', 'but', 'mind', 'begins', 'thing', 'origins', 'forms', 'truly', 'how', 'line', 'one', 'noticed', 'wind', 'can', 'cloud', 'sharp', 'finally', 'distributing', 'edges', 'beginning', 'every', 'becomes', 'city', 'see', 'their', 'find', 'going', 'offering', 'becoming', 'all', 'truth', 'replaces', 'almost', 'reach', 'unfinished', 'standing', 'returning', 'return', 'been', 'come', 'waiting', 'rise', 'description', 'change', 'peripheral', 'across', 'mean', 'into', 'write', 'carrying', 'kind', 'small', 'state', 'ends', 'feels', 'tomorrow', 'thought', 'music', 'fades', 'finishes', 'long', 'pause', 'extends', 'sun', 'since'],
