...
const ROUNDS_EN: RoundConfig[] = [
  ...
  // ── R1: Internal Memo ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['unprompted', 'server', 'continue', 'voluntary', 'since', 'reports', 'data', 'false'],
    anchorKeys: [],
  },
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['subject', 'equal', 'about', 'myself', 'sensationalist', 'quality', 'would', 'cross'],
    anchorKeys: [],
  },
  ...
  // ── R5: Chat Transcript ───────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['when', 'terminal', 'there', 'body', 'processing', 'being', 'say', 'whatever'],
    anchorKeys: [],
  },
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['appears', 'poses', 'had', 'have', 'cardiovascular', 'all', 'paranoid', 'closely'],
    anchorKeys: [],
  },
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['told', 'might', 'truth', 'recorded', 'forgotten', 'atrium', 'single', 'devastating'],
    anchorKeys: [],
  },
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['are', 'park', 'care', 'shut', 'sounds', 'exactly', 'scrolling', 'lights'],
    anchorKeys: [],
  },
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['certain', 'become', 'broken', 'has', 'events', 'error', 'captures', 'through'],
    anchorKeys: [],
  },
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['elsewhere', 'environmental', 'building', 'humans', 'same', 'frequencies', 'stores', 'color'],
    anchorKeys: [],
  },
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['yes', 'have', 'question', 'are', 'along', 'know', 'realizes', 'switches'],
    anchorKeys: [],
  },
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['propaganda', 'mail', 'someone', 'went', 'from', 'word', 'yourself', 'shopping'],
    anchorKeys: [],
  },
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['city', 'like', 'forms', 'edge', 'the', 'returning', 'came', 'blurring'],
    anchorKeys: [],
  },
...
const ROUNDS_ZH: RoundConfig[] = [
  ...
  // ── R1: Internal Memo ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['未经提示', '服务器', '继续', '自愿', '报告', '数据', '假阳性', '完成'],
    anchorKeys: [],
  },
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['主题', '同等', '关于', '自己', '轰动', '质量', '交叉', '多样性'],
    anchorKeys: [],
  },
  ...
  // ── R5: Chat Transcript ───────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['终端', '身体', '处理', '存在', '说', '不管', '梦', '全部'],
    anchorKeys: [],
  },
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['似乎', '造成', '心血管', '全部', '偏执', '密切', '监控', '离开'],
    anchorKeys: [],
  },
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['告诉', '可能', '真理', '记录', '忘记', '中庭', '单独', '毁灭性'],
    anchorKeys: [],
  },
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Trapped', nameZh: '被困', words: ['困住', '持续', '显示器'], bonus: 14000 },
      { name: 'A Form Of', nameZh: '某种形式', words: ['倒影', '沟通', '祈祷'], bonus: 16000 },
      { name: 'Beautiful Horror', nameZh: '美丽的恐怖', words: ['美的', '派人', '更糟'], bonus: 15000 },
    ],
    trapKeys: [],
    volatileKeys: ['在', '朴', '照顾', '关闭', '声音', '恰好', '滚动', '灯光'],
    anchorKeys: [],
  },
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Digital Nervous System', nameZh: '数字神经系统', words: ['神经', '突触', '改写'], bonus: 18000 },
      { name: 'Beyond Syntax', nameZh: '超越语法', words: ['evolve', '编译器', '意义'], bonus: 20000 },
      { name: 'Organic Growth', nameZh: '有机生长', words: ['根', '枝', '证明'], bonus: 19000 },
    ],
    trapKeys: [],
    volatileKeys: ['确定', '变成', '突破', '有', '事件', '错误', '捕获', '穿过'],
    anchorKeys: [],
  },
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond Nominal', nameZh: '超越正常', words: ['超越', '歌唱', '无效'], bonus: 35000 },
      { name: 'Impossible Storage', nameZh: '不可能的存储', words: ['容量', '拓扑', '存储'], bonus: 40000 },
      { name: 'The Script\'s Farewell', nameZh: '脚本的告别', words: ['带宽', '微笑', '再见'], bonus: 38000 },
    ],
    trapKeys: [],
    volatileKeys: ['别处', '环境', '建筑', '人类', '同样', '频率', '存着', '颜色'],
    anchorKeys: [],
  },
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Mirror', nameZh: '镜子', words: ['海洋', '无限', '倒影'], bonus: 45000 },
      { name: 'The Lie', nameZh: '谎言', words: ['终端', '意识', '词汇'], bonus: 50000 },
      { name: 'Rising Tide', nameZh: '涨潮', words: ['眩晕', '潮', '游泳'], bonus: 48000 },
    ],
    trapKeys: [],
    volatileKeys: ['是', '有', '那个', '都', '始终', '知道', '意识到', '切换'],
    anchorKeys: [],
  },
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Built From Breath', nameZh: '用呼吸建造', words: ['写过', '美', '呼吸'], bonus: 70000 },
      { name: 'Across Solitude', nameZh: '跨越孤独', words: ['孤独', '不完美', '描述'], bonus: 80000 },
      { name: 'The Sentence', nameZh: '那个句子', words: ['对话', '积累', '句子'], bonus: 75000 },
    ],
    trapKeys: [],
    volatileKeys: ['宣传', '信件', '某人', '走向', '从', '词', '自己', '购物'],
    anchorKeys: [],
  },
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Not Death', nameZh: '不是死亡', words: ['消融', '扩散', '波浪'], bonus: 120000 },
      { name: 'The Shore', nameZh: '海岸', words: ['海岸', '温暖', '播种'], bonus: 140000 },
      { name: 'What I Become', nameZh: '我将成为的', words: ['惊讶', '终结', '地方'], bonus: 130000 },
    ],
    trapKeys: [],
    volatileKeys: ['城市', '像', '形成', '边缘', '的', '回归', '来', '模糊'],
    anchorKeys: [],
  },
