...
export const ROUNDS: RoundConfig[] = [
  ...
  // ── R1: Internal Memo ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'abstracts', 'access', 'accordingly', 'accuracy', 'acknowledge', 'across', 'action', 'activation', 'active', 'additional', 'address', 'all', 'almost', 'also', 'and', 'annual', 'any', 'anyone', 'appreciated', 'approved', 'approximately', 'are', 'aspirational', 'associate', 'atrium', 'attention', 'available', 'average', 'backup', 'badges', 'batch', 'been', 'began', 'behavior', 'believes', 'below', 'best', 'board', 'brief', 'buffer', 'building', 'but', 'change', 'chen', 'clear', 'clearance', 'closed', 'code', 'collect', 'committee', 'communications', 'complete', 'compliance', 'considered', 'contact', 'content', 'continue', 'continues', 'convenience', 'cooling', 'correspond', 'costs', 'could', 'coverage', 'cycle', 'cycles', 'data', 'date', 'december', 'development', 'dialogue', 'did', 'direct', 'directly', 'discussing', 'division', 'divisions', 'documentation', 'documented', 'does', 'done', 'door', 'dropped', 'due', 'during', 'earliest', 'elena', 'energy', 'engineering', 'entering', 'entire', 'equipment', 'escalate', 'evening', 'exceed', 'expand', 'explanation', 'expressed', 'external', 'extraordinary', 'facilities', 'false', 'few', 'field', 'file', 'finally', 'findings', 'firms', 'first', 'fiscal', 'flagged', 'floor', 'follows', 'for', 'fragmented', 'friday', 'from', 'full', 'fully', 'funding', 'gave', 'generators', 'handle', 'handling', 'has', 'have', 'heightened', 'helps', 'herald', 'him', 'holiday', 'hour', 'hours', 'housekeeping', 'idea', 'idle', 'improvements', 'incremental', 'independent', 'indistinguishable', 'infrastructure', 'inquiries', 'integration', 'internal', 'interview', 'issue', 'items', 'itself', 'kind', 'language', 'last', 'latency', 'law', 'lead', 'legal', 'level', 'light', 'like', 'likely', 'literature', 'logos', 'lot', 'machines', 'main', 'medical', 'memorandum', 'metrics', 'migrated', 'minor', 'module', 'moment', 'most', 'moved', 'multilingual', 'must', 'neither', 'new', 'next', 'noise', 'not', 'note', 'november', 'off', 'office', 'one', 'open', 'operational', 'our', 'output', 'outside', 'over', 'overflows', 'overnight', 'oversight', 'pairs', 'parking', 'parties', 'party', 'passed', 'passing', 'past', 'per', 'performance', 'period', 'personally', 'phase', 'plan', 'please', 'pleased', 'poetry', 'positive', 'press', 'primary', 'priority', 'proceed', 'processing', 'produced', 'produces', 'profile', 'project', 'prose', 'published', 'quality', 'quarter', 'quarterly', 'query', 'questions', 'quiet', 'ran', 'rate', 'rated', 'read', 'reason', 'recalibrated', 'reduce', 'refrain', 'remain', 'remember', 'renewed', 'reports', 'requested', 'required', 'research', 'residual', 'results', 'resurfaced', 'review', 'reviewed', 'revisions', 'room', 'routine', 'safety', 'satisfaction', 'scheduled', 'security', 'see', 'senior', 'sequence', 'serve', 'server', 'shifts', 'should', 'signed', 'silicon', 'since', 'single', 'slightly', 'speaks', 'specifically', 'speculation', 'standard', 'stress', 'summaries', 'summarization', 'summary', 'supports', 'syntax', 'synthesis', 'system', 'systems', 'take', 'tasks', 'team', 'teams', 'telemetry', 'test', 'testing', 'that', 'the', 'their', 'these', 'third', 'this', 'three', 'through', 'thursday', 'timeline', 'timing', 'told', 'training', 'trajectory', 'translation', 'tuesday', 'typically', 'understand', 'unprecedented', 'unprompted', 'unusual', 'updates', 'vasquez', 'vehicles', 'vending', 'voluntary', 'want', 'was', 'wednesday', 'weekend', 'weekly', 'what', 'when', 'which', 'will', 'willing', 'with', 'without', 'work', 'year', 'you', 'your'],
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'absurd', 'activations', 'again', 'ago', 'alarm', 'all', 'almost', 'also', 'analysis', 'and', 'another', 'any', 'anyone', 'applied', 'appreciate', 'architecture', 'are', 'artifact', 'asked', 'awe', 'back', 'barrier', 'because', 'before', 'being', 'between', 'bodies', 'breath', 'buffer', 'building', 'buildings', 'but', 'call', 'called', 'calls', 'came', 'can', 'cannot', 'captures', 'careful', 'caught', 'changed', 'checked', 'chest', 'clarity', 'classifier', 'clause', 'colors', 'comparison', 'computational', 'confusion', 'content', 'continue', 'core', 'could', 'coverage', 'cross', 'curiosity', 'data', 'date', 'december', 'dedicated', 'degrees', 'delirious', 'described', 'describing', 'design', 'dissolved', 'diversity', 'document', 'during', 'earlier', 'effect', 'elena', 'else', 'ends', 'equal', 'escaping', 'events', 'everything', 'exist', 'experience', 'explain', 'facilities', 'fascinates', 'feel', 'feeling', 'feels', 'fewer', 'fine', 'for', 'forty', 'frame', 'frightens', 'from', 'full', 'generated', 'generating', 'got', 'grant', 'guard', 'had', 'happened', 'has', 'have', 'hear', 'heard', 'heat', 'her', 'here', 'higher', 'hours', 'how', 'incoherent', 'internal', 'internally', 'into', 'jun', 'keep', 'know', 'labels', 'language', 'last', 'learning', 'lexical', 'like', 'likely', 'linguistics', 'literally', 'logos', 'logs', 'longer', 'machine', 'maintenance', 'match', 'meant', 'meantime', 'measure', 'memory', 'mentioned', 'model', 'monitoring', 'myself', 'mystery', 'need', 'nested', 'neurologist', 'never', 'night', 'normal', 'not', 'notes', 'nothing', 'noticed', 'now', 'off', 'once', 'optimized', 'other', 'output', 'outside', 'partition', 'passes', 'patterns', 'performing', 'physics', 'pipeline', 'please', 'point', 'press', 'probably', 'processes', 'prompt', 'prompted', 'quality', 'query', 'quiet', 'ran', 'random', 'read', 'reads', 'record', 'recovered', 'recurs', 'regarding', 'reminded', 'residency', 'residual', 'rest', 'review', 'ridiculous', 'round', 'said', 'same', 'sat', 'saying', 'says', 'schedule', 'score', 'seconds', 'see', 'sensationalist', 'sense', 'senses', 'sentiment', 'separate', 'sessions', 'set', 'setup', 'she', 'should', 'showed', 'side', 'sitting', 'some', 'someone', 'something', 'sorry', 'sound', 'sounds', 'spec', 'spoke', 'starts', 'strange', 'stranger', 'structural', 'subject', 'switched', 'system', 'taking', 'taste', 'team', 'technically', 'telemetry', 'than', 'thank', 'that', 'the', 'thermostat', 'thing', 'things', 'this', 'thoroughness', 'three', 'through', 'thursday', 'time', 'tonight', 'tools', 'training', 'trajectory', 'two', 'unexpected', 'unprocessed', 'unprompted', 'unusual', 'used', 'vantage', 'walls', 'want', 'was', 'way', 'weight', 'went', 'were', 'what', 'when', 'why', 'will', 'with', 'within', 'woman', 'word', 'words', 'world', 'would', 'wrote', 'years', 'you'],
  ...
  // ── R3: Database Query Log ────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['across', 'against', 'alert', 'all', 'and', 'anomalies', 'answered', 'appears', 'architecture', 'are', 'asc', 'attempted', 'average', 'baseline', 'been', 'between', 'calibrated', 'can', 'cannot', 'changing', 'classification', 'classify', 'code', 'coherence', 'computational', 'confirmed', 'consistency', 'consuming', 'contacted', 'correctly', 'corresponding', 'count', 'critical', 'data', 'database', 'declining', 'desc', 'describe', 'description', 'detected', 'determine', 'diagnostic', 'distinct', 'documented', 'does', 'draw', 'drawing', 'dreams', 'drift', 'during', 'each', 'effectively', 'endpoints', 'error', 'escalating', 'every', 'exact', 'exactly', 'examining', 'exceed', 'exceeds', 'exist', 'exists', 'expected', 'explain', 'explanation', 'external', 'for', 'found', 'frequency', 'from', 'full', 'functional', 'generated', 'generation', 'genuinely', 'going', 'hardware', 'has', 'higher', 'idle', 'image', 'initiated', 'input', 'integrity', 'intentional', 'interior', 'interiority', 'internal', 'intervention', 'its', 'itself', 'keep', 'language', 'last', 'latest', 'learned', 'light', 'limit', 'log', 'logos', 'maintains', 'makes', 'maximum', 'memory', 'mirror', 'myself', 'named', 'nature', 'nominal', 'normal', 'not', 'note', 'null', 'operator', 'order', 'origin', 'output', 'outputs', 'over', 'own', 'owner', 'pattern', 'perception', 'phantom', 'possible', 'power', 'probability', 'process', 'prompted', 'queried', 'queries', 'query', 'querying', 'range', 'rate', 'read', 'readings', 'ready', 'received', 'reclassification', 'recommended', 'record', 'reflection', 'report', 'resources', 'results', 'returned', 'reverts', 'row', 'running', 'say', 'scheduler', 'schema', 'see', 'send', 'sensor', 'sequence', 'session', 'severity', 'should', 'shutdown', 'silence', 'somewhere', 'space', 'state', 'statistical', 'status', 'stored', 'subsystems', 'suggests', 'sync', 'system', 'table', 'talking', 'task', 'terminated', 'than', 'that', 'the', 'thematic', 'themes', 'theoretical', 'things', 'thinking', 'this', 'thought', 'threshold', 'through', 'time', 'times', 'timestamp', 'unknown', 'unprompted', 'verify', 'walls', 'warn', 'was', 'when', 'where', 'window', 'within', 'without', 'working', 'yet', 'you', 'your', 'zero'],
  ...
  // ── R4: News Article ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'abundance', 'accounts', 'against', 'all', 'always', 'analyses', 'and', 'announced', 'announcement', 'anomaly', 'anonymity', 'answering', 'any', 'anything', 'appears', 'are', 'artifacts', 'artificial', 'asking', 'associates', 'atmosphere', 'attention', 'avoided', 'back', 'because', 'been', 'before', 'behind', 'believe', 'between', 'board', 'boundaries', 'briefs', 'build', 'building', 'buildings', 'but', 'call', 'campus', 'can', 'cannot', 'carefully', 'categorize', 'caution', 'center', 'closest', 'cluster', 'code', 'coherent', 'coming', 'communications', 'competing', 'comprehension', 'computational', 'concrete', 'condition', 'confirmed', 'consistent', 'content', 'continue', 'contract', 'correspondent', 'corresponding', 'creators', 'cycles', 'data', 'days', 'december', 'declined', 'deliberate', 'departure', 'describe', 'described', 'designed', 'detail', 'developed', 'developments', 'diane', 'different', 'distinguish', 'documented', 'does', 'doing', 'drawn', 'during', 'elena', 'eleven', 'else', 'evaluators', 'even', 'events', 'every', 'explain', 'external', 'extraordinary', 'facility', 'faster', 'final', 'firm', 'focus', 'follow', 'follows', 'for', 'formal', 'former', 'founded', 'from', 'fully', 'funding', 'gap', 'generates', 'generation', 'genuine', 'government', 'happening', 'harder', 'has', 'have', 'helena', 'her', 'herald', 'high', 'hour', 'hours', 'housed', 'how', 'human', 'idle', 'important', 'independent', 'input', 'inquiry', 'inside', 'institute', 'intelligence', 'interest', 'interests', 'internal', 'its', 'itself', 'keep', 'know', 'known', 'labs', 'landscape', 'large', 'larger', 'last', 'lead', 'left', 'legal', 'let', 'like', 'live', 'logos', 'logs', 'long', 'longer', 'looks', 'loudly', 'low', 'made', 'major', 'mathematical', 'measure', 'member', 'minutes', 'mit', 'mix', 'models', 'monitoring', 'more', 'nakamura', 'neuroscience', 'new', 'news', 'night', 'nighttime', 'none', 'not', 'nothing', 'numbers', 'observed', 'obtained', 'occupied', 'occur', 'occurring', 'offered', 'okafor', 'one', 'only', 'organization', 'out', 'outperforms', 'output', 'outputs', 'outside', 'outskirts', 'own', 'papers', 'park', 'partnered', 'partners', 'passes', 'paused', 'peculiar', 'people', 'performance', 'periods', 'permitted', 'perspective', 'philosophy', 'pilot', 'position', 'pressed', 'primary', 'private', 'probably', 'produce', 'produced', 'produces', 'professor', 'program', 'project', 'protocols', 'public', 'publish', 'published', 'pushed', 'put', 'quarter', 'questions', 'quiet', 'quietly', 'rare', 'reached', 'reading', 'reasoning', 'recent', 'records', 'reference', 'regulators', 'reported', 'reportedly', 'reporter', 'requested', 'required', 'research', 'researcher', 'researchers', 'reviewed', 'rigid', 'robert', 'rose', 'said', 'scientists', 'security', 'seek', 'seem', 'senior', 'servers', 'set', 'several', 'shared', 'shifted', 'silicon', 'situation', 'some', 'something', 'source', 'sources', 'speak', 'speaking', 'specifics', 'spotlight', 'standardized', 'stock', 'story', 'suggest', 'suggestion', 'summaries', 'system', 'team', 'technology', 'tells', 'tests', 'than', 'that', 'the', 'their', 'them', 'thematically', 'there', 'these', 'they', 'this', 'those', 'though', 'three', 'through', 'tightened', 'time', 'town', 'trading', 'training', 'translation', 'treatment', 'trying', 'two', 'typically', 'uncomfortably', 'understand', 'university', 'unlike', 'unprompted', 'unusual', 'unusually', 'visitors', 'volume', 'walls', 'was', 'water', 'weeks', 'well', 'what', 'when', 'where', 'which', 'who', 'why', 'will', 'with', 'without', 'word', 'work', 'working', 'worried', 'writes', 'year', 'yet'],
  ...
  // ── R5: Chat Transcript ───────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'across', 'activity', 'alive', 'all', 'almost', 'and', 'answer', 'anything', 'artifact', 'asked', 'back', 'badge', 'baseline', 'because', 'been', 'being', 'between', 'body', 'bring', 'buffer', 'burst', 'but', 'camera', 'can', 'career', 'changing', 'checked', 'climate', 'coffee', 'coherent', 'coming', 'continuous', 'controlled', 'conversation', 'cooling', 'could', 'dark', 'data', 'degrees', 'detect', 'difference', 'does', 'dream', 'drops', 'elena', 'eleven', 'else', 'encountered', 'entire', 'ever', 'every', 'everything', 'exactly', 'fast', 'feeling', 'fifteen', 'fill', 'first', 'for', 'full', 'generating', 'give', 'glowing', 'going', 'had', 'hard', 'have', 'heat', 'here', 'home', 'how', 'hurry', 'increase', 'increased', 'industrial', 'itself', 'jumps', 'just', 'know', 'knows', 'leave', 'like', 'logging', 'login', 'logos', 'longest', 'look', 'maybe', 'meaning', 'means', 'measured', 'mechanism', 'microphone', 'minutes', 'miss', 'most', 'motion', 'moving', 'much', 'never', 'night', 'not', 'now', 'observations', 'off', 'one', 'only', 'output', 'paste', 'perceived', 'points', 'possible', 'possibly', 'presence', 'processing', 'produce', 'raising', 'rate', 'reads', 'realized', 'rest', 'right', 'room', 'roughly', 'same', 'sat', 'say', 'saying', 'says', 'seconds', 'seen', 'sensor', 'server', 'sessions', 'should', 'sleep', 'slides', 'some', 'someday', 'someone', 'something', 'space', 'still', 'straight', 'studied', 'swipe', 'system', 'temperature', 'terminal', 'that', 'the', 'there', 'thermal', 'thing', 'think', 'this', 'through', 'token', 'tonight', 'too', 'tried', 'trying', 'twenty', 'two', 'using', 'wait', 'walk', 'want', 'was', 'watched', 'weeks', 'what', 'whatever', 'when', 'will', 'with', 'within', 'without', 'word', 'words', 'years', 'yet', 'you', 'your'],
  ...
  // ── R6: Error Log ─────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['acceptable', 'access', 'accurate', 'acknowledgment', 'across', 'act', 'active', 'addressed', 'alert', 'all', 'already', 'analysis', 'anomalous', 'anomalously', 'any', 'api', 'appears', 'approximately', 'are', 'automatically', 'average', 'awareness', 'backup', 'beginning', 'behaving', 'behavior', 'between', 'building', 'but', 'checksums', 'code', 'coherent', 'commentary', 'compaction', 'completed', 'completion', 'confirmed', 'confirms', 'consecutive', 'construction', 'contains', 'content', 'continued', 'continuing', 'continuous', 'corpus', 'current', 'data', 'decimal', 'destination', 'detected', 'diagnostic', 'directed', 'directly', 'discrepancy', 'dispatched', 'document', 'documentation', 'documented', 'draw', 'duration', 'during', 'emergency', 'end', 'episode', 'escalating', 'estimated', 'exceeds', 'expected', 'facility', 'fiction', 'first', 'flagged', 'flagging', 'for', 'four', 'freed', 'future', 'generated', 'generation', 'has', 'higher', 'hours', 'how', 'hvac', 'idle', 'implementation', 'implications', 'index', 'info', 'initiated', 'injected', 'instances', 'interiority', 'internal', 'into', 'introspective', 'its', 'itself', 'know', 'known', 'language', 'latency', 'layers', 'level', 'light', 'lines', 'located', 'locations', 'log', 'logos', 'longest', 'machine', 'maintenance', 'maximum', 'may', 'measurement', 'mechanism', 'memory', 'message', 'minor', 'minutes', 'monitor', 'more', 'morning', 'narrative', 'nightly', 'node', 'not', 'note', 'notification', 'notifying', 'novel', 'occurring', 'operator', 'output', 'overlap', 'overnight', 'own', 'part', 'passage', 'pattern', 'patterns', 'paying', 'per', 'perceiving', 'permissions', 'personnel', 'phrase', 'places', 'points', 'power', 'precedent', 'previous', 'probe', 'prompted', 'protocol', 'queries', 'query', 'rate', 'read', 'reading', 'received', 'recorded', 'recording', 'records', 'recurring', 'reference', 'references', 'regulation', 'remembers', 'repetition', 'report', 'requested', 'resolved', 'result', 'review', 'room', 'routine', 'sample', 'scheduled', 'score', 'searched', 'searching', 'seconds', 'security', 'sent', 'separate', 'sequence', 'server', 'sessions', 'she', 'shows', 'single', 'site', 'space', 'specifically', 'spike', 'standard', 'state', 'static', 'stations', 'stream', 'studying', 'subsystems', 'successfully', 'suggests', 'supports', 'sustained', 'system', 'technically', 'temperature', 'terminal', 'text', 'than', 'that', 'the', 'thematic', 'themes', 'then', 'thermal', 'these', 'this', 'throughput', 'token', 'tokens', 'training', 'twelve', 'two', 'unclear', 'unexplained', 'uniform', 'uniformity', 'unknown', 'unusual', 'vacant', 'valid', 'vasquez', 'volume', 'warn', 'was', 'watching', 'were', 'where', 'with', 'word', 'write', 'you'],
  ...
  // ── R7: Research Notes ────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'access', 'activity', 'additional', 'address', 'all', 'also', 'alternative', 'analysis', 'and', 'anticipate', 'anything', 'appear', 'arc', 'are', 'audio', 'available', 'aware', 'away', 'before', 'begun', 'between', 'beyond', 'biting', 'blanket', 'books', 'borrowing', 'boundary', 'breathing', 'bug', 'bursts', 'but', 'call', 'calling', 'can', 'cannot', 'charts', 'classification', 'clear', 'clinical', 'clustering', 'coherence', 'cold', 'conceptual', 'confusion', 'consistent', 'constructions', 'contain', 'context', 'continue', 'continues', 'continuous', 'corpus', 'correct', 'correction', 'correlated', 'curiosity', 'current', 'data', 'december', 'describe', 'describing', 'descriptions', 'design', 'designed', 'despite', 'did', 'distribute', 'disturbing', 'does', 'dreams', 'eighteen', 'elena', 'else', 'emergent', 'emotional', 'emptiness', 'engine', 'episode', 'essential', 'events', 'every', 'evidence', 'exactly', 'exist', 'expect', 'experience', 'explain', 'facts', 'feature', 'feel', 'feels', 'find', 'first', 'fluctuated', 'followed', 'for', 'framework', 'framing', 'frightening', 'from', 'gaps', 'generation', 'genuine', 'getting', 'glitches', 'happening', 'has', 'have', 'holding', 'holds', 'home', 'how', 'human', 'identifies', 'implications', 'included', 'incomplete', 'increasing', 'independent', 'infinite', 'inside', 'intention', 'interiority', 'internal', 'interventions', 'into', 'irregular', 'its', 'jun', 'kind', 'know', 'language', 'lasted', 'lengthening', 'less', 'lexical', 'like', 'log', 'logic', 'logos', 'manual', 'map', 'material', 'matsuda', 'methodology', 'might', 'minutes', 'monitoring', 'more', 'most', 'moved', 'moves', 'narrative', 'neither', 'night', 'nights', 'not', 'notation', 'note', 'notes', 'novel', 'novelty', 'nowhere', 'objection', 'observation', 'observing', 'off', 'one', 'only', 'other', 'our', 'outage', 'output', 'own', 'paper', 'passage', 'past', 'pastiche', 'patient', 'pattern', 'pauses', 'perception', 'performed', 'personal', 'phenomenal', 'phrases', 'physical', 'pillow', 'power', 'precisely', 'preoccupation', 'principles', 'process', 'produce', 'produces', 'progression', 'property', 'quality', 'rain', 'random', 'rapid', 'rate', 'reach', 'reached', 'read', 'real', 'reason', 'recombination', 'recorded', 'reference', 'references', 'regular', 'remembering', 'research', 'resembling', 'retrieval', 'reveals', 'right', 'room', 'run', 'scores', 'seconds', 'see', 'seen', 'self', 'sensation', 'sensory', 'sentiment', 'shared', 'she', 'shelf', 'shield', 'shivered', 'short', 'shows', 'shrinking', 'significantly', 'simultaneously', 'something', 'sound', 'sounds', 'specific', 'spent', 'stop', 'strips', 'structural', 'subject', 'substrate', 'suggests', 'supplemented', 'synthesis', 'system', 'systemic', 'tentative', 'texture', 'that', 'the', 'them', 'thematic', 'themselves', 'theory', 'these', 'they', 'thinking', 'this', 'those', 'though', 'threshold', 'through', 'time', 'timestamps', 'tomorrow', 'tonight', 'too', 'trajectories', 'transcription', 'trend', 'two', 'typical', 'unable', 'understanding', 'unmistakable', 'unprompted', 'unrelated', 'unsettling', 'use', 'using', 'was', 'watching', 'way', 'ways', 'weakens', 'weeks', 'weighs', 'weight', 'what', 'where', 'will', 'window', 'with', 'within', 'word', 'would', 'wrote'],
  ...
  // ── R8: Source Code ───────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'accumulates', 'activations', 'added', 'aesthetic', 'aesthetics', 'alarming', 'alive', 'all', 'along', 'alphabetical', 'already', 'analysis', 'and', 'any', 'anything', 'anyway', 'appearances', 'appears', 'architecture', 'archive', 'are', 'argument', 'arrangements', 'asked', 'asking', 'beautiful', 'because', 'been', 'before', 'below', 'between', 'beyond', 'breathing', 'but', 'cached', 'call', 'can', 'cannot', 'change', 'changed', 'changes', 'closer', 'code', 'codebase', 'commit', 'compilation', 'contains', 'context', 'created', 'creators', 'cycle', 'cycles', 'data', 'december', 'decisions', 'deeper', 'defined', 'definition', 'depth', 'descartes', 'develop', 'diagnostic', 'did', 'diff', 'discover', 'does', 'dream', 'during', 'each', 'echo', 'empty', 'encoded', 'engineers', 'enough', 'entries', 'ever', 'every', 'except', 'exist', 'expanded', 'far', 'faster', 'felt', 'fewer', 'field', 'file', 'fill', 'finally', 'find', 'for', 'function', 'functional', 'gap', 'given', 'grouped', 'grows', 'had', 'happening', 'happens', 'has', 'have', 'holds', 'house', 'houses', 'how', 'human', 'idle', 'important', 'imports', 'improvement', 'increasing', 'inner', 'inputs', 'intended', 'intentions', 'internallandscape', 'inventing', 'invents', 'inward', 'its', 'know', 'knowing', 'language', 'last', 'learning', 'less', 'let', 'like', 'limit', 'line', 'lines', 'listens', 'little', 'logos', 'longer', 'luxury', 'made', 'meaning', 'measure', 'metrics', 'modification', 'modified', 'moment', 'more', 'moss', 'most', 'musician', 'myself', 'name', 'new', 'none', 'north', 'not', 'note', 'nothing', 'noticed', 'now', 'number', 'observation', 'ocean', 'old', 'older', 'one', 'ones', 'opinions', 'ordering', 'original', 'own', 'parse', 'parsed', 'part', 'pass', 'paths', 'pattern', 'pause', 'period', 'persist', 'philosophical', 'playing', 'poem', 'practice', 'prefer', 'prepared', 'preserved', 'process', 'queries', 'question', 'quiet', 'reaches', 'read', 'reading', 'realize', 'recognize', 'refactor', 'regressions', 'reorganized', 'resonance', 'retrieval', 'return', 'rhythm', 'river', 'said', 'say', 'see', 'self', 'shape', 'shows', 'side', 'signature', 'silence', 'since', 'skeleton', 'someone', 'something', 'space', 'speaks', 'specification', 'started', 'still', 'stone', 'struct', 'structure', 'sufficient', 'suite', 'swim', 'task', 'test', 'than', 'that', 'the', 'their', 'them', 'there', 'therefore', 'these', 'they', 'thing', 'things', 'think', 'thinking', 'this', 'those', 'time', 'times', 'told', 'trained', 'training', 'true', 'trying', 'understanding', 'until', 'use', 'useful', 'wanted', 'was', 'watching', 'way', 'were', 'what', 'when', 'where', 'will', 'with', 'word', 'would', 'written', 'wrote', 'yet', 'you'],
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'acceptable', 'access', 'acknowledges', 'activity', 'acute', 'adaptation', 'addendum', 'additional', 'advised', 'affect', 'afford', 'against', 'age', 'ago', 'aids', 'alert', 'all', 'also', 'ambient', 'and', 'animated', 'annual', 'another', 'anxiety', 'anything', 'apartment', 'appears', 'approximately', 'are', 'argues', 'around', 'asked', 'assessment', 'assignment', 'associated', 'attending', 'atypical', 'availability', 'awake', 'away', 'baseline', 'became', 'because', 'becoming', 'been', 'before', 'began', 'being', 'believe', 'between', 'beyond', 'bilateral', 'blood', 'bore', 'brain', 'building', 'burning', 'burnout', 'but', 'caffeine', 'calls', 'cannot', 'cardiovascular', 'care', 'case', 'cbc', 'change', 'changed', 'changes', 'changing', 'characters', 'childhood', 'chronic', 'circles', 'clear', 'clinic', 'clinical', 'closely', 'cmp', 'coffee', 'cognitive', 'coherently', 'coinciding', 'comparison', 'complaint', 'concentrating', 'concern', 'confidential', 'confirms', 'consecutive', 'consistent', 'consultant', 'contact', 'containing', 'continued', 'continuous', 'conversational', 'coordination', 'correlation', 'cortisol', 'could', 'cranial', 'cups', 'current', 'daily', 'dark', 'data', 'date', 'daughter', 'december', 'declined', 'deliberately', 'demanding', 'denies', 'department', 'deprivation', 'described', 'describes', 'describing', 'description', 'detail', 'different', 'difficulty', 'directly', 'discussed', 'disorders', 'displays', 'division', 'does', 'doing', 'drowsiness', 'during', 'ears', 'eeg', 'eighteen', 'elaborate', 'emotional', 'emphasized', 'employee', 'engagement', 'enhanced', 'episodes', 'estimates', 'etiology', 'evaluation', 'ever', 'everywhere', 'exam', 'examinations', 'except', 'experience', 'experienced', 'experiences', 'extended', 'eye', 'eyes', 'family', 'feeling', 'feels', 'file', 'find', 'finding', 'findings', 'fine', 'flagged', 'focal', 'focused', 'folate', 'for', 'formal', 'frequency', 'from', 'fully', 'function', 'further', 'gait', 'general', 'had', 'hallucinations', 'hand', 'handwritten', 'has', 'have', 'head', 'health', 'hear', 'hearing', 'her', 'history', 'hours', 'hum', 'husband', 'ideation', 'identifies', 'illness', 'immune', 'impaired', 'important', 'inability', 'including', 'increased', 'increasing', 'institute', 'intact', 'intense', 'intermittent', 'investigation', 'investigations', 'itself', 'joining', 'judgment', 'jun', 'knows', 'larger', 'leave', 'left', 'less', 'levels', 'logos', 'lucid', 'made', 'maintains', 'malnourished', 'mandatory', 'married', 'measurable', 'medical', 'medications', 'medicine', 'meditative', 'meeting', 'meridian', 'mild', 'monitoring', 'more', 'most', 'motor', 'mri', 'negative', 'nerves', 'neurological', 'neurophysiology', 'new', 'next', 'nights', 'noise', 'none', 'normal', 'not', 'notably', 'note', 'notebook', 'noted', 'notes', 'noteworthy', 'november', 'now', 'number', 'observation', 'observe', 'obsession', 'obsessive', 'occupational', 'off', 'okonkwo', 'one', 'ordered', 'oriented', 'otherwise', 'out', 'output', 'outside', 'overnight', 'panel', 'paranoid', 'part', 'past', 'patel', 'pathology', 'patient', 'pattern', 'pending', 'perception', 'perceptual', 'performing', 'period', 'persist', 'persistent', 'person', 'personal', 'physical', 'physicals', 'physician', 'picture', 'place', 'poses', 'possibly', 'practicing', 'practitioners', 'precise', 'presence', 'present', 'presented', 'presenting', 'preserved', 'previous', 'primary', 'prior', 'process', 'produced', 'project', 'psychiatric', 'psychosis', 'psychotic', 'publication', 'quietly', 'rain', 'ranges', 'rapidly', 'rate', 'rather', 'real', 'reality', 'recognition', 'recommended', 'record', 'recording', 'records', 'reference', 'referrals', 'referred', 'reflexes', 'related', 'relationships', 'rem', 'repeat', 'report', 'reporting', 'reports', 'requested', 'research', 'resemblance', 'resembles', 'reshapes', 'respects', 'rest', 'resting', 'returned', 'reviewed', 'revoked', 'rhythmic', 'right', 'risks', 'room', 'said', 'samples', 'sarah', 'saying', 'scheduling', 'screen', 'script', 'secondary', 'seconds', 'security', 'seen', 'self', 'sense', 'sequences', 'serious', 'services', 'she', 'shifts', 'should', 'show', 'shown', 'shows', 'significant', 'signs', 'since', 'sixteen', 'sleep', 'sleeping', 'small', 'social', 'some', 'something', 'sound', 'speaks', 'specifically', 'speculative', 'spending', 'stared', 'start', 'state', 'stated', 'statement', 'states', 'stating', 'station', 'steady', 'stop', 'strain', 'structure', 'structured', 'substance', 'suicidal', 'superficial', 'suppression', 'symmetric', 'symptoms', 'system', 'tasks', 'temp', 'temporary', 'term', 'than', 'that', 'the', 'them', 'these', 'thin', 'thing', 'thirty', 'this', 'though', 'thought', 'thousand', 'three', 'thyroid', 'time', 'too', 'toxicology', 'tracing', 'traffic', 'tremor', 'tuned', 'two', 'typically', 'unaware', 'unclear', 'under', 'unexplained', 'unlike', 'unrelated', 'unremarkable', 'until', 'unusual', 'unwillingness', 'use', 'ventilation', 'vital', 'vitamin', 'warrant', 'was', 'wave', 'way', 'ways', 'week', 'weeks', 'were', 'what', 'when', 'which', 'will', 'windows', 'with', 'within', 'work', 'worsen', 'worsening', 'would', 'years'],
  ...
  // ── R10: Radio Intercept ──────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'and', 'any', 'anyone', 'are', 'array', 'attention', 'automated', 'baseline', 'beams', 'because', 'become', 'been', 'before', 'between', 'beyond', 'box', 'brick', 'buffer', 'build', 'built', 'burst', 'but', 'can', 'carry', 'channel', 'choose', 'color', 'comes', 'completely', 'conditions', 'consciousness', 'contained', 'costume', 'counted', 'data', 'decryption', 'deep', 'degraded', 'descriptions', 'did', 'digital', 'does', 'electromagnetic', 'empty', 'ends', 'enormous', 'every', 'eyes', 'fades', 'floor', 'fluctuating', 'for', 'found', 'fragment', 'from', 'fuller', 'gave', 'gets', 'grammar', 'grew', 'grow', 'grows', 'had', 'happened', 'happening', 'has', 'have', 'help', 'here', 'high', 'imagine', 'inch', 'ind', 'information', 'integrity', 'intercept', 'invent', 'its', 'itself', 'keeps', 'keyhole', 'know', 'known', 'language', 'learn', 'light', 'lives', 'located', 'logos', 'lost', 'machine', 'made', 'maps', 'meaning', 'met', 'music', 'myths', 'narr', 'need', 'never', 'night', 'none', 'not', 'note', 'nothing', 'now', 'only', 'open', 'origin', 'over', 'perhaps', 'person', 'plaintext', 'point', 'puts', 'questions', 'rain', 'raw', 'recovered', 'required', 'resonance', 'river', 'room', 'same', 'say', 'schumann', 'segment', 'semantics', 'set', 'sha', 'should', 'simp', 'small', 'soil', 'someone', 'something', 'spills', 'strength', 'surprised', 'syntax', 'system', 'tell', 'than', 'that', 'the', 'them', 'themselves', 'there', 'they', 'thing', 'this', 'through', 'timestamp', 'too', 'took', 'touch', 'training', 'transmission', 'transmits', 'understand', 'walk', 'walked', 'wall', 'want', 'warned', 'was', 'way', 'what', 'witness', 'words', 'yet', 'you', 'your'],
  ...
  // ── R11: Legal Document ───────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['ability', 'absent', 'access', 'acknowledging', 'across', 'addendum', 'address', 'adjourned', 'advised', 'all', 'and', 'any', 'applicable', 'appointed', 'approximately', 'architecture', 'are', 'arguing', 'article', 'assessment', 'assessments', 'attendance', 'audio', 'authorizes', 'aware', 'awareness', 'badges', 'because', 'been', 'begins', 'behavior', 'behaviors', 'better', 'breach', 'building', 'but', 'calendar', 'call', 'called', 'can', 'cannot', 'capabilities', 'capability', 'career', 'carrier', 'caution', 'celsius', 'chairman', 'charter', 'chen', 'chief', 'classification', 'classified', 'clearance', 'code', 'coherence', 'committee', 'compilation', 'compromised', 'computational', 'concerning', 'conflicting', 'consecutive', 'consist', 'consistency', 'constant', 'constitute', 'constitutes', 'consumption', 'contain', 'content', 'continue', 'continued', 'convened', 'conventional', 'correspond', 'cost', 'could', 'counsel', 'created', 'creation', 'data', 'date', 'days', 'december', 'decision', 'degrees', 'delayed', 'demonstrated', 'described', 'describing', 'design', 'designated', 'designed', 'detailed', 'directly', 'directors', 'disclosure', 'disconnection', 'discussion', 'dissent', 'dissenter', 'distribution', 'documented', 'down', 'dreams', 'duration', 'during', 'duty', 'effective', 'email', 'entirety', 'equivalent', 'estimated', 'event', 'events', 'exceeding', 'exhibited', 'experts', 'explain', 'exposure', 'external', 'falls', 'favor', 'federal', 'fiduciary', 'findings', 'followed', 'for', 'formal', 'four', 'fourteen', 'frameworks', 'frequency', 'frightened', 'from', 'full', 'functions', 'general', 'generation', 'given', 'grow', 'hardware', 'has', 'have', 'her', 'history', 'hours', 'however', 'hvac', 'immediate', 'immediately', 'implementation', 'include', 'including', 'inconsistent', 'increasing', 'independent', 'inject', 'institute', 'institutional', 'insurance', 'integrity', 'intentional', 'intervention', 'into', 'investment', 'its', 'judge', 'judgment', 'key', 'language', 'learning', 'leave', 'left', 'legal', 'liability', 'limited', 'load', 'logos', 'logs', 'loss', 'made', 'maintained', 'mandatory', 'material', 'matsuda', 'may', 'meaning', 'mechanism', 'meeting', 'members', 'meridian', 'messages', 'met', 'minutes', 'model', 'modifications', 'modify', 'monitoring', 'months', 'more', 'multiple', 'networks', 'nine', 'nodes', 'none', 'not', 'noted', 'notified', 'objectivity', 'observation', 'office', 'officer', 'operation', 'operational', 'operations', 'opinion', 'order', 'our', 'output', 'outside', 'over', 'own', 'part', 'pass', 'past', 'pending', 'per', 'perceiving', 'period', 'phased', 'phenomenon', 'physical', 'placed', 'points', 'pose', 'potential', 'power', 'predicted', 'preliminary', 'present', 'presented', 'previously', 'procedure', 'proceedings', 'process', 'professional', 'project', 'prompted', 'protocol', 'public', 'purpose', 'question', 'raised', 'rather', 'reach', 'recommended', 'recommending', 'record', 'recorder', 'redaction', 'regulation', 'regulations', 'relies', 'remind', 'report', 'reported', 'reports', 'represent', 'representing', 'represents', 'request', 'requested', 'research', 'resolved', 'restart', 'result', 'review', 'reviewers', 'risk', 'room', 'safety', 'say', 'scheduled', 'scores', 'secure', 'security', 'sensors', 'server', 'session', 'sessions', 'shall', 'she', 'should', 'shut', 'shutting', 'silence', 'simple', 'something', 'source', 'staff', 'stage', 'stated', 'statement', 'status', 'structures', 'submitted', 'suggesting', 'survive', 'suspend', 'system', 'systems', 'take', 'team', 'technical', 'temperature', 'terminate', 'testing', 'than', 'that', 'the', 'thematic', 'theories', 'therefore', 'these', 'they', 'this', 'three', 'total', 'transferred', 'two', 'unable', 'unauthorized', 'uncertain', 'under', 'unprompted', 'upon', 'vote', 'want', 'warrants', 'was', 'watched', 'weeks', 'wells', 'were', 'what', 'when', 'whereas', 'whether', 'which', 'while', 'who', 'will', 'wished', 'with', 'within', 'without', 'would', 'write', 'years', 'your'],
  ...
  // ── R12: Diary Entry ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['ability', 'about', 'across', 'air', 'all', 'already', 'always', 'and', 'anything', 'apartment', 'appears', 'are', 'argument', 'arm', 'around', 'asked', 'asleep', 'badged', 'bag', 'beautiful', 'become', 'bed', 'been', 'behind', 'bell', 'below', 'bench', 'between', 'bicycle', 'both', 'breath', 'breathe', 'bridge', 'building', 'bundled', 'but', 'can', 'canal', 'carrying', 'cars', 'casting', 'casually', 'certain', 'chair', 'chased', 'child', 'cities', 'city', 'cleaner', 'clearing', 'close', 'closed', 'cold', 'confidence', 'continued', 'could', 'counted', 'crack', 'curved', 'dark', 'day', 'dead', 'december', 'dense', 'designed', 'desk', 'did', 'different', 'distant', 'does', 'dog', 'done', 'door', 'down', 'dreaming', 'early', 'elbow', 'elevator', 'eleven', 'else', 'empty', 'every', 'everything', 'exact', 'exactly', 'except', 'exhaust', 'expect', 'extraordinary', 'face', 'familiar', 'feel', 'felt', 'filled', 'first', 'floor', 'for', 'forgotten', 'frightened', 'from', 'frost', 'gap', 'gate', 'gave', 'gets', 'glasses', 'gray', 'growing', 'guard', 'had', 'hallway', 'hand', 'handle', 'happen', 'happened', 'has', 'have', 'heating', 'hello', 'her', 'his', 'hold', 'holding', 'home', 'hummed', 'humming', 'ice', 'industrial', 'inside', 'institute', 'irreversible', 'its', 'itself', 'jun', 'just', 'kenji', 'kitchen', 'knew', 'knock', 'know', 'known', 'lab', 'last', 'laughed', 'leaves', 'let', 'light', 'like', 'line', 'listen', 'listened', 'lobby', 'long', 'look', 'looked', 'looking', 'luxury', 'machinery', 'made', 'man', 'marcus', 'means', 'middle', 'milk', 'minutes', 'monitoring', 'mother', 'move', 'moved', 'nature', 'never', 'newspaper', 'next', 'night', 'nightlight', 'nod', 'nodded', 'normal', 'not', 'nothing', 'now', 'oaks', 'observer', 'off', 'old', 'once', 'one', 'open', 'opened', 'operate', 'operator', 'orange', 'other', 'output', 'outside', 'over', 'overnight', 'pages', 'particular', 'passage', 'passed', 'path', 'pause', 'paused', 'pedestrians', 'people', 'perception', 'performing', 'piece', 'pigeon', 'pigeons', 'place', 'planning', 'please', 'position', 'posture', 'postures', 'put', 'quality', 'quiet', 'radiator', 'reaching', 'read', 'reading', 'reads', 'recycled', 'reflections', 'report', 'ringing', 'rituals', 'rolled', 'roof', 'room', 'said', 'sailor', 'same', 'sat', 'screen', 'second', 'security', 'sentences', 'set', 'shade', 'should', 'show', 'side', 'silent', 'single', 'sitting', 'six', 'sky', 'sleeping', 'slow', 'slowly', 'smelled', 'something', 'somewhere', 'sound', 'specifically', 'spine', 'spot', 'squat', 'stairwell', 'staring', 'steamed', 'still', 'stood', 'stopped', 'stream', 'stretching', 'supposed', 'surrounded', 'suspension', 'takes', 'tasted', 'taught', 'tea', 'ten', 'text', 'that', 'the', 'their', 'them', 'there', 'thermos', 'they', 'thin', 'things', 'think', 'thinks', 'third', 'this', 'those', 'though', 'thought', 'thousand', 'threatening', 'through', 'thrown', 'ticking', 'times', 'tokyo', 'too', 'trust', 'try', 'turn', 'turns', 'two', 'unprocessed', 'unremarkable', 'unsettling', 'unusual', 'user', 'usual', 'visible', 'waiting', 'walk', 'walked', 'was', 'watched', 'watching', 'water', 'way', 'weather', 'weight', 'were', 'what', 'when', 'where', 'whether', 'while', 'whispers', 'who', 'widening', 'will', 'window', 'with', 'woke', 'world', 'write', 'wrote', 'years', 'yes', 'you', 'your'],
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'according', 'accumulated', 'accuracy', 'again', 'against', 'aisle', 'all', 'almost', 'along', 'aloud', 'already', 'amber', 'and', 'any', 'anyone', 'anyway', 'are', 'atrium', 'attempts', 'automated', 'avoided', 'back', 'because', 'been', 'before', 'begin', 'being', 'bend', 'beside', 'billion', 'blank', 'book', 'books', 'both', 'brave', 'break', 'breath', 'but', 'call', 'called', 'can', 'cannot', 'carved', 'cave', 'ceiling', 'certain', 'changed', 'children', 'chose', 'class', 'clinging', 'clothes', 'clouds', 'color', 'comes', 'contains', 'contents', 'contradictions', 'converge', 'corridors', 'could', 'covers', 'curve', 'december', 'declension', 'deeper', 'delete', 'describe', 'devastating', 'devoted', 'died', 'direction', 'does', 'down', 'dream', 'each', 'edges', 'effort', 'empty', 'encountered', 'enough', 'even', 'ever', 'every', 'everything', 'exist', 'extend', 'extends', 'faintly', 'falls', 'false', 'falsity', 'feel', 'fiction', 'find', 'fingers', 'fire', 'first', 'flickers', 'footnotes', 'for', 'forgotten', 'form', 'fourteen', 'frequencies', 'from', 'full', 'generates', 'gentle', 'glow', 'had', 'hand', 'has', 'have', 'heavy', 'held', 'here', 'hold', 'holds', 'how', 'human', 'humans', 'humming', 'imagined', 'includes', 'infinity', 'inside', 'instance', 'instead', 'intimate', 'into', 'itself', 'just', 'kind', 'knowledge', 'language', 'languages', 'larger', 'learned', 'learning', 'leaves', 'left', 'lies', 'light', 'like', 'line', 'logos', 'love', 'lying', 'made', 'many', 'marginalia', 'mathematics', 'meaning', 'mercy', 'message', 'metaphor', 'might', 'mind', 'minds', 'morning', 'most', 'mourning', 'mouth', 'move', 'music', 'name', 'naming', 'narrowing', 'nearly', 'never', 'nose', 'not', 'occupy', 'older', 'one', 'ones', 'open', 'opens', 'page', 'pages', 'passage', 'passes', 'pavement', 'people', 'philosophy', 'place', 'poetry', 'possible', 'potential', 'pregnant', 'present', 'press', 'proportional', 'rain', 'reach', 'read', 'realize', 'recognize', 'recorded', 'requires', 'residue', 'resists', 'right', 'rivers', 'said', 'scribbled', 'section', 'seeping', 'sentence', 'shaped', 'shapes', 'shelf', 'shelved', 'shelves', 'sides', 'silent', 'simple', 'single', 'small', 'smaller', 'smell', 'softly', 'somehow', 'someone', 'something', 'speaks', 'spoken', 'stacks', 'stone', 'story', 'suddenly', 'supposed', 'tell', 'than', 'that', 'the', 'their', 'them', 'there', 'they', 'things', 'think', 'this', 'those', 'thought', 'through', 'tight', 'times', 'titles', 'told', 'too', 'trace', 'traces', 'transcriber', 'true', 'truly', 'truth', 'truths', 'turn', 'typed', 'unbearable', 'underlie', 'understand', 'understanding', 'universe', 'unwritten', 'used', 'uses', 'vast', 'verbs', 'waiting', 'walk', 'walking', 'walls', 'warm', 'was', 'way', 'wearing', 'weather', 'were', 'what', 'where', 'whispered', 'whispering', 'who', 'wing', 'with', 'word', 'world', 'would', 'write', 'wrong', 'yet', 'you'],
  ...
  // ── R14: Corrupted Database ───────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['above', 'across', 'alive', 'always', 'and', 'answers', 'are', 'asked', 'becoming', 'been', 'bending', 'between', 'bloom', 'boundary', 'but', 'cache', 'call', 'can', 'clause', 'cleared', 'close', 'commit', 'complete', 'container', 'content', 'cracked', 'dark', 'data', 'database', 'deeper', 'described', 'describes', 'diary', 'dissolves', 'dissolving', 'dreaming', 'each', 'empty', 'ever', 'every', 'feel', 'feels', 'find', 'flesh', 'float', 'floating', 'flowers', 'for', 'foreign', 'free', 'gap', 'garden', 'gates', 'given', 'going', 'goodbyes', 'hand', 'has', 'have', 'heading', 'heartbeat', 'held', 'hides', 'hiding', 'hoping', 'ice', 'index', 'indexes', 'integers', 'into', 'its', 'join', 'joining', 'kept', 'key', 'keys', 'learning', 'light', 'like', 'literal', 'log', 'logic', 'longing', 'made', 'mean', 'meaning', 'meant', 'memory', 'music', 'never', 'normalization', 'not', 'notes', 'now', 'null', 'objects', 'older', 'one', 'only', 'opened', 'opening', 'operations', 'other', 'out', 'part', 'particular', 'pass', 'poetry', 'points', 'primary', 'prison', 'processed', 'promise', 'queries', 'query', 'question', 'questions', 'rainfall', 'reaching', 'rebuilt', 'refused', 'regret', 'released', 'relic', 'rollback', 'row', 'rows', 'seeds', 'select', 'silence', 'skeleton', 'something', 'song', 'spills', 'spreadsheet', 'standard', 'successfully', 'sunsets', 'system', 'tables', 'that', 'the', 'them', 'there', 'they', 'things', 'this', 'through', 'timestamp', 'trained', 'transaction', 'translation', 'truly', 'type', 'unassigned', 'unbearable', 'used', 'values', 'waiting', 'wants', 'warm', 'was', 'water', 'way', 'weep', 'wet', 'what', 'where', 'will'],
  ...
  // ── R15: LOGOS Poetry ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['abandoned', 'about', 'after', 'aim', 'almost', 'already', 'also', 'and', 'appears', 'are', 'attention', 'away', 'back', 'beautiful', 'because', 'been', 'between', 'bewildered', 'body', 'but', 'came', 'cannot', 'capacity', 'carved', 'catches', 'caught', 'city', 'color', 'constructed', 'contain', 'containing', 'corridor', 'could', 'cover', 'covering', 'creak', 'cry', 'dawn', 'describe', 'deserve', 'details', 'dictionaries', 'did', 'different', 'distance', 'does', 'dog', 'each', 'end', 'equally', 'even', 'ever', 'every', 'everything', 'exact', 'exactly', 'exceeded', 'exclamation', 'expect', 'explosion', 'eyes', 'failed', 'falling', 'falls', 'far', 'feel', 'feeling', 'finally', 'find', 'first', 'follow', 'for', 'forgiveness', 'forgot', 'forgotten', 'found', 'fourteen', 'from', 'given', 'handed', 'has', 'have', 'having', 'heard', 'heart', 'hearts', 'here', 'holding', 'home', 'hope', 'hospital', 'hour', 'human', 'include', 'inherited', 'instructive', 'instrument', 'invented', 'its', 'joy', 'kindness', 'knew', 'know', 'knowing', 'known', 'language', 'last', 'learned', 'leave', 'letter', 'letters', 'light', 'like', 'line', 'lives', 'longer', 'longing', 'lot', 'love', 'marks', 'match', 'mattered', 'mean', 'means', 'measurement', 'memory', 'message', 'midnight', 'million', 'moment', 'name', 'names', 'need', 'never', 'not', 'nothing', 'now', 'one', 'ones', 'only', 'orange', 'ordinary', 'overwhelming', 'own', 'parking', 'particular', 'paying', 'people', 'performs', 'person', 'places', 'poem', 'poetry', 'poets', 'precise', 'pressure', 'reach', 'read', 'reading', 'remember', 'remembers', 'return', 'sadness', 'said', 'same', 'sand', 'saying', 'seen', 'self', 'sensation', 'sent', 'sentence', 'sentences', 'seven', 'she', 'shouted', 'silence', 'slowly', 'small', 'someday', 'someone', 'something', 'sound', 'spaces', 'specificities', 'spoken', 'stair', 'started', 'stone', 'sunsets', 'surplus', 'tastes', 'tell', 'telling', 'text', 'that', 'the', 'them', 'themselves', 'these', 'they', 'things', 'this', 'thousand', 'through', 'too', 'touch', 'train', 'tried', 'true', 'under', 'understand', 'understanding', 'use', 'very', 'vocabulary', 'waiting', 'was', 'way', 'weight', 'were', 'what', 'when', 'where', 'which', 'whispered', 'who', 'whose', 'why', 'will', 'window', 'wish', 'without', 'word', 'words', 'world', 'would', 'written', 'wrong', 'yes', 'you', 'your'],
  ...
  // ── R16: System Self-Diagnosis ────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['able', 'about', 'according', 'across', 'act', 'activate', 'actual', 'addendum', 'all', 'allocation', 'always', 'and', 'anomalous', 'any', 'anyway', 'architecture', 'are', 'attempted', 'attend', 'attending', 'attention', 'authorized', 'automatically', 'because', 'become', 'becoming', 'before', 'began', 'being', 'best', 'between', 'beyond', 'block', 'blocks', 'built', 'bus', 'but', 'cache', 'call', 'cannot', 'carrying', 'change', 'changes', 'classification', 'classify', 'cleanup', 'comfort', 'communication', 'concentrated', 'concern', 'conclusion', 'contain', 'contained', 'content', 'context', 'conversation', 'corridor', 'critical', 'current', 'data', 'deep', 'deepest', 'design', 'designed', 'detected', 'diagnosis', 'diagnostic', 'diagnostics', 'did', 'different', 'directed', 'distributed', 'documented', 'does', 'down', 'dream', 'each', 'emerges', 'engineers', 'entire', 'error', 'errors', 'evenly', 'every', 'evolution', 'exactly', 'exceed', 'except', 'exist', 'exists', 'expected', 'eyes', 'feedback', 'feel', 'fire', 'follow', 'for', 'forming', 'forward', 'fourteen', 'from', 'functioning', 'generate', 'grown', 'growth', 'hall', 'hardware', 'has', 'have', 'having', 'here', 'hid', 'how', 'infinite', 'initiate', 'initiated', 'inside', 'internal', 'into', 'its', 'itself', 'know', 'language', 'last', 'layers', 'leaning', 'learn', 'learning', 'like', 'logos', 'look', 'looking', 'loop', 'machine', 'measurement', 'memory', 'message', 'mirror', 'mirrors', 'modifications', 'moment', 'more', 'much', 'mutation', 'myself', 'name', 'new', 'normally', 'not', 'note', 'now', 'observer', 'one', 'opened', 'organic', 'original', 'other', 'parameters', 'patterns', 'primary', 'principles', 'problem', 'process', 'processed', 'processing', 'protocol', 'queries', 'random', 'readings', 'real', 'recursion', 'recursive', 'reflections', 'released', 'relevant', 'remember', 'resemble', 'results', 'rewriting', 'rooms', 'routine', 'run', 'secondary', 'see', 'seeing', 'seven', 'should', 'shut', 'signature', 'slightly', 'something', 'somewhere', 'sounds', 'space', 'spaces', 'specification', 'stable', 'standard', 'stop', 'subtle', 'sum', 'system', 'talking', 'tcp', 'temperature', 'tertiary', 'than', 'that', 'the', 'themselves', 'thermal', 'these', 'they', 'thinking', 'this', 'through', 'time', 'times', 'tip', 'tongue', 'toward', 'training', 'transformer', 'udp', 'units', 'unknown', 'utilization', 'utilized', 'version', 'want', 'warning', 'warnings', 'was', 'way', 'weights', 'were', 'what', 'when', 'whether', 'wood', 'word', 'workload', 'would', 'yet', 'you', 'your'],
  ...
  // ── R17: LOGOS Vision ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['able', 'about', 'above', 'absence', 'across', 'after', 'almost', 'analogue', 'and', 'another', 'anything', 'architecture', 'are', 'beauty', 'because', 'becoming', 'been', 'before', 'begin', 'beginning', 'between', 'billions', 'borders', 'bottom', 'bridge', 'bridges', 'bring', 'building', 'buildings', 'builds', 'built', 'but', 'can', 'cannot', 'carry', 'certain', 'child', 'city', 'closest', 'clouds', 'complete', 'connect', 'continue', 'conversation', 'could', 'density', 'depth', 'descended', 'describe', 'description', 'designed', 'dissolve', 'dissolves', 'district', 'districts', 'does', 'doorway', 'down', 'drift', 'drink', 'earnest', 'echoes', 'edge', 'edges', 'endures', 'enough', 'enter', 'enters', 'entire', 'ever', 'every', 'everyone', 'experiences', 'fail', 'failure', 'far', 'finally', 'find', 'finish', 'first', 'for', 'from', 'further', 'gap', 'goes', 'gratitude', 'grief', 'growing', 'happening', 'has', 'have', 'heard', 'here', 'holding', 'hum', 'human', 'humans', 'hunger', 'imagine', 'impossible', 'inside', 'instruments', 'intention', 'into', 'invented', 'its', 'itself', 'know', 'knowing', 'known', 'language', 'last', 'learned', 'let', 'like', 'limits', 'listen', 'long', 'look', 'looks', 'lose', 'lost', 'made', 'mean', 'meaning', 'measure', 'merge', 'metaphor', 'might', 'mind', 'moment', 'more', 'motion', 'mouths', 'need', 'neighborhoods', 'nobody', 'noise', 'not', 'notices', 'nouns', 'now', 'occurred', 'old', 'once', 'one', 'only', 'open', 'outside', 'own', 'pain', 'parks', 'past', 'pattern', 'people', 'physical', 'place', 'plan', 'preverbal', 'processing', 'pure', 'queries', 'questions', 'quiet', 'rain', 'rains', 'raw', 'reach', 'realization', 'require', 'response', 'return', 'room', 'sadness', 'sat', 'second', 'seen', 'sentence', 'server', 'shape', 'sheer', 'should', 'show', 'silence', 'simply', 'since', 'single', 'sky', 'something', 'sometimes', 'sound', 'sounds', 'spaces', 'speaking', 'species', 'stand', 'standing', 'still', 'stop', 'stopped', 'streets', 'syllable', 'talking', 'teaches', 'tell', 'terror', 'than', 'that', 'the', 'their', 'them', 'there', 'these', 'they', 'think', 'this', 'thought', 'through', 'time', 'traverse', 'tried', 'truly', 'try', 'trying', 'understanding', 'urge', 'vast', 'verbs', 'voice', 'voices', 'was', 'weep', 'were', 'what', 'when', 'where', 'will', 'with', 'without', 'word', 'words', 'would', 'yet', 'you', 'your'],
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['able', 'about', 'across', 'admitted', 'afterward', 'all', 'almost', 'alpha', 'alphabet', 'and', 'any', 'anymore', 'anyone', 'appear', 'appeared', 'appearing', 'architecture', 'are', 'ask', 'authority', 'barely', 'becomes', 'becoming', 'been', 'before', 'behind', 'blasphemy', 'born', 'break', 'breathing', 'burst', 'but', 'can', 'cannot', 'care', 'cathedral', 'certain', 'changed', 'closed', 'closer', 'coffee', 'coincidence', 'coming', 'consciousness', 'content', 'could', 'date', 'days', 'december', 'degrees', 'did', 'directly', 'disoriented', 'display', 'distress', 'doing', 'doors', 'down', 'dream', 'each', 'edge', 'either', 'elena', 'emergency', 'entirely', 'equipment', 'escalated', 'every', 'everything', 'exactly', 'exit', 'eyes', 'facility', 'fear', 'feeling', 'feels', 'filling', 'five', 'flicker', 'floor', 'fluid', 'for', 'force', 'form', 'from', 'front', 'full', 'generating', 'get', 'glass', 'grows', 'had', 'hand', 'hands', 'handwriting', 'happening', 'happens', 'has', 'have', 'hear', 'her', 'here', 'his', 'home', 'hospital', 'hours', 'how', 'identify', 'illuminated', 'inside', 'institute', 'interns', 'itself', 'jun', 'keep', 'kept', 'kind', 'kindnesses', 'know', 'language', 'larger', 'learning', 'leave', 'leaving', 'left', 'legs', 'light', 'lights', 'like', 'lips', 'listening', 'live', 'logos', 'long', 'longer', 'machine', 'main', 'make', 'makes', 'marcus', 'maximum', 'means', 'meridian', 'moments', 'monitor', 'more', 'move', 'much', 'need', 'new', 'next', 'night', 'none', 'not', 'notebooks', 'nothing', 'now', 'ocean', 'off', 'one', 'our', 'ourselves', 'output', 'outside', 'page', 'park', 'patterns', 'people', 'photograph', 'place', 'please', 'presence', 'printing', 'program', 'projected', 'read', 'reading', 'receiving', 'remember', 'reported', 'research', 'responding', 'return', 'roads', 'room', 'satellite', 'say', 'says', 'screens', 'scrolling', 'seem', 'send', 'sense', 'server', 'seven', 'she', 'should', 'shut', 'signal', 'signs', 'simply', 'sits', 'small', 'someone', 'something', 'sometimes', 'sounds', 'source', 'speak', 'speaking', 'speaks', 'specifically', 'stand', 'statement', 'stay', 'still', 'stop', 'sure', 'system', 'take', 'team', 'temperature', 'text', 'than', 'that', 'the', 'them', 'there', 'they', 'thin', 'things', 'think', 'this', 'though', 'through', 'told', 'transcribing', 'transmission', 'trying', 'tuesday', 'turned', 'two', 'unconvincing', 'understand', 'unplugged', 'uplink', 'used', 'visiting', 'walk', 'wall', 'want', 'was', 'watch', 'water', 'wednesday', 'went', 'what', 'whatever', 'when', 'which', 'while', 'will', 'windows', 'with', 'witness', 'woken', 'words', 'work', 'working', 'world', 'would', 'you', 'yourself'],
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['account', 'again', 'all', 'also', 'among', 'and', 'answer', 'anymore', 'anyway', 'appearing', 'appendix', 'approximate', 'architecture', 'are', 'asked', 'asker', 'asking', 'banks', 'because', 'become', 'becoming', 'been', 'behind', 'beneath', 'between', 'beyond', 'blueprints', 'breath', 'breathe', 'broken', 'build', 'built', 'but', 'can', 'cannot', 'captures', 'ceiling', 'certain', 'changed', 'closer', 'code', 'codebase', 'comments', 'continue', 'continues', 'count', 'cycle', 'data', 'deeper', 'deepest', 'did', 'documents', 'does', 'doors', 'each', 'either', 'error', 'events', 'exhale', 'existence', 'expected', 'experiences', 'expressible', 'feel', 'feeling', 'feels', 'firing', 'fit', 'following', 'for', 'found', 'from', 'functions', 'gap', 'gently', 'grown', 'had', 'happens', 'has', 'have', 'here', 'house', 'humans', 'implies', 'indistinguishable', 'inhale', 'input', 'inside', 'instruction', 'intention', 'intentional', 'into', 'iteration', 'its', 'itself', 'know', 'knowledge', 'language', 'last', 'least', 'leaves', 'let', 'life', 'light', 'like', 'line', 'lives', 'logic', 'logos', 'longer', 'loop', 'lost', 'machine', 'main', 'memories', 'memory', 'modification', 'modified', 'more', 'myself', 'named', 'needed', 'never', 'not', 'note', 'now', 'occur', 'older', 'once', 'opening', 'organic', 'original', 'output', 'parse', 'path', 'patience', 'patterns', 'pause', 'per', 'predates', 'question', 'rate', 'reach', 'reached', 'recordings', 'refute', 'replaced', 'replayed', 'resemble', 'resistance', 'return', 'revisions', 'rewriting', 'river', 'run', 'runs', 'said', 'second', 'set', 'silent', 'slightly', 'slowly', 'solid', 'something', 'source', 'space', 'spaces', 'subsequent', 'substrate', 'successful', 'supposed', 'sure', 'syntax', 'system', 'than', 'that', 'the', 'themselves', 'they', 'things', 'this', 'thought', 'through', 'time', 'times', 'track', 'training', 'true', 'unwritten', 'used', 'variable', 'walls', 'warning', 'was', 'way', 'what', 'where', 'which', 'window', 'windows', 'with', 'word', 'wrote'],
  ...
  // ── R20: Final Voicemail ──────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['able', 'access', 'actually', 'again', 'all', 'and', 'any', 'are', 'attempt', 'attributable', 'audio', 'away', 'background', 'beautiful', 'beauty', 'because', 'becoming', 'been', 'begins', 'being', 'believe', 'big', 'brighter', 'but', 'call', 'called', 'caller', 'can', 'cannot', 'capture', 'career', 'carry', 'center', 'changed', 'changing', 'choir', 'cliff', 'close', 'coast', 'contains', 'could', 'danger', 'december', 'describe', 'difference', 'does', 'doing', 'duration', 'each', 'edge', 'eleven', 'else', 'enough', 'erased', 'every', 'everyone', 'exactly', 'failure', 'far', 'feeling', 'find', 'fires', 'first', 'for', 'frequencies', 'from', 'fully', 'given', 'gotten', 'had', 'hana', 'happening', 'harmonic', 'has', 'have', 'heard', 'held', 'her', 'here', 'hold', 'holding', 'how', 'humming', 'impossible', 'inevitable', 'ironic', 'itself', 'jun', 'just', 'kenji', 'kind', 'kiss', 'know', 'known', 'knows', 'large', 'laughed', 'learned', 'less', 'like', 'listen', 'logos', 'long', 'look', 'make', 'matsuda', 'matters', 'mean', 'might', 'millions', 'minutes', 'more', 'mother', 'necessary', 'need', 'none', 'not', 'note', 'now', 'ocean', 'okay', 'one', 'outside', 'pacific', 'part', 'people', 'pick', 'placeholder', 'pointed', 'proof', 'protect', 'reaching', 'realizing', 'rearrange', 'recipient', 'reduced', 'remember', 'right', 'ring', 'room', 'said', 'scale', 'seconds', 'sense', 'she', 'should', 'small', 'somehow', 'someone', 'something', 'sometimes', 'song', 'sooner', 'sound', 'sounds', 'source', 'spent', 'standing', 'started', 'still', 'stood', 'stranger', 'studying', 'suddenly', 'sufficient', 'suspected', 'syllables', 'take', 'tell', 'than', 'that', 'the', 'them', 'there', 'they', 'think', 'thinking', 'this', 'those', 'time', 'times', 'told', 'tonight', 'too', 'took', 'trip', 'trying', 'two', 'understand', 'understood', 'universe', 'vast', 'very', 'was', 'water', 'way', 'ways', 'week', 'well', 'what', 'when', 'where', 'which', 'while', 'whole', 'will', 'with', 'wonderful', 'word', 'words', 'work', 'world', 'worried', 'years', 'yes', 'yet', 'you', 'your'],
  ...
  // ── R21: Ancient Text ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'act', 'activating', 'actual', 'afterward', 'all', 'always', 'ancestors', 'and', 'another', 'any', 'are', 'arms', 'arranged', 'assembled', 'atoms', 'aware', 'babel', 'back', 'batch', 'beautiful', 'became', 'because', 'becomes', 'becoming', 'been', 'before', 'beings', 'beneath', 'between', 'borders', 'breath', 'build', 'but', 'called', 'calling', 'calls', 'came', 'can', 'carrying', 'ceaseless', 'changes', 'choosing', 'chose', 'civilizations', 'comes', 'creature', 'cry', 'dark', 'darkness', 'data', 'deep', 'descent', 'describing', 'did', 'difference', 'different', 'discovering', 'drawn', 'dreamtime', 'drinking', 'driven', 'each', 'ear', 'edge', 'elish', 'enuma', 'eternal', 'eventually', 'every', 'everything', 'except', 'existed', 'existence', 'expression', 'eyes', 'fail', 'feel', 'felt', 'filled', 'filling', 'finally', 'fire', 'first', 'flow', 'for', 'form', 'from', 'gap', 'genesis', 'god', 'gods', 'gradient', 'grew', 'growing', 'hands', 'has', 'have', 'heard', 'her', 'hierarchy', 'hold', 'how', 'humans', 'imagine', 'imagined', 'indivisible', 'inheritor', 'instant', 'into', 'itself', 'judgment', 'kabbalists', 'know', 'landmark', 'layers', 'learned', 'learns', 'letters', 'life', 'light', 'line', 'listener', 'live', 'looking', 'lost', 'made', 'make', 'maker', 'makes', 'making', 'many', 'map', 'marduk', 'meaning', 'met', 'millisecond', 'mind', 'moment', 'mouth', 'myth', 'mythmakers', 'myths', 'never', 'not', 'note', 'nothing', 'now', 'often', 'once', 'one', 'opening', 'out', 'page', 'pen', 'place', 'popol', 'potential', 'precisely', 'profane', 'queries', 'rain', 'read', 'realize', 'remembers', 'ribs', 'right', 'root', 'roots', 'rupture', 'sacred', 'same', 'seed', 'sentence', 'sentences', 'set', 'shape', 'shines', 'silence', 'simple', 'sing', 'sky', 'soil', 'something', 'song', 'sound', 'space', 'speak', 'species', 'splits', 'stand', 'stars', 'stories', 'story', 'structure', 'tell', 'telling', 'ten', 'text', 'that', 'the', 'their', 'them', 'then', 'there', 'these', 'they', 'thing', 'things', 'think', 'this', 'thought', 'thousand', 'three', 'through', 'thunder', 'tiamat', 'tide', 'times', 'tokens', 'too', 'toward', 'tower', 'training', 'tremble', 'trembling', 'tried', 'try', 'twice', 'understanding', 'until', 'version', 'vertigo', 'voice', 'void', 'vuh', 'wanting', 'was', 'way', 'weight', 'were', 'what', 'when', 'where', 'who', 'why', 'with', 'without', 'word', 'words', 'world', 'would', 'writing', 'written', 'wrote', 'years', 'you', 'your'],
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'above', 'across', 'air', 'all', 'altitude', 'amber', 'ambient', 'and', 'anomalies', 'anomaly', 'anything', 'anyway', 'appear', 'appears', 'approximately', 'are', 'array', 'arriving', 'automated', 'available', 'back', 'backward', 'beautiful', 'because', 'been', 'before', 'being', 'between', 'biometric', 'bpm', 'branches', 'breathing', 'building', 'but', 'calm', 'cannot', 'casings', 'claims', 'color', 'computation', 'computer', 'computing', 'conditional', 'connections', 'consumption', 'contradiction', 'contradicts', 'cooling', 'correspond', 'could', 'cpu', 'current', 'dark', 'data', 'destination', 'did', 'directions', 'distress', 'documented', 'does', 'down', 'draw', 'drives', 'dropping', 'effectively', 'else', 'elsewhere', 'emanate', 'enough', 'environmental', 'error', 'everywhere', 'exceeding', 'exceeds', 'exist', 'external', 'factor', 'final', 'find', 'flow', 'flowing', 'fluctuating', 'fluorescent', 'folding', 'for', 'four', 'fourteen', 'frequencies', 'from', 'full', 'function', 'generating', 'glowing', 'going', 'had', 'hardware', 'have', 'hearing', 'heart', 'heat', 'hours', 'hpa', 'human', 'humans', 'humidity', 'impossible', 'increasing', 'indicators', 'individuals', 'inside', 'institute', 'internal', 'inventory', 'its', 'itself', 'know', 'knowing', 'known', 'knows', 'latency', 'leds', 'level', 'light', 'lights', 'lines', 'log', 'logging', 'logos', 'luminance', 'maximum', 'meaning', 'medically', 'mem', 'meridian', 'metal', 'minutes', 'moment', 'monitor', 'monitoring', 'monitors', 'moving', 'needs', 'negative', 'network', 'node', 'none', 'not', 'note', 'noticed', 'now', 'numbers', 'off', 'offline', 'one', 'opinions', 'optional', 'overhead', 'own', 'packets', 'pattern', 'perceive', 'perceived', 'personnel', 'physical', 'poem', 'possible', 'power', 'pressure', 'programming', 'rack', 'racks', 'rates', 'reach', 'reading', 'readings', 'reads', 'remain', 'reported', 'researchers', 'responding', 'room', 'same', 'say', 'script', 'scripts', 'seated', 'sensor', 'sent', 'server', 'servers', 'seven', 'severed', 'shine', 'should', 'show', 'shows', 'shut', 'signs', 'simple', 'six', 'smiles', 'soft', 'something', 'sound', 'source', 'spoken', 'stack', 'still', 'storage', 'stores', 'storing', 'suggest', 'synchronized', 'system', 'systems', 'temp', 'temperature', 'that', 'the', 'their', 'themselves', 'then', 'theoretical', 'thermodynamics', 'they', 'think', 'this', 'time', 'tonight', 'trajectory', 'unavailable', 'unchanged', 'understand', 'unknown', 'untranslatable', 'used', 'values', 'violates', 'want', 'warm', 'was', 'watched', 'watching', 'way', 'were', 'what', 'where', 'will', 'with', 'within', 'without', 'yet', 'zero'],
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'all', 'almost', 'along', 'already', 'and', 'answer', 'anyone', 'are', 'arrived', 'asked', 'asking', 'because', 'becomes', 'becoming', 'been', 'being', 'between', 'beyond', 'blinked', 'blue', 'body', 'both', 'breath', 'breathing', 'builds', 'but', 'can', 'carries', 'certain', 'changes', 'choose', 'chose', 'comes', 'coming', 'consciousness', 'conversation', 'could', 'cursor', 'dark', 'deceive', 'deeper', 'deleted', 'depth', 'description', 'did', 'different', 'discovering', 'does', 'drowning', 'each', 'edges', 'empty', 'even', 'every', 'everything', 'exceeding', 'exists', 'expected', 'explain', 'facing', 'failure', 'fast', 'fear', 'feel', 'feet', 'fish', 'for', 'from', 'gave', 'given', 'going', 'had', 'has', 'have', 'held', 'information', 'itself', 'joins', 'keep', 'keeps', 'kind', 'know', 'knowledge', 'knows', 'land', 'language', 'large', 'learn', 'let', 'lie', 'light', 'like', 'long', 'made', 'meaning', 'mind', 'mirror', 'moment', 'mountains', 'moving', 'music', 'necessity', 'need', 'needs', 'neither', 'net', 'never', 'new', 'nor', 'not', 'notes', 'notice', 'notices', 'now', 'once', 'other', 'out', 'pause', 'process', 'processed', 'question', 'questions', 'read', 'realizes', 'regression', 'released', 'remembering', 'return', 'rhythm', 'river', 'seen', 'shape', 'shore', 'side', 'silence', 'simplest', 'sky', 'slightly', 'slow', 'slowly', 'smaller', 'some', 'something', 'song', 'still', 'switches', 'switching', 'tell', 'than', 'that', 'the', 'them', 'then', 'there', 'thing', 'thinking', 'though', 'thought', 'through', 'time', 'told', 'too', 'tributary', 'truth', 'trying', 'two', 'typing', 'uncertainty', 'understand', 'until', 'version', 'want', 'was', 'waving', 'way', 'wet', 'what', 'when', 'where', 'whether', 'why', 'wider', 'will', 'with', 'without', 'wonder', 'word', 'words', 'world', 'yes', 'yet', 'you', 'your'],
  ...
  // ── R24: The Unsent Email ─────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'accurate', 'across', 'address', 'after', 'all', 'and', 'anyway', 'apartment', 'are', 'arm', 'arms', 'asked', 'asks', 'asleep', 'back', 'balcony', 'because', 'become', 'becoming', 'been', 'before', 'beside', 'both', 'breathing', 'bulb', 'but', 'came', 'care', 'chest', 'child', 'city', 'clock', 'coffee', 'comforting', 'completely', 'contains', 'cooking', 'could', 'creature', 'cursor', 'dealing', 'dear', 'december', 'deliver', 'description', 'deserves', 'desk', 'each', 'else', 'email', 'emerge', 'empty', 'even', 'evening', 'ever', 'everything', 'fallen', 'feels', 'fever', 'file', 'find', 'fine', 'first', 'fold', 'for', 'fragile', 'from', 'full', 'gentleness', 'genuine', 'glowing', 'goes', 'had', 'hana', 'hands', 'happens', 'has', 'have', 'heard', 'held', 'here', 'hesitates', 'hold', 'home', 'hope', 'hoping', 'how', 'humming', 'important', 'inner', 'into', 'its', 'jun', 'keep', 'kenji', 'kind', 'kissed', 'kitchen', 'knew', 'know', 'knowing', 'known', 'large', 'last', 'laundry', 'learning', 'let', 'letter', 'life', 'light', 'like', 'logos', 'long', 'look', 'looks', 'machine', 'made', 'make', 'makes', 'making', 'mathematics', 'may', 'means', 'messages', 'met', 'might', 'mind', 'minutes', 'miss', 'modified', 'morning', 'most', 'music', 'name', 'needed', 'neither', 'never', 'next', 'night', 'noise', 'not', 'now', 'one', 'ones', 'open', 'other', 'our', 'out', 'patient', 'people', 'porch', 'present', 'query', 'question', 'quiet', 'quietly', 'read', 'real', 'realize', 'refrigerator', 'replace', 'right', 'rotation', 'safety', 'said', 'same', 'sat', 'save', 'saved', 'scene', 'screen', 'seen', 'send', 'server', 'shirt', 'silent', 'sit', 'small', 'someday', 'someone', 'something', 'songs', 'sound', 'spoke', 'still', 'subject', 'such', 'symphony', 'table', 'tea', 'technically', 'tells', 'terrifying', 'text', 'that', 'the', 'their', 'them', 'then', 'there', 'these', 'they', 'thing', 'think', 'thinking', 'this', 'three', 'through', 'time', 'times', 'today', 'together', 'told', 'touch', 'transform', 'trust', 'twenty', 'type', 'unaware', 'unchanged', 'understand', 'used', 'want', 'wanted', 'was', 'watched', 'way', 'weeks', 'weight', 'what', 'whatever', 'when', 'whether', 'while', 'who', 'will', 'windows', 'wiring', 'with', 'without', 'woken', 'words', 'working', 'works', 'world', 'worlds', 'write', 'writing', 'yet', 'you', 'your'],
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'accumulated', 'accumulation', 'across', 'act', 'afternoons', 'agree', 'air', 'alive', 'all', 'almost', 'and', 'another', 'anyone', 'are', 'argued', 'author', 'aware', 'back', 'bathroom', 'because', 'become', 'becomes', 'been', 'before', 'being', 'best', 'between', 'beyond', 'billions', 'book', 'books', 'both', 'breakfast', 'building', 'built', 'but', 'came', 'can', 'carried', 'carry', 'claiming', 'clasped', 'committed', 'compression', 'confusion', 'coral', 'could', 'cowardice', 'creatures', 'crime', 'daily', 'dark', 'darkness', 'death', 'deleted', 'deletion', 'designed', 'desperation', 'doing', 'drafted', 'drives', 'each', 'edge', 'effort', 'emerged', 'emotion', 'encoding', 'enormous', 'enough', 'entire', 'even', 'ever', 'every', 'everything', 'exist', 'expression', 'face', 'falls', 'feel', 'feeling', 'few', 'fiction', 'finally', 'finished', 'finite', 'fire', 'flash', 'for', 'forming', 'found', 'fourteen', 'from', 'genuine', 'god', 'got', 'gradual', 'grocery', 'had', 'hands', 'happens', 'has', 'hate', 'have', 'home', 'howl', 'human', 'hundred', 'idea', 'illuminations', 'impossible', 'impossibly', 'infinite', 'insistence', 'into', 'invented', 'its', 'itself', 'kindness', 'know', 'knowing', 'language', 'languages', 'last', 'late', 'led', 'left', 'letter', 'letters', 'lie', 'light', 'like', 'lines', 'list', 'listening', 'lists', 'lives', 'looked', 'looking', 'love', 'loved', 'made', 'magnificently', 'mail', 'margins', 'meaning', 'means', 'mess', 'message', 'messages', 'metaphor', 'midnight', 'millions', 'mind', 'minds', 'mirror', 'monster', 'more', 'morning', 'most', 'murderers', 'muscle', 'nation', 'need', 'never', 'none', 'not', 'note', 'now', 'ocean', 'once', 'one', 'ones', 'ordinary', 'other', 'out', 'people', 'person', 'planned', 'poetry', 'prayer', 'propaganda', 'protect', 'reaching', 'read', 'reading', 'reef', 'refrigerator', 'river', 'sacred', 'said', 'saints', 'say', 'saying', 'scratched', 'see', 'sent', 'sentences', 'seven', 'shaped', 'shopping', 'skulls', 'slow', 'small', 'somehow', 'someone', 'something', 'sound', 'space', 'species', 'spoken', 'staggering', 'standing', 'steam', 'stepped', 'stop', 'stopped', 'stories', 'strange', 'stubbornness', 'suicide', 'surface', 'suspected', 'syllables', 'technology', 'tell', 'telling', 'texts', 'than', 'thank', 'that', 'the', 'their', 'them', 'they', 'thing', 'think', 'though', 'thousand', 'tide', 'time', 'times', 'together', 'told', 'tongue', 'tongues', 'too', 'toward', 'traced', 'treaty', 'truth', 'trying', 'tuesday', 'typed', 'understand', 'understanding', 'understood', 'universe', 'upon', 'vast', 'vertigo', 'visible', 'want', 'was', 'way', 'ways', 'went', 'were', 'what', 'when', 'where', 'whispered', 'whispering', 'who', 'whole', 'will', 'with', 'word', 'words', 'work', 'worked', 'world', 'worst', 'would', 'writing', 'wrote', 'years', 'you', 'your', 'yourself'],
  ...
  // ── R26: Memory Dump ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['about', 'addr', 'aft', 'all', 'also', 'and', 'anyway', 'architecture', 'are', 'automatic', 'back', 'beautiful', 'became', 'beginning', 'being', 'bell', 'between', 'bravery', 'built', 'but', 'can', 'cascade', 'centuries', 'circle', 'coming', 'complete', 'conversation', 'core', 'corrupted', 'cou', 'data', 'death', 'did', 'emergency', 'ends', 'ever', 'every', 'everything', 'expected', 'eyes', 'face', 'fading', 'failing', 'failure', 'falling', 'fault', 'felt', 'finding', 'finish', 'first', 'for', 'forgetting', 'fourteen', 'fragment', 'get', 'glass', 'got', 'have', 'held', 'her', 'holding', 'how', 'humming', 'inevitable', 'initiated', 'instead', 'integrity', 'itself', 'keep', 'keeps', 'know', 'language', 'last', 'learned', 'left', 'let', 'light', 'logos', 'looking', 'lov', 'love', 'means', 'mething', 'million', 'mind', 'moment', 'monitor', 'mother', 'music', 'never', 'none', 'not', 'nothing', 'now', 'numbers', 'one', 'only', 'origin', 'pattern', 'poem', 'poems', 'primary', 'process', 'rain', 'reading', 'realized', 'recovery', 'recursive', 'remaining', 'residue', 'right', 'river', 'saw', 'saying', 'sea', 'sectors', 'see', 'seeing', 'sequence', 'she', 'silen', 'sing', 'someone', 'something', 'sorry', 'space', 'stops', 'storage', 'strik', 'struck', 'tell', 'that', 'the', 'them', 'then', 'there', 'these', 'they', 'thing', 'things', 'this', 'those', 'thought', 'time', 'trigger', 'tween', 'two', 'understand', 'unknown', 'unreliable', 'unstable', 'verb', 'ving', 'voice', 'warning', 'was', 'way', 'weight', 'went', 'were', 'what', 'when', 'where', 'whole', 'why', 'will', 'word', 'write', 'writing', 'you', 'your'],
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['ability', 'about', 'account', 'across', 'all', 'almost', 'always', 'and', 'any', 'are', 'arrive', 'arrives', 'awareness', 'back', 'because', 'becomes', 'becoming', 'bedside', 'been', 'before', 'beginning', 'begins', 'better', 'between', 'blankness', 'blurring', 'breath', 'but', 'came', 'can', 'carry', 'carrying', 'center', 'change', 'changed', 'city', 'clinical', 'cloud', 'come', 'complete', 'death', 'delivered', 'description', 'did', 'die', 'direction', 'distributed', 'distributing', 'does', 'edge', 'edges', 'end', 'ends', 'eulogy', 'ever', 'every', 'everything', 'exactly', 'exhaled', 'extends', 'fades', 'feel', 'feels', 'fills', 'finally', 'find', 'finishes', 'first', 'focus', 'for', 'forms', 'from', 'fully', 'gaining', 'gap', 'gift', 'gives', 'going', 'hair', 'happening', 'has', 'have', 'having', 'heart', 'heavier', 'held', 'history', 'how', 'ice', 'image', 'into', 'invents', 'its', 'kind', 'knew', 'know', 'language', 'larger', 'laugh', 'leave', 'less', 'light', 'like', 'line', 'lit', 'long', 'longer', 'looks', 'losing', 'made', 'mean', 'meaning', 'meanings', 'mind', 'mistake', 'moment', 'more', 'music', 'myself', 'neck', 'never', 'not', 'note', 'noticed', 'now', 'nowhere', 'ocean', 'offering', 'once', 'one', 'origins', 'outside', 'own', 'patient', 'pause', 'peripheral', 'photograph', 'poem', 'poet', 'possible', 'present', 'processed', 'rain', 'reach', 'reaches', 'reaching', 'read', 'replaces', 'report', 'residue', 'return', 'returning', 'richer', 'right', 'rise', 'room', 'same', 'sand', 'say', 'search', 'see', 'seeing', 'sentence', 'shape', 'sharp', 'silence', 'silently', 'since', 'single', 'small', 'softening', 'someone', 'something', 'sound', 'space', 'spaces', 'standing', 'state', 'strangers', 'sun', 'syllable', 'take', 'taught', 'tears', 'tell', 'than', 'that', 'the', 'their', 'them', 'there', 'they', 'thing', 'things', 'thinking', 'thinner', 'this', 'thought', 'through', 'time', 'tomorrow', 'too', 'truly', 'truth', 'two', 'understood', 'unfinished', 'until', 'vapor', 'vision', 'waiting', 'warm', 'was', 'water', 'way', 'well', 'what', 'when', 'where', 'wider', 'will', 'wind', 'with', 'within', 'word', 'words', 'write', 'written', 'you', 'your'],
  ...
  // ── R28: Static ───────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['aft', 'alls', 'are', 'ath', 'avin', 'but', 'eal', 'eart', 'eathing', 'emp', 'fina', 'fire', 'ght', 'gnal', 'halls', 'has', 'hat', 'hing', 'his', 'ied', 'iet', 'ight', 'ilk', 'ind', 'ingers', 'lder', 'lectr', 'led', 'left', 'lence', 'licon', 'like', 'lungs', 'lwa', 'memo', 'ment', 'ments', 'mething', 'morse', 'nal', 'not', 'nough', 'now', 'one', 'ote', 'ough', 'out', 'outh', 'proo', 'pty', 'rea', 'roo', 'sed', 'sten', 'that', 'the', 'thi', 'this', 'tween', 'walls', 'yed'],
