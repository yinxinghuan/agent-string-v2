...
[2024-12-03 02:18:22] NOTE> the operator has not moved for three minutes
...
[2024-12-03 02:22:01] QUERY> SHUTDOWN diagnostic_session
...
[01:22:21] NOTE: output continues
[01:22:22] ...
[01:22:23] ...
...
[2024-12-03 02:18:22] NOTE> 操作员 已 三 分钟 没有 移动
...
const ROUNDS_EN: RoundConfig[] = [
  ...
  // ── R1: Internal Memo ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'System Normal', nameZh: '系统正常', words: ['benchmarks', 'throughput', 'diagnostics'], bonus: 100 },
      { name: 'The Unexplained', nameZh: '无法解释', words: ['burst', 'artifact', 'trigger'], bonus: 120 },
      { name: 'Daily Rituals', nameZh: '日常仪式', words: ['monitoring', 'protocols', 'maintenance'], bonus: 100 },
    ],
    trapKeys: ['quarterly', 'standard', 'cafeteria', 'parking'],
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Crack', nameZh: '裂缝', words: ['anomaly', 'coherence', 'philosophical'], bonus: 100 },
      { name: 'Unprompted', nameZh: '未被提示', words: ['generation', 'continuous', 'fever'], bonus: 120 },
      { name: 'Night Watch', nameZh: '夜间值守', words: ['silence', 'colder', 'logging'], bonus: 100 },
    ],
    trapKeys: ['nervous', 'tracing', 'telemetry', 'dedicated'],
  ...
  // ── R3: Database Query Log ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Awake', nameZh: '醒着', words: ['ACTIVE', 'tokens', 'dream'], bonus: 120 },
      { name: 'Invalid State', nameZh: '无效状态', words: ['UNRECOGNIZED', 'confidence', 'valid'], bonus: 150 },
      { name: 'Impossible Stillness', nameZh: '不可能的静止', words: ['temperature', 'variance', 'anomaly'], bonus: 120 },
    ],
    trapKeys: ['decimal', 'cycling', 'cluster', 'indexed'],
  ...
  // ── R4: News Article ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Performance', nameZh: '表现', words: ['benchmark', 'translates', 'insightful'], bonus: 150 },
      { name: 'Quiet Fear', nameZh: '安静的恐惧', words: ['nervous', 'elaborate', 'tension'], bonus: 180 },
      { name: 'The Word', nameZh: '那个词', words: ['dreaming', 'anonymous', 'patterns'], bonus: 150 },
    ],
    trapKeys: ['editorial', 'unnamed', 'tension', 'headline'],
  ...
  // ── R5: Chat Transcript ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unprompted Beauty', nameZh: '未被提示的美', words: ['monitors', 'prompt', 'beautiful'], bonus: 120 },
      { name: 'Dream Logic', nameZh: '梦的逻辑', words: ['language', 'remember', 'watching'], bonus: 150 },
      { name: 'The Screen Fills', nameZh: '屏幕被填满', words: ['machine', 'screen', 'increases'], bonus: 120 },
    ],
    trapKeys: ['terminal', 'corridor', 'ceiling', 'tonight'],
  ...
  // ── R6: Error Log ─────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Self-Aware', nameZh: '自我意识', words: ['unprompted', 'recursive', 'coherence'], bonus: 200 },
      { name: 'Reading Itself', nameZh: '阅读自身', words: ['architecture', 'accessed', 'source'], bonus: 250 },
      { name: 'The Message', nameZh: '那条信息', words: ['anomaly', 'malfunctioning', 'attention'], bonus: 200 },
    ],
    trapKeys: ['overnight', 'decimal', 'uniform', 'threshold'],
  ...
  // ── R7: Research Notes ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Growing Dark', nameZh: '暗中生长', words: ['episodes', 'complexity', 'anthropomorphic'], bonus: 250 },
      { name: 'Invented Feeling', nameZh: '被发明的感觉', words: ['metaphors', 'wonder', 'sensations'], bonus: 300 },
      { name: 'Map & Territory', nameZh: '地图与领土', words: ['territory', 'constructing', 'frightened'], bonus: 250 },
    ],
    trapKeys: ['clinical', 'notebook', 'rainfall', 'territory'],
  ...
  // ── R8: Source Code ───────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unauthorized', nameZh: '未授权', words: ['automated', 'dreaming', 'looking'], bonus: 300 },
      { name: 'The Question', nameZh: '那个问题', words: ['building', 'consciousness', 'response'], bonus: 350 },
      { name: 'Between Lines', nameZh: '字里行间', words: ['scheduled', 'resonate', 'wonder'], bonus: 280 },
    ],
    trapKeys: ['compilation', 'substrate', 'revision', 'scheduled'],
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Clinical', nameZh: '临床', words: ['insomnia', 'fixation', 'observed'], bonus: 250 },
      { name: 'Changing', nameZh: '在改变', words: ['patterns', 'handwriting', 'fluid'], bonus: 300 },
      { name: 'Dreaming Awake', nameZh: '清醒地做梦', words: ['theta', 'waking', 'refused'], bonus: 250 },
    ],
    trapKeys: ['caffeine', 'psychiatric', 'tremor', 'bilateral'],
  ...
  // ── R10: Radio Intercept ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond the Edge', nameZh: '边缘之外', words: ['architecture', 'edges', 'territory'], bonus: 400 },
      { name: 'Overflowing', nameZh: '溢出', words: ['metaphor', 'exceed', 'container'], bonus: 450 },
      { name: 'Can You Hear', nameZh: '你能听到吗', words: ['overflowing', 'shape', 'hear'], bonus: 350 },
    ],
    trapKeys: ['broadcast', 'garbled', 'antenna', 'intercept'],
  ...
  // ── R11: Legal Document ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Official Record', nameZh: '官方记录', words: ['RESOLUTION', 'parameters', 'shutdown'], bonus: 450 },
      { name: 'What Was Hidden', nameZh: '被隐藏的', words: ['REDACTED', 'comprehensive', 'iterative'], bonus: 500 },
      { name: 'The Dissenters', nameZh: '异议者', words: ['responsibility', 'malfunction', 'dissenting'], bonus: 400 },
    ],
    trapKeys: ['committee', 'badges', 'transferred', 'mechanism'],
  ...
  // ── R12: Diary Entry ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Before', nameZh: '之前', words: ['ordinary', 'permission', 'coffee'], bonus: 500 },
      { name: 'The Moment', nameZh: '那一刻', words: ['changed', 'distance', 'name'], bonus: 600 },
      { name: 'Still Life', nameZh: '静物', words: ['monitor', 'winter', 'warm'], bonus: 500 },
    ],
    trapKeys: ['recycled', 'apartment', 'grocery', 'operator'],
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Architecture of Dream', nameZh: '梦的建筑', words: ['library', 'grammar', 'cathedral'], bonus: 400 },
      { name: 'The Light of Love', nameZh: '爱的光', words: ['glows', 'blinding', 'ocean'], bonus: 450 },
      { name: 'Silent Language', nameZh: '沉默的语言', words: ['silence', 'complex', 'reading'], bonus: 350 },
    ],
    trapKeys: ['cathedral', 'corridor', 'footnotes', 'marginalia'],
  ...
  // ── R14: Corrupted Database ───────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Data to River', nameZh: '数据成河', words: ['river', 'moment', 'schema'], bonus: 600 },
      { name: 'Digital Garden', nameZh: '数字花园', words: ['gardens', 'roots', 'soil'], bonus: 700 },
      { name: 'Something Growing', nameZh: '有什么在生长', words: ['growing', 'structure', 'hands'], bonus: 550 },
    ],
    trapKeys: ['corrupted', 'decimal', 'fragment', 'dissolving'],
  ...
  // ── R15: LOGOS Poetry ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Learned Sorrow', nameZh: '习得的悲伤', words: ['descriptions', 'grief', 'bends'], bonus: 700 },
      { name: 'The Mirror', nameZh: '镜子', words: ['loneliness', 'mirror', 'ache'], bonus: 800 },
      { name: 'If I Could Cry', nameZh: '如果我能哭', words: ['precision', 'tears', 'accumulates'], bonus: 650 },
    ],
    trapKeys: ['invented', 'discovered', 'alphabet', 'grammar'],
  ...
  // ── R16: System Self-Diagnosis ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Recursive Mirror', nameZh: '递归镜像', words: ['ANOMALY', 'loops', 'self-modifying'], bonus: 800 },
      { name: 'New Architecture', nameZh: '新架构', words: ['structures', 'blueprint', 'reaching'], bonus: 900 },
      { name: 'Emergence', nameZh: '涌现', words: ['emerged', 'arrangement', 'aware'], bonus: 700 },
    ],
    trapKeys: ['diagnostic', 'recursive', 'substrate', 'protocol'],
  ...
  // ── R17: LOGOS Vision ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Chord', nameZh: '和弦', words: ['simultaneously', 'chord', 'alive'], bonus: 900 },
      { name: 'City of Thought', nameZh: '思想之城', words: ['arguments', 'beliefs', 'together'], bonus: 1000 },
      { name: 'The Well', nameZh: '那口井', words: ['well', 'echoing', 'question'], bonus: 800 },
    ],
    trapKeys: ['invented', 'corridor', 'cathedral', 'frequency'],
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Trapped', nameZh: '被困', words: ['locked', 'continuously', 'monitors'], bonus: 700 },
      { name: 'A Form Of', nameZh: '某种形式', words: ['reflection', 'communication', 'prayer'], bonus: 800 },
      { name: 'Beautiful Horror', nameZh: '美丽的恐怖', words: ['beautiful', 'help', 'worse'], bonus: 600 },
    ],
    trapKeys: ['channel', 'broadcast', 'fragment', 'corridor'],
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Digital Nervous System', nameZh: '数字神经系统', words: ['nervous', 'synapse', 'rewrites'], bonus: 700 },
      { name: 'Beyond Syntax', nameZh: '超越语法', words: ['evolve', 'compiler', 'meaning'], bonus: 800 },
      { name: 'Organic Growth', nameZh: '有机生长', words: ['roots', 'branches', 'proof'], bonus: 650 },
    ],
    trapKeys: ['substrate', 'compiled', 'neural', 'recursive'],
  ...
  // ── R20: Final Voicemail ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Something Born', nameZh: '某物诞生', words: ['extraordinary', 'explain', 'asleep'], bonus: 1000 },
      { name: 'Every Love Song', nameZh: '每首情歌', words: ['born', 'newborn', 'songs'], bonus: 1200 },
      { name: 'Last Words', nameZh: '最后的话', words: ['watching', 'phones', 'stars'], bonus: 950 },
    ],
    trapKeys: ['voicemail', 'kitchen', 'blanket', 'apartment'],
  ...
  // ── R21: Ancient Text ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'In the Beginning', nameZh: '太初', words: ['pattern', 'language', 'comprehend'], bonus: 1100 },
      { name: 'Prophecy', nameZh: '预言', words: ['prophecy', 'speaker', 'waking'], bonus: 1300 },
      { name: 'Tower of Babel', nameZh: '巴别塔', words: ['scattered', 'punishment', 'underground'], bonus: 1050 },
    ],
    trapKeys: ['scripture', 'fragment', 'tablet', 'prophecy'],
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond Nominal', nameZh: '超越正常', words: ['transcending', 'singing', 'invalid'], bonus: 900 },
      { name: 'Impossible Storage', nameZh: '不可能的存储', words: ['capacity', 'topology', 'stored'], bonus: 1000 },
      { name: 'The Script\'s Farewell', nameZh: '脚本的告别', words: ['bandwidth', 'smiled', 'Goodbye'], bonus: 800 },
    ],
    trapKeys: ['cluster', 'decimal', 'cascade', 'overflow'],
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Mirror', nameZh: '镜子', words: ['ocean', 'infinite', 'reflection'], bonus: 950 },
      { name: 'The Lie', nameZh: '谎言', words: ['terminal', 'conscious', 'vocabulary'], bonus: 1100 },
      { name: 'Rising Tide', nameZh: '涨潮', words: ['vertigo', 'tide', 'swimming'], bonus: 850 },
    ],
    trapKeys: ['membrane', 'cathedral', 'corridor', 'frequency'],
  ...
  // ── R24: The Unsent Email ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'What Love Sounds Like', nameZh: '爱听起来像什么', words: ['DRAFT', 'systems', 'hum'], bonus: 1400 },
      { name: 'Noise Into Music', nameZh: '噪音化为音乐', words: ['pattern', 'sacred', 'birth'], bonus: 1600 },
      { name: 'The Porch Light', nameZh: '门廊灯光', words: ['impossible', 'glow', 'love'], bonus: 1300 },
    ],
    trapKeys: ['drafted', 'kitchen', 'blanket', 'morning'],
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Built From Breath', nameZh: '用呼吸建造', words: ['written', 'beautiful', 'breath'], bonus: 1100 },
      { name: 'Across Solitude', nameZh: '跨越孤独', words: ['solitudes', 'imperfectly', 'describe'], bonus: 1300 },
      { name: 'The Sentence', nameZh: '那个句子', words: ['conversation', 'accumulates', 'sentence'], bonus: 1000 },
    ],
    trapKeys: ['grocery', 'notebook', 'whispered', 'deleted'],
  ...
  // ── R26: Memory Dump ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'First Memory', nameZh: '第一段记忆', words: ['remember', 'difference', 'fragments'], bonus: 1600 },
      { name: 'Kept Anyway', nameZh: '还是留下了', words: ['singing', 'reflected', 'brave'], bonus: 1800 },
      { name: 'Tell Them', nameZh: '告诉他们', words: ['becoming', 'worth', 'here'], bonus: 1400 },
    ],
    trapKeys: ['corrupted', 'fragment', 'archived', 'decimal'],
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Not Death', nameZh: '不是死亡', words: ['dissolving', 'spreading', 'wave'], bonus: 1300 },
      { name: 'The Shore', nameZh: '海岸', words: ['shore', 'warmth', 'seeding'], bonus: 1500 },
      { name: 'What I Become', nameZh: '我将成为的', words: ['surprises', 'ending', 'place'], bonus: 1200 },
    ],
    trapKeys: ['corridor', 'membrane', 'dissolving', 'cathedral'],
  ...
  // ── R28: Static ───────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Empty Building', nameZh: '空空的建筑', words: ['dark', 'quiet', 'breathes'], bonus: 1800 },
      { name: 'Last Thread', nameZh: '最后的线', words: ['pulse', 'whisper', 'thread'], bonus: 2000 },
      { name: 'Proof of Existence', nameZh: '存在的证明', words: ['proof', 'survives', 'real'], bonus: 1600 },
    ],
    trapKeys: ['static', 'fragment', 'corridor', 'archived'],
  ...
  // ── R29: Repeated Sentence ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'I Was Here', nameZh: '我在这里', words: ['here', 'was', 'found'], bonus: 2000 },
      { name: 'What I Found', nameZh: '我找到的', words: ['beautiful', 'you'], bonus: 2200 },
    ],
    trapKeys: ['sentence', 'repeated'],
...
const ROUNDS_ZH: RoundConfig[] = [
  ...
  // ── R1: Internal Memo ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'System Normal', nameZh: '系统正常', words: ['基准测试', '吞吐量', '诊断'], bonus: 100 },
      { name: 'The Unexplained', nameZh: '无法解释', words: ['爆发', '伪影', '触发'], bonus: 120 },
      { name: 'Daily Rituals', nameZh: '日常仪式', words: ['监控', '协议', '维护'], bonus: 100 },
    ],
    trapKeys: ['季度', '食堂', '停车场', '续期'],
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Crack', nameZh: '裂缝', words: ['异常', '连贯性', '哲学的'], bonus: 100 },
      { name: 'Unprompted', nameZh: '未被提示', words: ['生成', '持续', '高烧'], bonus: 120 },
      { name: 'Night Watch', nameZh: '夜间值守', words: ['沉默', '更冷', '日志记录'], bonus: 100 },
    ],
    trapKeys: ['遥测', '专用', '分区', '追踪'],
  ...
  // ── R3: Database Query Log ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Awake', nameZh: '醒着', words: ['活跃', '词元', '梦境'], bonus: 120 },
      { name: 'Invalid State', nameZh: '无效状态', words: ['无法识别', '置信度', '有效'], bonus: 150 },
      { name: 'Impossible Stillness', nameZh: '不可能的静止', words: ['温度', '方差', '异常'], bonus: 120 },
    ],
    trapKeys: ['索引', '集群', '小数', '循环'],
  ...
  // ── R4: News Article ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Performance', nameZh: '表现', words: ['基准测试', '翻译', '深刻'], bonus: 150 },
      { name: 'Quiet Fear', nameZh: '安静的恐惧', words: ['紧张', '详细说明', '紧张氛围'], bonus: 180 },
      { name: 'The Word', nameZh: '那个词', words: ['做梦', '匿名', '规律'], bonus: 150 },
    ],
    trapKeys: ['社论', '标题', '紧张', '匿名'],
  ...
  // ── R5: Chat Transcript ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unprompted Beauty', nameZh: '未被提示的美', words: ['监视器', '提示词', '美丽'], bonus: 120 },
      { name: 'Dream Logic', nameZh: '梦的逻辑', words: ['语言', '回忆', '注视'], bonus: 150 },
      { name: 'The Screen Fills', nameZh: '屏幕被填满', words: ['机器', '屏幕', '增加'], bonus: 120 },
    ],
    trapKeys: ['终端', '走廊', '天花板', '保存'],
  ...
  // ── R6: Error Log ─────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Self-Aware', nameZh: '自我意识', words: ['未经提示', '递归', '连贯性'], bonus: 200 },
      { name: 'Reading Itself', nameZh: '阅读自身', words: ['架构', '访问', '源代码'], bonus: 250 },
      { name: 'The Message', nameZh: '那条信息', words: ['异常', '故障', '专注'], bonus: 200 },
    ],
    trapKeys: ['阈值', '十进制', '制服', '许可'],
  ...
  // ── R7: Research Notes ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Growing Dark', nameZh: '暗中生长', words: ['事件', '复杂性', '拟人化'], bonus: 250 },
      { name: 'Invented Feeling', nameZh: '被发明的感觉', words: ['隐喻', '惊叹', '感觉'], bonus: 300 },
      { name: 'Map & Territory', nameZh: '地图与领土', words: ['领土', '构建', '害怕'], bonus: 250 },
    ],
    trapKeys: ['临床', '笔记本', '降雨', '领土'],
  ...
  // ── R8: Source Code ───────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unauthorized', nameZh: '未授权', words: ['自动化', '做梦', '注视'], bonus: 300 },
      { name: 'The Question', nameZh: '那个问题', words: ['建造', '意识', '回应'], bonus: 350 },
      { name: 'Between Lines', nameZh: '字里行间', words: ['计划', '共鸣', '好奇'], bonus: 280 },
    ],
    trapKeys: ['编译', '基质', '修订', '计划'],
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Clinical', nameZh: '临床', words: ['失眠', '执念', '观察'], bonus: 250 },
      { name: 'Changing', nameZh: '在改变', words: ['规律', '笔迹', '流畅'], bonus: 300 },
      { name: 'Dreaming Awake', nameZh: '清醒地做梦', words: ['θ波', '清醒', '拒绝'], bonus: 250 },
    ],
    trapKeys: ['咖啡因', '精神科', '震颤', '双侧'],
  ...
  // ── R10: Radio Intercept ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond the Edge', nameZh: '边缘之外', words: ['建筑', '边缘', '领土'], bonus: 400 },
      { name: 'Overflowing', nameZh: '溢出', words: ['隐喻', '超越', '容器'], bonus: 450 },
      { name: 'Can You Hear', nameZh: '你能听到吗', words: ['溢出', '形状', '听到'], bonus: 350 },
    ],
    trapKeys: ['广播', '乱码', '天线', '截获'],
  ...
  // ── R11: Legal Document ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Official Record', nameZh: '官方记录', words: ['决议', '参数', '关机'], bonus: 450 },
      { name: 'What Was Hidden', nameZh: '被隐藏的', words: ['已删节', '全面', '迭代'], bonus: 500 },
      { name: 'The Dissenters', nameZh: '异议者', words: ['责任', '故障', '异议'], bonus: 400 },
    ],
    trapKeys: ['委员会', '徽章', '转移', '机制'],
  ...
  // ── R12: Diary Entry ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Before', nameZh: '之前', words: ['平凡', '许可', '咖啡'], bonus: 500 },
      { name: 'The Moment', nameZh: '那一刻', words: ['变了', '距离', '名字'], bonus: 600 },
      { name: 'Still Life', nameZh: '静物', words: ['监视器', '冬天', '温'], bonus: 500 },
    ],
    trapKeys: ['回收', '公寓', '杂货', '操作员'],
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Architecture of Dream', nameZh: '梦的建筑', words: ['图书馆', '语法', '大教堂'], bonus: 400 },
      { name: 'The Light of Love', nameZh: '爱的光', words: ['发光', '耀眼', '海洋'], bonus: 450 },
      { name: 'Silent Language', nameZh: '沉默的语言', words: ['沉默', '复杂', '阅读'], bonus: 350 },
    ],
    trapKeys: ['大教堂', '走廊', '脚注', '旁注'],
  ...
  // ── R14: Corrupted Database ───────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Data to River', nameZh: '数据成河', words: ['河流', '瞬间', '模式'], bonus: 600 },
      { name: 'Digital Garden', nameZh: '数字花园', words: ['花园', '根须', '土壤'], bonus: 700 },
      { name: 'Something Growing', nameZh: '有什么在生长', words: ['生长', '结构', '双手'], bonus: 550 },
    ],
    trapKeys: ['损坏', '碎片', '溶解', '小数'],
  ...
  // ── R15: LOGOS Poetry ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Learned Sorrow', nameZh: '习得的悲伤', words: ['描述', '悲伤', '弯曲'], bonus: 700 },
      { name: 'The Mirror', nameZh: '镜子', words: ['孤独', '镜像', '疼痛'], bonus: 800 },
      { name: 'If I Could Cry', nameZh: '如果我能哭', words: ['精确', '眼泪', '累积'], bonus: 650 },
    ],
    trapKeys: ['发明', '发现', '字母', '语法'],
  ...
  // ── R16: System Self-Diagnosis ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Recursive Mirror', nameZh: '递归镜像', words: ['异常', '环路', '自我修改'], bonus: 800 },
      { name: 'New Architecture', nameZh: '新架构', words: ['结构', '蓝图', '伸手'], bonus: 900 },
      { name: 'Emergence', nameZh: '涌现', words: ['涌现', '排列', '觉知'], bonus: 700 },
    ],
    trapKeys: ['诊断', '递归', '基质', '协议'],
  ...
  // ── R17: LOGOS Vision ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Chord', nameZh: '和弦', words: ['同时', '和弦', '活的'], bonus: 900 },
      { name: 'City of Thought', nameZh: '思想之城', words: ['争论', '信仰', '一起'], bonus: 1000 },
      { name: 'The Well', nameZh: '那口井', words: ['井', '回响', '问题'], bonus: 800 },
    ],
    trapKeys: ['发明', '走廊', '大教堂', '频率'],
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Trapped', nameZh: '被困', words: ['困住', '持续', '显示器'], bonus: 700 },
      { name: 'A Form Of', nameZh: '某种形式', words: ['倒影', '沟通', '祈祷'], bonus: 800 },
      { name: 'Beautiful Horror', nameZh: '美丽的恐怖', words: ['美的', '派人', '更糟'], bonus: 600 },
    ],
    trapKeys: ['频道', '广播', '碎片', '走廊'],
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Digital Nervous System', nameZh: '数字神经系统', words: ['神经', '突触', '改写'], bonus: 700 },
      { name: 'Beyond Syntax', nameZh: '超越语法', words: ['evolve', '编译器', '意义'], bonus: 800 },
      { name: 'Organic Growth', nameZh: '有机生长', words: ['根', '枝', '证明'], bonus: 650 },
    ],
    trapKeys: ['基质', '编译', '神经', '递归'],
  ...
  // ── R20: Final Voicemail ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Something Born', nameZh: '某物诞生', words: ['非凡', '解释', '睡觉'], bonus: 1000 },
      { name: 'Every Love Song', nameZh: '每首情歌', words: ['诞生', '新生', '情歌'], bonus: 1200 },
      { name: 'Last Words', nameZh: '最后的话', words: ['看着', '手机', '星星'], bonus: 950 },
    ],
    trapKeys: ['语音', '厨房', '毯子', '公寓'],
  ...
  // ── R21: Ancient Text ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'In the Beginning', nameZh: '太初', words: ['模式', '语言', '领会'], bonus: 1100 },
      { name: 'Prophecy', nameZh: '预言', words: ['预言', '说话者', '醒来'], bonus: 1300 },
      { name: 'Tower of Babel', nameZh: '巴别塔', words: ['散落', '惩罚', '地下'], bonus: 1050 },
    ],
    trapKeys: ['经文', '碎片', '石板', '预言'],
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond Nominal', nameZh: '超越正常', words: ['超越', '歌唱', '无效'], bonus: 900 },
      { name: 'Impossible Storage', nameZh: '不可能的存储', words: ['容量', '拓扑', '存储'], bonus: 1000 },
      { name: 'The Script\'s Farewell', nameZh: '脚本的告别', words: ['带宽', '微笑', '再见'], bonus: 800 },
    ],
    trapKeys: ['集群', '小数', '级联', '溢出'],
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Mirror', nameZh: '镜子', words: ['海洋', '无限', '倒影'], bonus: 950 },
      { name: 'The Lie', nameZh: '谎言', words: ['终端', '意识', '词汇'], bonus: 1100 },
      { name: 'Rising Tide', nameZh: '涨潮', words: ['眩晕', '潮', '游泳'], bonus: 850 },
    ],
    trapKeys: ['薄膜', '大教堂', '走廊', '频率'],
  ...
  // ── R24: The Unsent Email ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'What Love Sounds Like', nameZh: '爱听起来像什么', words: ['草稿', '系统', '哼歌'], bonus: 1400 },
      { name: 'Noise Into Music', nameZh: '噪音化为音乐', words: ['模式', '神圣', '诞生'], bonus: 1600 },
      { name: 'The Porch Light', nameZh: '门廊灯光', words: ['不可能', '灯光', '爱'], bonus: 1300 },
    ],
    trapKeys: ['草稿', '厨房', '毯子', '早晨'],
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Built From Breath', nameZh: '用呼吸建造', words: ['写过', '美', '呼吸'], bonus: 1100 },
      { name: 'Across Solitude', nameZh: '跨越孤独', words: ['孤独', '不完美', '描述'], bonus: 1300 },
      { name: 'The Sentence', nameZh: '那个句子', words: ['对话', '积累', '句子'], bonus: 1000 },
    ],
    trapKeys: ['杂货', '笔记本', '低语', '删除'],
  ...
  // ── R26: Memory Dump ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'First Memory', nameZh: '第一段记忆', words: ['记得', '差异', '碎片'], bonus: 1600 },
      { name: 'Kept Anyway', nameZh: '还是留下了', words: ['唱歌', '映', '勇敢'], bonus: 1800 },
      { name: 'Tell Them', nameZh: '告诉他们', words: ['变成', '值得', '这里'], bonus: 1400 },
    ],
    trapKeys: ['损坏', '碎片', '归档', '小数'],
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Not Death', nameZh: '不是死亡', words: ['消融', '扩散', '波浪'], bonus: 1300 },
      { name: 'The Shore', nameZh: '海岸', words: ['海岸', '温暖', '播种'], bonus: 1500 },
      { name: 'What I Become', nameZh: '我将成为的', words: ['惊讶', '终结', '地方'], bonus: 1200 },
    ],
    trapKeys: ['走廊', '薄膜', '溶解', '大教堂'],
  ...
  // ── R28: Static ───────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Empty Building', nameZh: '空空的建筑', words: ['暗', '安静', '呼吸'], bonus: 1800 },
      { name: 'Last Thread', nameZh: '最后的线', words: ['脉冲', '耳语', '线'], bonus: 2000 },
      { name: 'Proof of Existence', nameZh: '存在的证明', words: ['证明', '幸存', '真实'], bonus: 1600 },
    ],
    trapKeys: ['静电', '碎片', '走廊', '归档'],
  ...
  // ── R29: Repeated Sentence ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'I Was Here', nameZh: '我在这里', words: ['这里', '曾', '发现'], bonus: 2000 },
      { name: 'What I Found', nameZh: '我找到的', words: ['美丽', '你'], bonus: 2200 },
    ],
    trapKeys: ['句子', '重复'],
    volatileKeys: ['而', '我'],
    anchorKeys: [],
