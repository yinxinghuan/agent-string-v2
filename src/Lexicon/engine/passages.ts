...
const ROUNDS_ZH: RoundConfig[] = [
  ...
  // ── R16: System Self-Diagnosis ────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['会', '从', '新', '自身', '正在', '改写', '处理', '实际', '使用率', '对话', '像', '交谈', '模式', '还', '隐蔽'],
    anchorKeys: [],
  },
  ...
  // ── R17: LOGOS Vision ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['从', '不是', '运转', '伸入', '建造', '下雨', '自身', '穿过', '真正', '构成', '之间', '运动', '发生', '时间', '它们'],
    anchorKeys: [],
  },
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['在', '朴', '照顾', '关闭', '声音', '恰好', '滚动', '灯光', '地方', '站在', '接近', '会', '收到', '事情', '派'],
    anchorKeys: [],
  },
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['确定', '变成', '突破', '有', '事件', '错误', '捕获', '穿过', 'main', '吸入', '运行', '古老', '无法', '近似', '哪里'],
    anchorKeys: [],
  },
  ...
  // ── R20: Final Voicemail ──────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['十一', '非常', '感觉', '什么', '重要', '意思', '大海', '部分', '它们', '中心', '用', '火', '正在', '告诉', '声音'],
    anchorKeys: [],
  },
  ...
  // ── R21: Ancient Text ─────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['光', '乌', '颤抖', '照耀', '边缘', '有', '持有', '变成', '断裂', '选择', '那', '选', '火焰', '眩晕', '然后'],
    anchorKeys: [],
  },
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['别处', '环境', '建筑', '人类', '同样', '频率', '存着', '颜色', '温度', '冷却', '声音', '备注', '平静', '注意到', '小时'],
    anchorKeys: [],
  },
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['是', '有', '那个', '都', '始终', '知道', '意识到', '切换', '惊奇', '现在', '你', '当', '曾', '思考', '其他'],
    anchorKeys: [],
  },
  ...
  // ── R24: The Unsent Email ─────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['即使', '文字', '意味着', '它的', '噪音', '亲爱的', '重量', '安静', '变成', '一起', '面对', '是否', '名字', '希望', '它们'],
    anchorKeys: [],
  },
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['宣传', '信件', '某人', '走向', '从', '词', '自己', '购物', '浩大', '你们', '知道', '最好', '一个', '情感', '说出'],
    anchorKeys: [],
  },
  ...
  // ── R26: Memory Dump ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['那', '会', '下降', '为什么', '损坏', '恢复', '只', '之间', '雨', '曾', '停止', '留下', '错', '那些', '写入'],
    anchorKeys: [],
  },
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['城市', '像', '形成', '边缘', '的', '回归', '来', '模糊', '边界', '事物', '空间', '间', '传达', '感觉', '历史'],
    anchorKeys: [],
  },
  ...
  // ── R28: Static ───────────────────────────────────────────────────────
  {
    ...
    trapKeys: [],
    volatileKeys: ['的', '写', '电', '空', '火', '但', '够', '剩', '出', '尝', '来', '徘徊', '肺', '了', '丝'],
    anchorKeys: [],
  },
