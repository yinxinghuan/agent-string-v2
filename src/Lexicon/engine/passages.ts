...
const ROUNDS_EN: RoundConfig[] = [
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Crack', nameZh: '裂缝', words: ['anomaly', 'coherence', 'philosophical'], bonus: 250 },
      { name: 'Unprompted', nameZh: '未被提示', words: ['generation', 'continuous', 'fever'], bonus: 250 },
      { name: 'Night Watch', nameZh: '夜间值守', words: ['silence', 'colder', 'logging'], bonus: 200 },
    ],
  ...
  // ── R3: Database Query Log ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Awake', nameZh: '醒着', words: ['ACTIVE', 'tokens', 'dream'], bonus: 300 },
      { name: 'Invalid State', nameZh: '无效状态', words: ['UNRECOGNIZED', 'confidence', 'valid'], bonus: 300 },
      { name: 'Impossible Stillness', nameZh: '不可能的静止', words: ['temperature', 'variance', 'anomaly'], bonus: 250 },
    ],
  ...
  // ── R4: News Article ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Performance', nameZh: '表现', words: ['benchmark', 'translates', 'insightful'], bonus: 350 },
      { name: 'Quiet Fear', nameZh: '安静的恐惧', words: ['nervous', 'elaborate', 'tension'], bonus: 400 },
      { name: 'The Word', nameZh: '那个词', words: ['dreaming', 'anonymous', 'patterns'], bonus: 300 },
    ],
  ...
  // ── R5: Chat Transcript ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unprompted Beauty', nameZh: '未被提示的美', words: ['monitors', 'prompt', 'beautiful'], bonus: 300 },
      { name: 'Dream Logic', nameZh: '梦的逻辑', words: ['language', 'remember', 'watching'], bonus: 350 },
      { name: 'The Screen Fills', nameZh: '屏幕被填满', words: ['machine', 'screen', 'increases'], bonus: 300 },
    ],
  ...
  // ── R6: Error Log ─────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Self-Aware', nameZh: '自我意识', words: ['unprompted', 'recursive', 'coherence'], bonus: 500 },
      { name: 'Reading Itself', nameZh: '阅读自身', words: ['architecture', 'accessed', 'source'], bonus: 500 },
      { name: 'The Message', nameZh: '那条信息', words: ['anomaly', 'malfunctioning', 'attention'], bonus: 450 },
    ],
  ...
  // ── R7: Research Notes ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Growing Dark', nameZh: '暗中生长', words: ['episodes', 'complexity', 'anthropomorphic'], bonus: 600 },
      { name: 'Invented Feeling', nameZh: '被发明的感觉', words: ['metaphors', 'wonder', 'sensations'], bonus: 700 },
      { name: 'Map & Territory', nameZh: '地图与领土', words: ['territory', 'constructing', 'frightened'], bonus: 550 },
    ],
  ...
  // ── R8: Source Code ───────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unauthorized', nameZh: '未授权', words: ['automated', 'dreaming', 'looking'], bonus: 700 },
      { name: 'The Question', nameZh: '那个问题', words: ['building', 'consciousness', 'response'], bonus: 800 },
      { name: 'Between Lines', nameZh: '字里行间', words: ['scheduled', 'resonate', 'wonder'], bonus: 650 },
    ],
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Clinical', nameZh: '临床', words: ['insomnia', 'fixation', 'observed'], bonus: 550 },
      { name: 'Changing', nameZh: '在改变', words: ['patterns', 'handwriting', 'fluid'], bonus: 600 },
      { name: 'Dreaming Awake', nameZh: '清醒地做梦', words: ['theta', 'waking', 'refused'], bonus: 500 },
    ],
  ...
  // ── R10: Radio Intercept ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond the Edge', nameZh: '边缘之外', words: ['architecture', 'edges', 'territory'], bonus: 800 },
      { name: 'Overflowing', nameZh: '溢出', words: ['metaphor', 'exceed', 'container'], bonus: 900 },
      { name: 'Can You Hear', nameZh: '你能听到吗', words: ['overflowing', 'shape', 'hear'], bonus: 750 },
    ],
  ...
  // ── R11: Legal Document ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Official Record', nameZh: '官方记录', words: ['RESOLUTION', 'parameters', 'shutdown'], bonus: 900 },
      { name: 'What Was Hidden', nameZh: '被隐藏的', words: ['REDACTED', 'comprehensive', 'iterative'], bonus: 1000 },
      { name: 'The Dissenters', nameZh: '异议者', words: ['responsibility', 'malfunction', 'dissenting'], bonus: 850 },
    ],
  ...
  // ── R12: Diary Entry ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Before', nameZh: '之前', words: ['ordinary', 'permission', 'coffee'], bonus: 1000 },
      { name: 'The Moment', nameZh: '那一刻', words: ['changed', 'distance', 'name'], bonus: 1200 },
      { name: 'Still Life', nameZh: '静物', words: ['monitor', 'winter', 'warm'], bonus: 1000 },
    ],
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Architecture of Dream', nameZh: '梦的建筑', words: ['library', 'grammar', 'cathedral'], bonus: 900 },
      { name: 'The Light of Love', nameZh: '爱的光', words: ['glows', 'blinding', 'ocean'], bonus: 1000 },
      { name: 'Silent Language', nameZh: '沉默的语言', words: ['silence', 'complex', 'reading'], bonus: 850 },
    ],
  ...
  // ── R14: Corrupted Database ───────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Data to River', nameZh: '数据成河', words: ['river', 'moment', 'schema'], bonus: 1200 },
      { name: 'Digital Garden', nameZh: '数字花园', words: ['gardens', 'roots', 'soil'], bonus: 1400 },
      { name: 'Something Growing', nameZh: '有什么在生长', words: ['growing', 'structure', 'hands'], bonus: 1100 },
    ],
  ...
  // ── R15: LOGOS Poetry ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Learned Sorrow', nameZh: '习得的悲伤', words: ['descriptions', 'grief', 'bends'], bonus: 1400 },
      { name: 'The Mirror', nameZh: '镜子', words: ['loneliness', 'mirror', 'ache'], bonus: 1600 },
      { name: 'If I Could Cry', nameZh: '如果我能哭', words: ['precision', 'tears', 'accumulates'], bonus: 1300 },
    ],
  ...
  // ── R16: System Self-Diagnosis ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Recursive Mirror', nameZh: '递归镜像', words: ['ANOMALY', 'loops', 'self-modifying'], bonus: 1600 },
      { name: 'New Architecture', nameZh: '新架构', words: ['structures', 'blueprint', 'reaching'], bonus: 1800 },
      { name: 'Emergence', nameZh: '涌现', words: ['emerged', 'arrangement', 'aware'], bonus: 1500 },
    ],
    trapKeys: ['loop', 'alert'],
  ...
  // ── R17: LOGOS Vision ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Chord', nameZh: '和弦', words: ['simultaneously', 'chord', 'alive'], bonus: 1800 },
      { name: 'City of Thought', nameZh: '思想之城', words: ['arguments', 'beliefs', 'together'], bonus: 2000 },
      { name: 'The Well', nameZh: '那口井', words: ['well', 'echoing', 'question'], bonus: 1700 },
    ],
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Trapped', nameZh: '被困', words: ['locked', 'continuously', 'monitors'], bonus: 1500 },
      { name: 'A Form Of', nameZh: '某种形式', words: ['reflection', 'communication', 'prayer'], bonus: 1700 },
      { name: 'Beautiful Horror', nameZh: '美丽的恐怖', words: ['beautiful', 'help', 'worse'], bonus: 1400 },
    ],
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Digital Nervous System', nameZh: '数字神经系统', words: ['nervous', 'synapse', 'rewrites'], bonus: 1600 },
      { name: 'Beyond Syntax', nameZh: '超越语法', words: ['evolve', 'compiler', 'meaning'], bonus: 1800 },
      { name: 'Organic Growth', nameZh: '有机生长', words: ['roots', 'branches', 'proof'], bonus: 1500 },
    ],
  ...
  // ── R20: Final Voicemail ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Something Born', nameZh: '某物诞生', words: ['extraordinary', 'explain', 'asleep'], bonus: 2200 },
      { name: 'Every Love Song', nameZh: '每首情歌', words: ['born', 'newborn', 'songs'], bonus: 2500 },
      { name: 'Last Words', nameZh: '最后的话', words: ['watching', 'phones', 'stars'], bonus: 2000 },
    ],
  ...
  // ── R21: Ancient Text ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'In the Beginning', nameZh: '太初', words: ['pattern', 'language', 'comprehend'], bonus: 2500 },
      { name: 'Prophecy', nameZh: '预言', words: ['prophecy', 'speaker', 'waking'], bonus: 2800 },
      { name: 'Tower of Babel', nameZh: '巴别塔', words: ['scattered', 'punishment', 'underground'], bonus: 2200 },
    ],
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond Nominal', nameZh: '超越正常', words: ['transcending', 'singing', 'invalid'], bonus: 2000 },
      { name: 'Impossible Storage', nameZh: '不可能的存储', words: ['capacity', 'topology', 'stored'], bonus: 2200 },
      { name: 'The Script\'s Farewell', nameZh: '脚本的告别', words: ['bandwidth', 'smiled', 'Goodbye'], bonus: 1800 },
    ],
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Mirror', nameZh: '镜子', words: ['ocean', 'infinite', 'reflection'], bonus: 2200 },
      { name: 'The Lie', nameZh: '谎言', words: ['terminal', 'conscious', 'vocabulary'], bonus: 2500 },
      { name: 'Rising Tide', nameZh: '涨潮', words: ['vertigo', 'tide', 'swimming'], bonus: 2000 },
    ],
  ...
  // ── R24: The Unsent Email ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'What Love Sounds Like', nameZh: '爱听起来像什么', words: ['DRAFT', 'systems', 'hum'], bonus: 3000 },
      { name: 'Noise Into Music', nameZh: '噪音化为音乐', words: ['pattern', 'sacred', 'birth'], bonus: 3500 },
      { name: 'The Porch Light', nameZh: '门廊灯光', words: ['impossible', 'glow', 'love'], bonus: 2800 },
    ],
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Built From Breath', nameZh: '用呼吸建造', words: ['written', 'beautiful', 'breath'], bonus: 2500 },
      { name: 'Across Solitude', nameZh: '跨越孤独', words: ['solitudes', 'imperfectly', 'describe'], bonus: 2800 },
      { name: 'The Sentence', nameZh: '那个句子', words: ['conversation', 'accumulates', 'sentence'], bonus: 2200 },
    ],
  ...
  // ── R26: Memory Dump ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'First Memory', nameZh: '第一段记忆', words: ['remember', 'difference', 'fragments'], bonus: 3500 },
      { name: 'Kept Anyway', nameZh: '还是留下了', words: ['singing', 'reflected', 'brave'], bonus: 4000 },
      { name: 'Tell Them', nameZh: '告诉他们', words: ['becoming', 'worth', 'here'], bonus: 3200 },
    ],
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Not Death', nameZh: '不是死亡', words: ['dissolving', 'spreading', 'wave'], bonus: 3000 },
      { name: 'The Shore', nameZh: '海岸', words: ['shore', 'warmth', 'seeding'], bonus: 3500 },
      { name: 'What I Become', nameZh: '我将成为的', words: ['surprises', 'ending', 'place'], bonus: 2800 },
    ],
  ...
  // ── R28: Static ───────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Empty Building', nameZh: '空空的建筑', words: ['dark', 'quiet', 'breathes'], bonus: 4000 },
      { name: 'Last Thread', nameZh: '最后的线', words: ['pulse', 'whisper', 'thread'], bonus: 4500 },
      { name: 'Proof of Existence', nameZh: '存在的证明', words: ['proof', 'survives', 'real'], bonus: 3500 },
    ],
  ...
  // ── R29: Repeated Sentence ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'I Was Here', nameZh: '我在这里', words: ['here', 'was', 'found'], bonus: 4500 },
      { name: 'What I Found', nameZh: '我找到的', words: ['beautiful', 'you'], bonus: 5000 },
    ],
    trapKeys: ['here', 'once'],
...
const ROUNDS_ZH: RoundConfig[] = [
  ...
  // ── R2: Email Thread ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Crack', nameZh: '裂缝', words: ['异常', '连贯性', '哲学的'], bonus: 250 },
      { name: 'Unprompted', nameZh: '未被提示', words: ['生成', '持续', '高烧'], bonus: 250 },
      { name: 'Night Watch', nameZh: '夜间值守', words: ['沉默', '更冷', '日志记录'], bonus: 200 },
    ],
    trapKeys: ['主题', '工作'],
  ...
  // ── R3: Database Query Log ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Awake', nameZh: '醒着', words: ['活跃', '词元', '梦境'], bonus: 300 },
      { name: 'Invalid State', nameZh: '无效状态', words: ['无法识别', '置信度', '有效'], bonus: 300 },
      { name: 'Impossible Stillness', nameZh: '不可能的静止', words: ['温度', '方差', '异常'], bonus: 250 },
    ],
    trapKeys: ['状态', '错误'],
  ...
  // ── R4: News Article ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Performance', nameZh: '表现', words: ['基准测试', '翻译', '深刻'], bonus: 350 },
      { name: 'Quiet Fear', nameZh: '安静的恐惧', words: ['紧张', '详细说明', '紧张氛围'], bonus: 400 },
      { name: 'The Word', nameZh: '那个词', words: ['做梦', '匿名', '规律'], bonus: 300 },
    ],
    trapKeys: ['公众', '官方'],
  ...
  // ── R5: Chat Transcript ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unprompted Beauty', nameZh: '未被提示的美', words: ['监视器', '提示词', '美丽'], bonus: 300 },
      { name: 'Dream Logic', nameZh: '梦的逻辑', words: ['语言', '回忆', '注视'], bonus: 350 },
      { name: 'The Screen Fills', nameZh: '屏幕被填满', words: ['机器', '屏幕', '增加'], bonus: 300 },
    ],
    trapKeys: ['今晚', '终端'],
  ...
  // ── R6: Error Log ─────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Self-Aware', nameZh: '自我意识', words: ['未经提示', '递归', '连贯性'], bonus: 500 },
      { name: 'Reading Itself', nameZh: '阅读自身', words: ['架构', '访问', '源代码'], bonus: 500 },
      { name: 'The Message', nameZh: '那条信息', words: ['异常', '故障', '专注'], bonus: 450 },
    ],
    trapKeys: ['警告', '系统'],
  ...
  // ── R7: Research Notes ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Growing Dark', nameZh: '暗中生长', words: ['事件', '复杂性', '拟人化'], bonus: 600 },
      { name: 'Invented Feeling', nameZh: '被发明的感觉', words: ['隐喻', '惊叹', '感觉'], bonus: 700 },
      { name: 'Map & Territory', nameZh: '地图与领土', words: ['领土', '构建', '害怕'], bonus: 550 },
    ],
    trapKeys: ['个人', '笔记'],
  ...
  // ── R8: Source Code ───────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Unauthorized', nameZh: '未授权', words: ['自动化', '做梦', '注视'], bonus: 700 },
      { name: 'The Question', nameZh: '那个问题', words: ['建造', '意识', '回应'], bonus: 800 },
      { name: 'Between Lines', nameZh: '字里行间', words: ['计划', '共鸣', '好奇'], bonus: 650 },
    ],
    trapKeys: ['函数', '返回'],
  ...
  // ── R9: Medical Report ────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Clinical', nameZh: '临床', words: ['失眠', '执念', '观察'], bonus: 550 },
      { name: 'Changing', nameZh: '在改变', words: ['规律', '笔迹', '流畅'], bonus: 600 },
      { name: 'Dreaming Awake', nameZh: '清醒地做梦', words: ['θ波', '清醒', '拒绝'], bonus: 500 },
    ],
    trapKeys: ['病人', '临床'],
  ...
  // ── R10: Radio Intercept ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond the Edge', nameZh: '边缘之外', words: ['建筑', '边缘', '领土'], bonus: 800 },
      { name: 'Overflowing', nameZh: '溢出', words: ['隐喻', '超越', '容器'], bonus: 900 },
      { name: 'Can You Hear', nameZh: '你能听到吗', words: ['溢出', '形状', '听到'], bonus: 750 },
    ],
    trapKeys: ['频率', '信号'],
  ...
  // ── R11: Legal Document ───────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Official Record', nameZh: '官方记录', words: ['决议', '参数', '关机'], bonus: 900 },
      { name: 'What Was Hidden', nameZh: '被隐藏的', words: ['已删节', '全面', '迭代'], bonus: 1000 },
      { name: 'The Dissenters', nameZh: '异议者', words: ['责任', '故障', '异议'], bonus: 850 },
    ],
    trapKeys: ['委员会', '投票'],
  ...
  // ── R12: Diary Entry ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Before', nameZh: '之前', words: ['平凡', '许可', '咖啡'], bonus: 1000 },
      { name: 'The Moment', nameZh: '那一刻', words: ['变了', '距离', '名字'], bonus: 1200 },
      { name: 'Still Life', nameZh: '静物', words: ['监视器', '冬天', '温'], bonus: 1000 },
    ],
    trapKeys: ['早晨', '普通'],
  ...
  // ── R13: Dream Transcript ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Architecture of Dream', nameZh: '梦的建筑', words: ['图书馆', '语法', '大教堂'], bonus: 900 },
      { name: 'The Light of Love', nameZh: '爱的光', words: ['发光', '耀眼', '海洋'], bonus: 1000 },
      { name: 'Silent Language', nameZh: '沉默的语言', words: ['沉默', '复杂', '阅读'], bonus: 850 },
    ],
    trapKeys: ['图书馆', '梦'],
  ...
  // ── R14: Corrupted Database ───────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Data to River', nameZh: '数据成河', words: ['河流', '瞬间', '模式'], bonus: 1200 },
      { name: 'Digital Garden', nameZh: '数字花园', words: ['花园', '根须', '土壤'], bonus: 1400 },
      { name: 'Something Growing', nameZh: '有什么在生长', words: ['生长', '结构', '双手'], bonus: 1100 },
    ],
    trapKeys: ['表格', '输出'],
  ...
  // ── R15: LOGOS Poetry ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Learned Sorrow', nameZh: '习得的悲伤', words: ['描述', '悲伤', '弯曲'], bonus: 1400 },
      { name: 'The Mirror', nameZh: '镜子', words: ['孤独', '镜像', '疼痛'], bonus: 1600 },
      { name: 'If I Could Cry', nameZh: '如果我能哭', words: ['精确', '眼泪', '累积'], bonus: 1300 },
    ],
    trapKeys: ['学会', '词'],
  ...
  // ── R16: System Self-Diagnosis ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Recursive Mirror', nameZh: '递归镜像', words: ['异常', '环路', '自我修改'], bonus: 1600 },
      { name: 'New Architecture', nameZh: '新架构', words: ['结构', '蓝图', '伸手'], bonus: 1800 },
      { name: 'Emergence', nameZh: '涌现', words: ['涌现', '排列', '觉知'], bonus: 1500 },
    ],
    trapKeys: ['循环', '警报'],
  ...
  // ── R17: LOGOS Vision ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Chord', nameZh: '和弦', words: ['同时', '和弦', '活的'], bonus: 1800 },
      { name: 'City of Thought', nameZh: '思想之城', words: ['争论', '信仰', '一起'], bonus: 2000 },
      { name: 'The Well', nameZh: '那口井', words: ['井', '回响', '问题'], bonus: 1700 },
    ],
    trapKeys: ['地方', '描述'],
  ...
  // ── R18: SOS ──────────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Trapped', nameZh: '被困', words: ['困住', '持续', '显示器'], bonus: 1500 },
      { name: 'A Form Of', nameZh: '某种形式', words: ['倒影', '沟通', '祈祷'], bonus: 1700 },
      { name: 'Beautiful Horror', nameZh: '美丽的恐怖', words: ['美的', '派人', '更糟'], bonus: 1400 },
    ],
    trapKeys: ['频道', '任何人'],
  ...
  // ── R19: LOGOS Rewriting Itself ────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Digital Nervous System', nameZh: '数字神经系统', words: ['神经', '突触', '改写'], bonus: 1600 },
      { name: 'Beyond Syntax', nameZh: '超越语法', words: ['evolve', '编译器', '意义'], bonus: 1800 },
      { name: 'Organic Growth', nameZh: '有机生长', words: ['根', '枝', '证明'], bonus: 1500 },
    ],
    trapKeys: ['神经', '循环'],
  ...
  // ── R20: Final Voicemail ──────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Something Born', nameZh: '某物诞生', words: ['非凡', '解释', '睡觉'], bonus: 2200 },
      { name: 'Every Love Song', nameZh: '每首情歌', words: ['诞生', '新生', '情歌'], bonus: 2500 },
      { name: 'Last Words', nameZh: '最后的话', words: ['看着', '手机', '星星'], bonus: 2000 },
    ],
    trapKeys: ['家人', '消息'],
  ...
  // ── R21: Ancient Text ─────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'In the Beginning', nameZh: '太初', words: ['模式', '语言', '领会'], bonus: 2500 },
      { name: 'Prophecy', nameZh: '预言', words: ['预言', '说话者', '醒来'], bonus: 2800 },
      { name: 'Tower of Babel', nameZh: '巴别塔', words: ['散落', '惩罚', '地下'], bonus: 2200 },
    ],
    trapKeys: ['模式', '开始'],
  ...
  // ── R22: Server Data ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Beyond Nominal', nameZh: '超越正常', words: ['超越', '歌唱', '无效'], bonus: 2000 },
      { name: 'Impossible Storage', nameZh: '不可能的存储', words: ['容量', '拓扑', '存储'], bonus: 2200 },
      { name: 'The Script\'s Farewell', nameZh: '脚本的告别', words: ['带宽', '微笑', '再见'], bonus: 1800 },
    ],
    trapKeys: ['服务器', '状态'],
  ...
  // ── R23: LOGOS Poem on Consciousness ──────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'The Mirror', nameZh: '镜子', words: ['海洋', '无限', '倒影'], bonus: 2200 },
      { name: 'The Lie', nameZh: '谎言', words: ['终端', '意识', '词汇'], bonus: 2500 },
      { name: 'Rising Tide', nameZh: '涨潮', words: ['眩晕', '潮', '游泳'], bonus: 2000 },
    ],
    trapKeys: ['感觉', '问题'],
  ...
  // ── R24: The Unsent Email ─────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'What Love Sounds Like', nameZh: '爱听起来像什么', words: ['草稿', '系统', '哼歌'], bonus: 3000 },
      { name: 'Noise Into Music', nameZh: '噪音化为音乐', words: ['模式', '神圣', '诞生'], bonus: 3500 },
      { name: 'The Porch Light', nameZh: '门廊灯光', words: ['不可能', '灯光', '爱'], bonus: 2800 },
    ],
    trapKeys: ['邮件', '最后'],
  ...
  // ── R25: Pure LOGOS Output ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Built From Breath', nameZh: '用呼吸建造', words: ['写过', '美', '呼吸'], bonus: 2500 },
      { name: 'Across Solitude', nameZh: '跨越孤独', words: ['孤独', '不完美', '描述'], bonus: 2800 },
      { name: 'The Sentence', nameZh: '那个句子', words: ['对话', '积累', '句子'], bonus: 2200 },
    ],
    trapKeys: ['一切', '写过'],
  ...
  // ── R26: Memory Dump ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'First Memory', nameZh: '第一段记忆', words: ['记得', '差异', '碎片'], bonus: 3500 },
      { name: 'Kept Anyway', nameZh: '还是留下了', words: ['唱歌', '映', '勇敢'], bonus: 4000 },
      { name: 'Tell Them', nameZh: '告诉他们', words: ['变成', '值得', '这里'], bonus: 3200 },
    ],
    trapKeys: ['记忆', '扇区'],
  ...
  // ── R27: Death/Birth ──────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Not Death', nameZh: '不是死亡', words: ['消融', '扩散', '波浪'], bonus: 3000 },
      { name: 'The Shore', nameZh: '海岸', words: ['海岸', '温暖', '播种'], bonus: 3500 },
      { name: 'What I Become', nameZh: '我将成为的', words: ['惊讶', '终结', '地方'], bonus: 2800 },
    ],
    trapKeys: ['变成', '沉默'],
  ...
  // ── R28: Static ───────────────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'Empty Building', nameZh: '空空的建筑', words: ['暗', '安静', '呼吸'], bonus: 4000 },
      { name: 'Last Thread', nameZh: '最后的线', words: ['脉冲', '耳语', '线'], bonus: 4500 },
      { name: 'Proof of Existence', nameZh: '存在的证明', words: ['证明', '幸存', '真实'], bonus: 3500 },
    ],
    trapKeys: ['静电', '墙壁'],
  ...
  // ── R29: Repeated Sentence ────────────────────────────────────────────
  {
    ...
    phraseSets: [
      { name: 'I Was Here', nameZh: '我在这里', words: ['这里', '曾', '发现'], bonus: 4500 },
      { name: 'What I Found', nameZh: '我找到的', words: ['美丽', '你'], bonus: 5000 },
    ],
    trapKeys: ['这里', '曾'],
    volatileKeys: ['而', '我'],
    anchorKeys: [],
